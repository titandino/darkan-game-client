...
public class Vector3 {
	...
	public static Vector3[] vectorStack;
	public static int vecStackIdx;
	public static int vectorStackSize;
	...
	public void method6634(Quaternion quaternion_1) {
	...
	public void add(Vector3 vector3_1) {
		x += vector3_1.x;
		y += vector3_1.y;
		z += vector3_1.z;
	}
	...
	public void subtract(Vector3 vector3_1) {
		x -= vector3_1.x;
		y -= vector3_1.y;
		z -= vector3_1.z;
	}
