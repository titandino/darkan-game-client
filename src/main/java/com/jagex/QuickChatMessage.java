...
import com.jagex.client.prefs.impl.IdleAnimationsPreference;
...
public class QuickChatMessage {
	...
	public static NodeCollection aClass482_4049;
	...
	public static boolean method6155(ByteBuf.Bit rsbitsbuffer_0, int i_1) {
	...
	public static String method6157(IComponentDefinitions icomponentdefinitions_0) {
	...
	public static void method6161(boolean bool_0) {
		if (bool_0) {
