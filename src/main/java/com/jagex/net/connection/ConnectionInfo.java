package com.jagex.net.connection;

import com.Loader;
import com.jagex.PingRequest;
import com.jagex.WorldDescriptor;
import com.jagex.client.js5.loaders.SkyboxIndexLoader;
import com.jagex.unknown.Class155;
import com.jagex.unknown.Class407;
...
public class ConnectionInfo {
	...
	public static PingRequest CURRENT_WORLD_PING_REQUEST;
	public static int currentWorldPingIdx;
	public static int CURRENT_WORLD = 1000336;
	public static WorldDescriptor[] WORLD_DESCRIPTORS_BYID = new WorldDescriptor[0];
	...
	public static String method7499(long long_0) {
		Calendar calendar_5;
		if (true) {
