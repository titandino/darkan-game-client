package com.jagex.net.connection.async;
...
public class AsyncConnection extends Connection {
	...
	public AsyncInputStream inputStream;

	public AsyncOutputStream outputStream;

	public AsyncConnection(Socket socket_1, int i_2) throws IOException {
		socket = socket_1;
