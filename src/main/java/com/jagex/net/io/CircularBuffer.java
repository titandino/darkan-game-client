...
import com.jagex.unknown.Class412;

public class CircularBuffer {

	public static int[] anIntArray5773;
	public static int anInt5768;
	public static int anInt5769;
	public static int anInt5772;
	public static byte[][] aByteArrayArray5767 = new byte[1000][];
	public static byte[][] aByteArrayArray5771 = new byte[250][];
	public static byte[][] aByteArrayArray5770 = new byte[50][];
