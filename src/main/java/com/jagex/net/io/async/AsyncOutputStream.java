...
import com.jagex.client.js5.defs.QuickchatMessageDefinitions;
...
public class AsyncOutputStream implements Runnable {
	...
	public IOException anIOException3439;
	public int anInt3443;
	public int anInt3444;
	public OutputStream anOutputStream3442;
	public boolean aBool3446;
	public int anInt3440;
	public byte[] aByteArray3441;
	public Thread aThread3445;

	public AsyncOutputStream(OutputStream outputstream_1, int i_2) {
	...
	public static boolean method5097(AbstractRenderer graphicalrenderer_0, int i_1) {
		Utils.time();
	...
	public void method5087(byte[] bytes_1, int i_2, int i_3) throws IOException {
