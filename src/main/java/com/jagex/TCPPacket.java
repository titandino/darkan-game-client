...
public class TCPPacket extends Node {
	...
	public static TCPPacket[] OUTGOING_PACKETS = new TCPPacket[300];
	public static int index;
	public int anInt7680;
	public ByteBuf.Bit buffer;
	public int anInt7678;
	public ClientProt packet;

	public static void method12366(int i_0, int i_1, int i_2, int i_3, int i_4, int i_5, int i_6) {
