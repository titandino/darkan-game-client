...
import com.jagex.unknown.Class480;
...
public class WorldMapDef extends CacheableNode {
	...
	public NodeCollection areaRects;

	public WorldMapDef(int fileId, String staticElementsName, String areaName, int regionHash, int i_5, boolean bool_6, int i_7, int mapSizeIndex) {
		this.id = fileId;
		...
		this.areaRects = new NodeCollection();
	}
