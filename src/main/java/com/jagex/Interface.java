...
public class Interface {
	...
	public Interface(boolean bool_1, IComponentDefinitions[] arr_2) {
		components = arr_2;
		aBool999 = bool_1;
	}

	public static void method7554(Interface inter, IComponentDefinitions defs) {
		if (defs != null) {
			int i_4;
			if (defs.slotId != -1) {
	...
	public static void method3710(Interface inter, IComponentDefinitions defs) {
		if (defs != null) {
			int i_4;
			if (defs.slotId != -1) {
