...
public class ProcessorSpecs {
	...
	public ProcessorSpecs(int i_1, int i_2, boolean bool_3) {
		maxMemory = i_1;
		processorCount = i_2;
		isARM = bool_3;
	}

	public static void method7724(PathingEntity animable_0) {
		if (animable_0 instanceof NPCEntity) {
			NPCEntity npc_2 = (NPCEntity) animable_0;
			if (npc_2.definitions != null) {
				MapAreaDefinitions.iComponentOnNPC(npc_2, npc_2.plane != VertexNormal.MY_PLAYER.plane);
			}
		} else if (animable_0 instanceof PlayerEntity) {
			PlayerEntity player_3 = (PlayerEntity) animable_0;
			CutsceneAction_Sub22.iComponentOnPlayer(player_3, player_3.plane != VertexNormal.MY_PLAYER.plane);
		}
	}

	public static int[] method7725(TCPPacket tcpmessage_0) {
	...
	public static void method7727(PathingEntity animable_0) {
	...
	public static void method7728(int i_0, int i_1, int i_2, int i_3, int i_4) {
		int i_6 = EntityNode.method4890(i_2, Class532_Sub1.anInt7070, Class532_Sub1.anInt7068);
		int i_7 = EntityNode.method4890(i_3, Class532_Sub1.anInt7070, Class532_Sub1.anInt7068);
		int i_8 = EntityNode.method4890(i_0, Class532_Sub1.anInt7071, Class532_Sub1.anInt7069);
		int i_9 = EntityNode.method4890(i_1, Class532_Sub1.anInt7071, Class532_Sub1.anInt7069);
		for (int i_10 = i_6; i_10 <= i_7; i_10++) {
			KeyHoldInputSubscriber.method3922(Class532_Sub1.anIntArrayArray7072[i_10], i_8, i_9, i_4);
		}
	}
