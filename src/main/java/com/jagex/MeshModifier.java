...
import com.jagex.unknown.Class267;
import com.jagex.unknown.Class337;
import com.jagex.unknown.Class388;

import java.util.Iterator;

public class MeshModifier {

	public static Class267 aClass267_5026;
	public int[] maleBody = new int[3];
	public int[] femaleBody = new int[3];
	public int[] maleHead = new int[2];
	public int[] femaleHead = new int[2];
	public short[] modifiedColors;
	public short[] modifiedTextures;

	public MeshModifier(ItemDefinitions defs) {
