...
import com.jagex.unknown.Class250;
import com.jagex.unknown.Class253;
import com.jagex.unknown.Class80;

public class Node_Sub15_Sub2 extends Node_Sub15 {

	public int anInt9719;
	public boolean aBool9724;
	public int volume = 256;
	public int anInt9690 = 256;
	public int anInt9695 = 1000000;
	public int[] anIntArray9702 = new int[16];
	public int[] anIntArray9711 = new int[16];
	public int[] anIntArray9691 = new int[16];
	public int[] anIntArray9697 = new int[16];
	public int[] anIntArray9698 = new int[16];
	public int[] anIntArray9699 = new int[16];
	public int[] anIntArray9700 = new int[16];
	public int[] anIntArray9701 = new int[16];
	public int[] anIntArray9720 = new int[16];
	public int[] anIntArray9703 = new int[16];
	public int[] anIntArray9707 = new int[16];
	public int[] anIntArray9708 = new int[16];
	public int[] anIntArray9709 = new int[16];
	public int[] anIntArray9704 = new int[16];
	public int[] anIntArray9723 = new int[16];
	public int[] anIntArray9712 = new int[16];
	public Node_Sub13[][] aNode_Sub13ArrayArray9713 = new Node_Sub13[16][128];
	public Node_Sub13[][] aNode_Sub13ArrayArray9714 = new Node_Sub13[16][128];
	public Class80 aClass80_9715 = new Class80();
	public Node_Sub15_Sub3 aNode_Sub15_Sub3_9721 = new Node_Sub15_Sub3(this);
	public IterableNodeMap aClass465_9694;
	public long aLong9710;
	public Node_Sub7 aNode_Sub7_9722;
	public int anInt9717;
	public int anInt9696;
	public long aLong9693;
	public boolean aBool9716;
	...
	public void method15091(int i_1, int i_2) {
		anIntArray9701[i_1] = i_2;
	}

	public synchronized void method15094(int i_1) {
		anInt9690 = i_1;
	}

	public synchronized void method15095(int i_1, int i_2) {
		if (i_1 < 0) {
	...
	public synchronized void method15096() {
	...
	public synchronized void method15097() {
		for (Node_Sub14 class282_sub14_2 = (Node_Sub14) aClass465_9694.method7750(); class282_sub14_2 != null; class282_sub14_2 = (Node_Sub14) aClass465_9694.method7751()) {
	...
	public synchronized void method15098(Node_Sub7 class282_sub7_1, boolean bool_2) {
		method15131(class282_sub7_1, bool_2, true);
	}

	public void method15099(Node_Sub13 class282_sub13_1, boolean bool_2) {
	...
	public synchronized void method15100(Node_Sub7 class282_sub7_1, boolean bool_2, long long_4) {
		method15131(class282_sub7_1, bool_2, true);
		method15126(aClass80_9715.anInt785 * long_4);
	}

	public synchronized void method15101() {
		method15102(true);
	}

	public synchronized void method15102(boolean bool_1) {
		aClass80_9715.method1395();
		aNode_Sub7_9722 = null;
		method15116(bool_1);
	}

	public synchronized boolean method15103() {
		return aClass80_9715.method1409();
	}

	public void method15104(int i_1, int i_2) {
	...
	public void method15107(int i_1, int i_2, int i_3) {
		method15109(i_1, i_2);
		...
		if (class282_sub14_10 != null) {
			...
			if (class282_sub26_sub1_6 != null) {
				...
				if (anIntArray9704[i_1] == 0) {
					class282_sub13_7.aNode_Sub15_Sub5_7568 = class282_sub26_sub1_6.method15225(method15120(class282_sub13_7), method15108(class282_sub13_7), method15122(class282_sub13_7));
				} else {
					class282_sub13_7.aNode_Sub15_Sub5_7568 = class282_sub26_sub1_6.method15225(method15120(class282_sub13_7), 0, method15122(class282_sub13_7));
	...
	public int method15108(Node_Sub13 class282_sub13_1) {
	...
	public void method15109(int i_1, int i_2) {
	...
	public void method15111(int i_1) {
	...
	public void method15114(int i_1) {
		int i_11 = i_1;
		if (i_11 < 0) {
	...
	public boolean method15115(Node_Sub13 class282_sub13_1) {
	...
	public void method15116(boolean bool_1) {
		if (bool_1) {
			method15111(-1);
		} else {
			method15192(-1);
	...
	public void method15117(int i_1) {
		if ((anIntArray9707[i_1] & 0x2) != 0) {
			for (Node_Sub13 class282_sub13_3 = (Node_Sub13) aNode_Sub15_Sub3_9721.aClass482_9754.head(); class282_sub13_3 != null; class282_sub13_3 = (Node_Sub13) aNode_Sub15_Sub3_9721.aClass482_9754.next()) {
	...
	public void method15118(int i_1, byte b_2) {
	...
	public void method15119(int i_1) {
		int i_3 = i_1 & 0xf0;
		int i_4;
		int i_5;
		int i_6;
	...
	public int method15120(Node_Sub13 class282_sub13_1) {
	...
	public int method15122(Node_Sub13 class282_sub13_1) {
	...
	@Override
	public synchronized Node_Sub15 method12226() {
		return aNode_Sub15_Sub3_9721;
	}

	public int method15123() {
		return volume;
	}
	...
	public void method15126(long long_1) {
	...
	@Override
	public synchronized int method12228() {
		return 0;
	}

	public boolean method15128(Node_Sub13 class282_sub13_1, int[] ints_2, int i_3, int i_4) {
		...
		if (class282_sub13_1.anInt7579 < 0 || class282_sub13_1.aNode_Sub15_Sub5_7568 != null && !class282_sub13_1.aNode_Sub15_Sub5_7568.method15319()) {
			...
			class282_sub13_1.aNode_Sub15_Sub5_7568.method15308(method15120(class282_sub13_1));
			...
			if (bool_8) {
				class282_sub13_1.aNode_Sub15_Sub5_7568.method15322(class282_sub13_1.anInt7584);
				if (ints_2 != null) {
				...
				if (class282_sub13_1.aNode_Sub15_Sub5_7568.method15311()) {
					aNode_Sub15_Sub3_9721.aNode_Sub15_Sub4_9755.method15275(class282_sub13_1.aNode_Sub15_Sub5_7568);
				}
				...
				class282_sub13_1.aNode_Sub15_Sub5_7568.method15321(class282_sub13_1.anInt7584, method15108(class282_sub13_1), method15122(class282_sub13_1));
				return false;
			}
		} else {
			class282_sub13_1.method12213();
	...
	@Override
	public synchronized Node_Sub15 method12233() {
		return aNode_Sub15_Sub3_9721;
	}

	@Override
	public synchronized Node_Sub15 method12229() {
		return null;
	}

	@Override
	public synchronized Node_Sub15 method12235() {
		return null;
	}

	@Override
	public synchronized Node_Sub15 method12236() {
		return null;
	}

	@Override
	public synchronized int method12227() {
		return 0;
	}

	@Override
	public synchronized int method12224() {
		return 0;
	}

	@Override
	public synchronized int method12238() {
		return 0;
	}
	...
	public synchronized void method15131(Node_Sub7 class282_sub7_1, boolean bool_2, boolean bool_3) {
		method15102(bool_3);
	...
	public synchronized void setVolume(int i_1) {
		volume = i_1;
	}

	@Override
	public synchronized Node_Sub15 method12239() {
		return null;
	}
	...
	@Override
	public synchronized int method12244() {
		return 0;
	}

	@Override
	public synchronized Node_Sub15 method12232() {
		return aNode_Sub15_Sub3_9721;
	}
	...
	public synchronized boolean method15182(Node_Sub7 class282_sub7_1, Index index_2, Class250 class250_3) {
	...
	public void method15189(int i_1, int i_2) {
	...
	public void method15192(int i_1) {
		for (Node_Sub13 class282_sub13_3 = (Node_Sub13) aNode_Sub15_Sub3_9721.aClass482_9754.head(); class282_sub13_3 != null; class282_sub13_3 = (Node_Sub13) aNode_Sub15_Sub3_9721.aClass482_9754.next()) {
