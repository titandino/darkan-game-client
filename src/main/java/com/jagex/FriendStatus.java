...
import com.jagex.client.js5.JS5GrabWorker;
...
import com.jagex.game.content.cutscenes.actions.CutsceneAction_Sub4;
...
public class FriendStatus {
	...
	public static void method7703() {
		if (client.CURRENT_CUTSCENE < 0) {
			...
			if (Class20.anInt169 <= 1) {
				...
				if (BuildAreaPreference.method12619() && Class20.anInt169 > 2) {
	...
	public static byte method7705(int i_0, int i_1) {
