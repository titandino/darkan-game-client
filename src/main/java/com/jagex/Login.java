...
import com.jagex.client.cs2.CS2ReturnValue;
...
import com.jagex.client.prefs.impl.CharacterShadowPreference;
...
public class Login {
			...
			try {
				...
				if (Class9.loginStage == 80) {
					...
					if (Class9.lobbyStage == 273) {
						...
						rsbitsbuffer_22.writeByte(Class393.preferences.aAntiAliasingPreference__8223.method12641());
				...
				if (Class9.loginStage == 115) {
					...
					if (Class9.loginStage == 140) {
						...
						if (Class9.lobbyStage == 273) {
							...
							CharacterShadowPreference.LASTLOGINLDAY = buffer.readUnsignedShort();
	...
	public void method5013(Class285 class285_1) {
