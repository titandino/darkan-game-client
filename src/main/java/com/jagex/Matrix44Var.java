...
import com.jagex.unknown.Class297;

public class Matrix44Var {

	public static Matrix44Var aClass294_3518 = new Matrix44Var();
	public float aFloat3517;
	public float aFloat3514;
	public float aFloat3520;
	public float aFloat3516;
	public float aFloat3513;
	public float aFloat3522;
	public float aFloat3515;
	public float aFloat3524;
	public float aFloat3525;
	public float aFloat3519;
	public float aFloat3523;
	public float aFloat3521;
	...
	public void method5242(Quaternion quaternion_1) {
	...
	public void method5263(Vector3 vector3_1) {
		method5219(vector3_1.x, vector3_1.y, vector3_1.z);
	}

	public void method5272(float f_1, float f_2, float f_3, float f_4) {
		float f_5 = f_1 * f_1;
		float f_6 = f_1 * f_2;
		float f_7 = f_1 * f_3;
		float f_8 = f_1 * f_4;
