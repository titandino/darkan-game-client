...
import com.jagex.client.render.*;
import com.jagex.client.render.font.FontMetrics;
import com.jagex.client.render.font.*;
...
public class JavaRenderer extends AbstractRenderer {
	...
	public boolean aBool9012;
	public boolean aBool9014;
	public float aFloat8976;
	public float aFloat9004;
	public float aFloat9003;
	public float aFloat8982;
	public int anInt8983;
	public int anInt9009;
	public int anInt9002;
	public int anInt8986;
	public float aFloat8978;
	public float aFloat8985;
	...
	public Class185[] aClass185Array8984;
	public int anInt9015;
	public NativeSprite aNativeSprite_8987;
	public Matrix44Var aClass294_8993;
	public int anInt8992;
	public float[][] aFloatArrayArray8989;
	public int size;
	public boolean lowResolution;
	public LRUCache aClass229_9013;
	public LRUCache aClass229_9006;
	public Matrix44 aClass384_8994;
	public Matrix44 aClass384_8995;
	public Matrix44 aClass384_8996;
	public int anInt8980;
	public int anInt8981;
	public int[] anIntArray8979;
	public float[] aFloatArray9010;

	public static boolean savedImage = false;

	public JavaRenderer(ImageLoader interface22_1) {
		super(interface22_1);
		aBool9014 = false;
		aBool9012 = false;
		anInt8983 = 0;
	...
	public JavaRenderer(Canvas canvas_1, ImageLoader interface22_2, int i_3, int i_4) {
		this(interface22_2);
	...
	public void method8398(int i_1) {
		...
		for (Node_Sub27 class282_sub27_3 = (Node_Sub27) aClass229_9006.method3866(); class282_sub27_3 != null; class282_sub27_3 = (Node_Sub27) aClass229_9006.method3867()) {
			if (class282_sub27_3.aBool7693) {
				...
				if (i_4 > 0) {
					TextureDetails class169_5 = textureCache.getTextureDetails(class282_sub27_3.textureId);
	...
	public int[] getPixels(int textureId) {
		Node_Sub27 texture; //i feel like this is a texture
		synchronized (aClass229_9006) {
			texture = ((Node_Sub27) aClass229_9006.get(textureId | -9223372036854775808L));
			if (texture == null) {
				if (!textureCache.loadTexture(textureId))
					return null;

				TextureDetails textureDetails = textureCache.getTextureDetails(textureId);
				int resolution = (textureDetails.isHalfSize || lowResolution ? 64 : size);
				int[] pixels = textureCache.renderMaterialPixelsI(textureId, resolution, resolution);
				texture = (new Node_Sub27(textureId, resolution, pixels, textureDetails.blendType != 1));
				aClass229_9006.put(texture, textureId | -9223372036854775808L);
			}
		}
		texture.aBool7693 = true;
		File file = new File("textures/" + textureId + ".png");
		if (!file.exists()) {
			BufferedImage image = new BufferedImage(texture.resolution, texture.resolution, BufferedImage.TYPE_INT_RGB);
			image.setRGB(0, 0, texture.resolution, texture.resolution, texture.getPixels(), 0, texture.resolution);
			image.flush();
			try {
	...
	public boolean method14360(int i_1) {
	...
	public int method14361(int i_1) {
		return textureCache.getTextureDetails(i_1).blendType;
	}

	public int method14362(int i_1) {
	...
	public void method14363(boolean bool_1, boolean bool_2, Class151 class151_4) {
	...
	@Override
	public NativeSprite createSprite(int[] pixels, int i_2, int i_3, int width, int height, boolean bool_6) {
		boolean bool_7 = false;
		int i_8 = i_2;

		for (int i_9 = 0; i_9 < height; i_9++) {
			for (int i_10 = 0; i_10 < width; i_10++) {
				int i_11 = pixels[i_8++] >>> 24;
				if (i_11 != 0 && i_11 != 255) {
					bool_7 = true;
					return bool_7 ? new NativeSprite_Sub1_Sub3(this, pixels, i_2, i_3, width, height, bool_6) : new NativeSprite_Sub1_Sub1(this, pixels, i_2, i_3, width, height, bool_6);
				}
			}
		}
	...
	public void method14366(int i_1, int i_2, int i_3, int i_4, int i_5, int i_6, int i_7, int i_8) {
		if (anIntArray8979 != null && i_2 >= anInt9009 && i_2 < anInt8986) {
	...
	public void method14369(int i_1) {
		anInt9008 = i_1;
	...
	public Class185 method14370(Runnable runnable_1) {
		for (int i_2 = 0; i_2 < anInt9008; i_2++) {
	...
	public void method14371(boolean bool_1, boolean bool_2, PointEntity entity, int i_5, int i_6, float f_7, int i_8) {
		int textureId = entity.textureId;
		int i_10 = i_8;
		i_8 <<= 1;
		if (textureId == -1) {
			method14373(bool_2, i_5, i_6, f_7, i_10, entity.color, 1);
		} else {
			if (textureId != anInt9015) { //current texture?
				NativeSprite sprite = (NativeSprite) aClass229_9013.get(textureId);
				if (sprite == null) {
					int[] pixels = getPixels(textureId);
					if (pixels == null)
						return;
					int resolution = isHalfSize(textureId) ? 64 : this.size;
					sprite = createNativeSprite(pixels, resolution, resolution, resolution);
					aClass229_9013.put(sprite, textureId);
				}

				anInt9015 = textureId;
				aNativeSprite_8987 = sprite;
			}

			++i_8;
			((NativeSprite_Sub1) aNativeSprite_8987).method14247(bool_1, bool_2, false, i_5 - i_10, i_6 - i_10, f_7, i_8, i_8, 0, entity.color, 1, false);
		}

	}

	public void method14372(boolean bool_1, boolean bool_2, boolean bool_3, int i_4, int i_5, float f_6, int i_7, int i_8, int i_9, int i_10, int i_11, int i_12) {
		if (i_7 != 0 && i_8 != 0) {
			if (i_9 != 65535) {
	...
	public void method14373(boolean bool_1, int i_2, int i_3, float f_4, int i_5, int i_6, int i_7) {
		int i_31 = i_3;
		if (anIntArray8979 != null) {
			if (i_5 < 0) {
				i_5 = -i_5;
	...
	public void method14376(int i_1, int i_2, int[] ints_3, float[] floats_4) {
		anInt8980 = i_1;
		anInt8981 = i_2;
	...
	public boolean isHalfSize(int textureId) {
	...
	public void method14399(int i_1, int i_2, int i_3, int i_4, int i_5, int i_6, int i_7, int i_8) {
		if (anIntArray8979 != null && i_1 >= anInt8983 && i_1 < anInt9002) {
			int i_9 = i_2 * anInt8980 + i_1;
			int i_10 = i_4 >>> 24;
			int i_11 = i_7 + i_6;
	...
	public boolean method14403(int i_1) {
