...
import com.jagex.client.js5.loaders.VarBitIndexLoader;
...
public class Huffman {
	...
	public static void method1982(int i_0) {
	...
	public int method1971(byte[] bytes_1, int i_2, int i_3, byte[] bytes_4, int i_5) {
		int i_7 = 0;
		int i_8 = i_5 << 3;
	...
	public int method1973(byte[] bytes_1, int i_2, byte[] bytes_3, int i_4, int i_5) {
		if (i_5 == 0) {
			return 0;
		} else {
			int i_7 = 0;
