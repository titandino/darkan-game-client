...
import com.jagex.client.prefs.impl.BuildAreaPreference;
import com.jagex.net.connection.Connection;
import com.jagex.unknown.Class16;
import com.jagex.unknown.Class492;
...
public enum NPCDirection implements Identifiable {
	...
	public static int method4325(WorldDescriptor class217_sub1_0, WorldDescriptor class217_sub1_1, int i_2, boolean bool_3, int i_4, boolean bool_5) {
		int i_7 = BuildAreaPreference.method12620(class217_sub1_0, class217_sub1_1, i_2, bool_3);
		if (i_7 != 0) {
			return bool_3 ? -i_7 : i_7;
		} else if (i_4 == -1) {
			return 0;
		} else {
			int i_8 = BuildAreaPreference.method12620(class217_sub1_0, class217_sub1_1, i_4, bool_5);
			return bool_5 ? -i_8 : i_8;
		}
	}

	public static void drawDebugInformation(int x, int y, IComponentDefinitions inter) {
