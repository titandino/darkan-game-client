...
public abstract class PathingEntity extends GraphNode_Sub1_Sub1 {
	...
	PathingEntity(SceneObjectManager sceneobjectmanager_1, int i_2) {
		...
		currentAnimation = new AnimationSub(this);
		anInt10347 = -1;
		anInt10348 = -1;
		scalar = 0;
		lastUpdate = 0;
	...
	public void method15799(AbstractRenderer graphicalrenderer_1, MeshRasterizer[] arr_2, Matrix44Var matrix44var_3, boolean bool_4) {
		if (!bool_4) {
			int i_6 = 0;
			int i_7 = 0;
			int i_8 = 0;
	...
	public void sendSpotAnim(int spotAnimId, int flags1, int rotation, int i_4, boolean bool_5, int index) {
		...
		class161_8.animation.setAnimationFull(spotAnimId != -1 ? IndexLoaders.SPOT_ANIM_LOADER.getSpotAnimDefs(spotAnimId).animationId : -1, flags1 & 0xffff, b_14, false);
	}
	...
	public boolean initInterface(int i_1) {
	...
	public void method15819(MeshRasterizer meshrasterizer_1) {
	...
	public void method15837(AbstractRenderer graphicalrenderer_1, BASDefinitions renderanimdefs_2, int i_3, int i_4, int i_5, int i_6) {
	...
	public BASDefinitions getRenderAnimDefs() {
		...
		return i_2 == -1 ? BASIndexLoader.aClass227_2669 : IndexLoaders.RENDER_ANIM_LOADER.getBASDefs(i_2);
	}
	...
	public abstract int method15867();

	public abstract int method15868();
	...
	public void method15895(int i_1, int i_2, int i_3, int i_4, int i_5) {
