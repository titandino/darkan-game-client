...
import com.jagex.client.js5.defs.ClanVarDefinitions;
import com.jagex.client.js5.defs.NPCDefinitions;
import com.jagex.client.js5.defs.ParticleProducerDefinition;
import com.jagex.client.js5.defs.models.materials.MaterialProp28;
...
import com.jagex.game.content.cutscenes.CutsceneArea;
import com.jagex.game.content.cutscenes.actions.PlaySynthCutsceneAction;
...
public class MapRegion {
	...
	public boolean aBool3171;
	public Class256 aClass256_3164;
	...
	public Class256 mapType;
	byte[][][] aByteArrayArrayArray3162;
	ObjectIndexLoader objectDefsLoader;
	SceneObjectManager sceneObjectManager;
	public Class339 aClass339_3188;
	int missingMapCount;
	public int anInt3190 = 1;
	public int anInt3191;
	public int anInt3192 = 1;
	public Class239 aClass239_3175;
	...
	public Class329_Sub1 highDetailWaterPlane;
	public Class329_Sub1 aClass329_Sub1_3167;
	public Class341 aClass341_3181 = new Class341();
	public float aFloat3173;
	...
	public static boolean routeTo(int i_0, int i_1, boolean bool_2, RouteStrategy routestrategy_3) {
	...
	public static void method4562(int i_0, String string_1) {
	...
	public void method4418(MapRegion mapregion_1) {
	...
	public void loadMapSceneBackground() {
	...
	public void method4432(Class329_Sub1 class329_sub1_1, byte[][] bytes_2) {
	...
	public void loadMapSceneDynamic(ByteBuf.Bit buffer) {
	...
	public void loadMapSceneNormal(ByteBuf.Bit rsbitsbuffer_1) {
	...
	public String getArchiveName(boolean settingsData, boolean underwaterMap, int regionX, int regionY) {
		String string = "";
		if (settingsData) {
	...
	public void setMapSizes(MapSize mapSize) {
	...
	public void method4458(int i_1, int i_2, int i_3, boolean bool_4) {
	...
	public void method4459(int i_1) {
	...
	public void method4462(int i_1) {
		try {
			Thread.sleep(i_1);
		} catch (InterruptedException ignored) {
		}
	...
	public void decodeUnderlayMasks(Class329_Sub1 class329_sub1_1, byte[][] bytes_2) {
	...
	public void method4464(Class329_Sub1 class329_sub1_1, byte[][] bytes_2) {
		for (int i_4 = 0; i_4 < class329_sub1_1.anInt3845; i_4++) {
			if (!aBool3171) {
				MaterialPropTexture.method15391();
			}
	...
	public void method4465(Class329_Sub1 class329_sub1_1, byte[][] bytes_2) {
	...
	public void method4547() {
		if (aBool3171) {
			...
			MapRegion region = IndexLoaders.MAP_REGION_DECODER;
			regionIds = region.regionIds;
			mapDataArchiveIds = region.mapDataArchiveIds;
			landscapeDataArchiveIds = region.landscapeDataArchiveIds;
			npcSpawnArchiveIds = region.npcSpawnArchiveIds;
			hdWaterMapDataArchiveIds = region.hdWaterMapDataArchiveIds;
			hdWaterLandscapeDataArchiveIds = region.hdWaterLandscapeDataArchiveIds;
			xteas = region.xteas;
			mapDataBuffer = region.mapDataBuffer;
			landscapeDataBuffer = region.landscapeDataBuffer;
			npcSpawnBuffer = region.npcSpawnBuffer;
			hdWaterMapDataBuffer = region.hdWaterMapDataBuffer;
			hdWaterLandscapeDataBuffer = region.hdWaterLandscapeDataBuffer;
			clipMaps = region.clipMaps;
			renderFlagMap = region.renderFlagMap;
			aClass239_3175 = region.aClass239_3175;
			chunkFlags = region.chunkFlags;
			anInt3177 = region.anInt3177;
			zFar = region.zFar;
			aCacheableNode_Sub6_3176 = region.aCacheableNode_Sub6_3176;
			mapStaticElements = region.mapStaticElements;
			anIntArrayArray3185 = region.anIntArrayArray3185;
			anIntArrayArray3186 = region.anIntArrayArray3186;
			aByteArrayArrayArray3162 = region.aByteArrayArrayArray3162;
			mapType = region.mapType;
			aClass106_3165 = region.aClass106_3165;
			coordGrid = region.coordGrid;
			aClass219_3169 = region.aClass219_3169;
			anInt3170 = region.anInt3170;
			anInt3207 = region.anInt3207;
			sizeX = region.sizeX;
			sizeY = region.sizeY;
