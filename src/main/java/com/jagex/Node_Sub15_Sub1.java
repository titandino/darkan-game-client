...
public class Node_Sub15_Sub1 extends Node_Sub15 {
	...
	public synchronized void method14808() {
		aBool9571 = true;
	}
	...
	public synchronized void method14813() {
	...
	public synchronized void method14815(Node_Sub39 class282_sub39_1) {
		while (anInt9569 >= 100) {
	...
	public synchronized void method14816(boolean bool_1) {
		aBool9574 = bool_1;
	}
