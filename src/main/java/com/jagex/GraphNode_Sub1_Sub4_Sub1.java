...
import com.jagex.game.content.cutscenes.actions.CutsceneAction_Sub12;
import com.jagex.game.content.cutscenes.actions.CutsceneAction_Sub22;
import com.jagex.game.content.cutscenes.actions.CutsceneAction_Sub6;
...
public class GraphNode_Sub1_Sub4_Sub1 extends GraphNode_Sub1_Sub4 implements WorldObject {
	...
	public boolean aBool10488;
	byte aByte10487;
	byte aByte10485;
	public boolean aBool10481;
	public boolean aBool10490;
	MeshRasterizer aMeshRasterizer_10483;
	Shadow aCacheableNode_Sub17_10486;
	public Class200 aClass200_10484;

	public GraphNode_Sub1_Sub4_Sub1(SceneObjectManager sceneobjectmanager_1, AbstractRenderer graphicalrenderer_2, ObjectIndexLoader objectindexloader_3, ObjectDefinition objectdefinitions_4, int i_5, int i_6, int i_7, int i_8, int i_9, boolean bool_10, int i_11, int i_12, int i_13, int i_14) {
	...
	public static void iComponentOnGroundTile(AbstractRenderer graphicalrenderer_0, int i_1, int i_2) {
	...
	public Class452 method16069(AbstractRenderer graphicalrenderer_1, int i_2, boolean bool_3) {
