...
public abstract class Shadow extends CacheableNode {
	...
	public static EventQueue anEventQueue10074;

	public static void method15506(AbstractRenderer graphicalrenderer_0, int i_1, int i_2, IComponentDefinitions icomponentdefinitions_3) {
		byte b_5 = 63;
		byte b_6 = 7;
	...
	public static int method15507(CacheableNode_Sub7 class282_sub50_sub7_0, FontMetrics fontmetrics_1) {
