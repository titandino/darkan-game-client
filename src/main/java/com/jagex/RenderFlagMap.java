...
public class RenderFlagMap {
	...
	public static int decodeLandscapeData(ObjectIndexLoader objectindexloader_0, byte[] bytes_1, int i_2, int i_3, int i_4, int i_5) {
		int i_7 = 0;
	...
	public int method5499(int i_1, int i_2, int i_3) {
