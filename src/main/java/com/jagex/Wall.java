...
public class Wall extends GraphNode_Sub1_Sub5 implements WorldObject {
	...
	public static int[] anIntArray10531 = {1, 2, 4, 8};
	public static int[] anIntArray10533 = {16, 32, 64, 128};
	public Class123 aClass123_10532;
	public boolean aBool10528 = true;
	public Class200 aClass200_10530;
	public boolean aBool10529;

	public Wall(SceneObjectManager sceneobjectmanager_1, AbstractRenderer graphicalrenderer_2, ObjectIndexLoader objectindexloader_3, ObjectDefinition objectdefinitions_4, int i_5, int i_6, int i_7, int i_8, int i_9, boolean bool_10, int i_11, int i_12, int i_13) {
	...
	public static void method16113() {
