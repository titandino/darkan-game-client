...
public class Particle extends PointEntity {
	...
	public void reset(ParticleProducer emitter, int i_2, int i_3, int i_4, int i_5, int i_6, int i_7, int i_8, int i_9, int i_10, int i_11, int i_12, boolean bool_14) {
		producer = emitter;
		x = i_2 << 12;
		z = i_3 << 12;
		y = i_4 << 12;
	...
	public void method15965(SceneObjectManager sceneobjectmanager_1, AbstractRenderer graphicalrenderer_2) {
	...
	public void method15967(int delta) {
		lifetime -= delta;
		if (lifetime <= 0) {
			kill();
		} else {
