...
public class Quaternion {
	...
	public static Quaternion[] aClass381Array4641 = new Quaternion[0];
	...
	public static Quaternion method6457(Quaternion quaternion_0) {
	...
	public static Quaternion method6465(Quaternion quaternion_0) {
		Quaternion quaternion_1 = method6457(quaternion_0);
		quaternion_1.negate();
		return quaternion_1;
	}

	public static Quaternion method6485(float f_0, float f_1, float f_2) {
	...
	public static Quaternion method6497(Quaternion quaternion_0, Quaternion quaternion_1) {
