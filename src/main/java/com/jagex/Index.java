...
import com.jagex.client.js5.JS5FileWorker;
...
import com.jagex.unknown.Class395;

public class Index {

	public static Class395 aClass395_3684 = new Class395();
	public static boolean aBool3692;
	public static int anInt3689;
	public ReferenceTable referenceTable;
	public Object[] archives;
	public Object[][] archiveFiles;
	public JS5FileWorker aClass327_3690;
	public boolean aBool3685;
	public int loadType;
	...
	public synchronized boolean archiveExists(int i_1) {
		if (!referenceTableLoaded()) {
			return false;
		} else if (i_1 >= 0 && i_1 < referenceTable.fileCounts.length && referenceTable.fileCounts[i_1] != 0) {
			return true;
		} else if (aBool3692) {
	...
	public synchronized boolean fileExists(int i_1, int i_2) {
		if (!referenceTableLoaded()) {
			return false;
		} else if (i_1 >= 0 && i_2 >= 0 && i_1 < referenceTable.fileCounts.length && i_2 < referenceTable.fileCounts[i_1]) {
			return true;
		} else if (aBool3692) {
	...
	public synchronized void requestArchive(int i_1) {
		if (aBool3685) {
	...
	public void method5606(int i_1) {
	...
	public synchronized int method5613(int i_1) {
	...
	public boolean method5627(String string_1, String string_2) {
		if (!referenceTableLoaded()) {
			return false;
		} else {
			string_1 = string_1.toLowerCase();
	...
	public synchronized boolean referenceTableLoaded() {
	...
	public synchronized boolean method5638(int i_1, int i_2, int[] ints_3) {
		if (!archiveExists(i_1)) {
			return false;
