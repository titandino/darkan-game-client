...
import com.jagex.unknown.Class344;
...
public class Node_Sub41_Sub4 extends Node_Sub41 {
	...
	public VorbisInfo aVorbisInfo9605 = new VorbisInfo();
	public VorbisComment aVorbisComment9599 = new VorbisComment();
	public double aDouble9604;
	public int anInt9602;
	public DSPState aDSPState9600;
	public VorbisBlock aVorbisBlock9601;
	public Class344 aClass344_9598;
	public Node_Sub15_Sub1 aNode_Sub15_Sub1_9603;

	public Node_Sub41_Sub4(OggStreamState oggstreamstate_1) {
		super(oggstreamstate_1);
	}

	@Override
	public void method13362(OggPacket oggpacket_1) {
		if (anInt8031 < 3) {
			...
			ParticlesPreference.method12805(floats_6, class282_sub39_4.aShortArrayArray8003);
	...
	@Override
	public void method13363(OggPacket oggpacket_1) {
		if (anInt8031 * 1669091145 * -509226247 < 3) {
			...
			ParticlesPreference.method12805(floats_5, class282_sub39_3.aShortArrayArray8003);
	...
	@Override
	public void method13366(OggPacket oggpacket_1) {
		if (anInt8031 * 1669091145 * -509226247 < 3) {
			int i_2 = aVorbisInfo9605.headerIn(aVorbisComment9599, oggpacket_1);
			if (i_2 < 0) {
				throw new IllegalStateException("" + i_2);
