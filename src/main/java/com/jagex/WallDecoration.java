...
public class WallDecoration extends GraphNode_Sub1_Sub4 implements WorldObject {
	...
	public boolean aBool10504 = true;
	public Class200 aClass200_10503;
	public boolean aBool10502;

	public WallDecoration(SceneObjectManager sceneobjectmanager_1, AbstractRenderer graphicalrenderer_2, ObjectIndexLoader objectindexloader_3, ObjectDefinition objectdefinitions_4, int i_5, int i_6, int i_7, int i_8, int i_9, boolean bool_10, int i_11, int i_12, int i_13, int i_14, int i_15) {
	...
	public static void method16087(PathingEntity animable_0) {
	...
	public static void method16088(int i_0) {
		if (client.GAME_STATE == 3) {
			TCPPacket tcpmessage_2 = TCPPacket.createPacket(ClientProt.UNK_79, client.LOBBY_CONNECTION_CONTEXT.isaac);
