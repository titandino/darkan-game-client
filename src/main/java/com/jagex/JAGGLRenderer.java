...
import com.jagex.client.render.opengl.OpenGLShader;
...
public class JAGGLRenderer extends HardwareRenderer {
	...
	public Class115_Sub2 aClass115_Sub2_10189;
	public LinkedNodeList aClass473_10173 = new LinkedNodeList();
	public LinkedNodeList aClass473_10174 = new LinkedNodeList();
	public LinkedNodeList aClass473_10175 = new LinkedNodeList();
	public LinkedNodeList aClass473_10176 = new LinkedNodeList();
	public LinkedNodeList aClass473_10195 = new LinkedNodeList();
	public LinkedNodeList aClass473_10178 = new LinkedNodeList();
	public LinkedNodeList aClass473_10179 = new LinkedNodeList();
	public int[] anIntArray10184 = new int[1000];
	public Class326_Sub1[] aClass326_Sub1Array10186 = new Class326_Sub1[16];
	public float[] aFloatArray10172;
	public float[] aFloatArray10182;
	public OpenGL anOpenGL10191;
	public String aString10185;
	public String aString10200;
	public int anInt10196;
	public boolean aBool10193;
	public boolean aBool10194;
	public boolean aBool10197;
	public boolean aBool10177;
	public boolean aBool10192;
	public int[] anIntArray10188;
	public int anInt10198;
	public Class326_Sub2 aClass326_Sub2_10187;
	public long aLong10199;
	public boolean aBool10180;
	public boolean aBool10190;
	public boolean aBool10183;
	public int anInt10181;

	public JAGGLRenderer(OpenGL opengl_1, Canvas canvas_2, long long_3, ImageLoader interface22_5, Index index_6, int i_7) {
					...
					if (anInt10196 < 12) {
						...
						if (anInt8825 < 2) {
							...
							if (!method13887() || !method13888()) {
								if (!anOpenGL10191.supportsExtension("GL_ARB_multitexture")) {
									throw new RuntimeException("");
								}

								if (!anOpenGL10191.supportsExtension("GL_ARB_texture_env_combine")) {
									throw new RuntimeException("");
								}
							}
	...
	public static int method15566(Class76 class76_0) {
	...
	public static int method15567(Class67 class67_0) {
	...
	public static int method15574(Class150 class150_0, Class76 class76_1) {
	...
	public static int method15575(Class150 class150_0) {
		switch (class150_0.anInt1958) {
			case 0:
				return 6409;
			case 1:
	...
	public static int method15583(Class68 class68_0) {
	...
	public synchronized void method15573(int i_1) {
	...
	public byte[] getGLShaderData(String string_1) {
	...
	public synchronized void method15580(long long_1) {
