...
public class MIDIInstrument extends Node {
	...
	public static boolean aBool7611;
	public static int anInt7635;
	public static int anInt7637;
	public static float[] aFloatArray7612;
	public static Class255[] aClass255Array7615;
	public static Class338[] aClass338Array7610;
	public static Class265[] aClass265Array7617;
	public static Class259[] aClass259Array7618;
	public static boolean[] aBoolArray7619;
	public static int[] anIntArray7621;
	public static float[] aFloatArray7627;
	public static float[] aFloatArray7628;
	public static float[] aFloatArray7629;
	public static int[] anIntArray7633;
	public static float[] aFloatArray7630;
	public static float[] aFloatArray7631;
	public static float[] aFloatArray7632;
	public static int[] anIntArray7634;
	public static byte[] aByteArray7607;
	...
	public float[] aFloatArray7622;
	public int anInt7623;
	public int anInt7624;
	public boolean aBool7625;
	public float[] aFloatArray7608;
	...
	public static void method12261(byte[] bytes_0) {
		method12262(bytes_0);
	...
	public static void method12262(byte[] bytes_0) {
		aByteArray7607 = bytes_0;
		anInt7614 = 0;
		anInt7613 = 0;
	}

	public static int method12263() {
	...
	public static int method12264(int i_0) {
		int i_1 = 0;
	...
	public static boolean method12268(Index index_0) {
		if (!aBool7611) {
	...
	public static MIDIInstrument method12271(Index index_0, int i_1, int i_2) {
		if (!method12268(index_0)) {
	...
	public static float method12300(int i_0) {
	...
	public void method12265(byte[] bytes_1) throws IOException {
	...
	public float[] method12267(int i_1) {
	...
	public int method12273(int i_1) {
		int i_2 = 0;
	...
	public int method12275() {
		return anInt7636;
	}

	public boolean method12276() {
		return anInt7636 < anInt7620 - 1;
	}

	public int method12277() {
		return anInt7605;
	}

	public void method12296(int i_1) {
		int i_11 = i_1;
		if (i_11 > anInt7620 - 1) {
			i_11 = anInt7620 - 1;
		}
