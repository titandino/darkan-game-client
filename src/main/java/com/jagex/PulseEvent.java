...
import com.jagex.client.cs2.CS2Interpreter;
...
import com.jagex.unknown.Class499;

public class PulseEvent extends CacheableNode {

	public static Queue aClass477_9666 = new Queue();
	public static Queue aClass477_9655 = new Queue();
	public static IterableNodeMap aClass465_9667 = new IterableNodeMap(16);
	public String string;
	public int secondary;
	public int tertiary;
	public int primary;

	public PulseEvent(int type, long data) {
		this.pointer = (long) type << 56 | data;
	}

	public static PulseEvent createPulseEvent(int i_0, long long_1) {
	...
	public static void processPulseEvents() {
		...
		for (PulseEvent event = ObjectDefinition.nextPulseEvent(); event != null; event = ObjectDefinition.nextPulseEvent()) {
			...
			if (type == 1) {
				...
				CS2Interpreter.VARC_STRING[(int) value] = event.string;
	...
	public static void method7917(int i_0, int i_1) {
	...
	public static void method11155(int i_0, int i_1) {
	...
	public static void setComponentItem(int i_0, int i_1, int i_2) {
	...
	public static void setIFContent(int i_0, int i_1, int i_2, int i_3) {
	...
	public static void setComponentPosition(int component, int x, int y) {
	...
	public static void method8722(int i_0, int i_1, int i_2, int i_3) {
	...
	public static void method15381(int i_0, int i_1) {
		PulseEvent class282_sub50_sub12_3 = PulseEvent.createPulseEvent(17, i_0);
		class282_sub50_sub12_3.immediate();
		class282_sub50_sub12_3.primary = i_1;
	}

	public static void method15435(int i_0, int i_1) {
		PulseEvent class282_sub50_sub12_3 = PulseEvent.createPulseEvent(16, i_0);
		class282_sub50_sub12_3.immediate();
		class282_sub50_sub12_3.primary = i_1;
	}

	public static void method778(int i_0, int i_1, int i_2, int i_3) {
	...
	public static void method12882(int i_0, int i_1) {
		PulseEvent class282_sub50_sub12_3 = PulseEvent.createPulseEvent(13, i_0);
		class282_sub50_sub12_3.immediate();
		class282_sub50_sub12_3.primary = i_1;
	}

	public static void method3252(int i_0, boolean bool_1) {
		PulseEvent class282_sub50_sub12_3 = PulseEvent.createPulseEvent(22, i_0);
		class282_sub50_sub12_3.immediate();
		class282_sub50_sub12_3.primary = bool_1 ? 1 : 0;
	}

	public static void method2966(int i_0, int i_1) {
		PulseEvent class282_sub50_sub12_3 = PulseEvent.createPulseEvent(12, i_0);
		class282_sub50_sub12_3.immediate();
		class282_sub50_sub12_3.primary = i_1;
	}

	public static void method14663(int i_0, int i_1) {
		PulseEvent class282_sub50_sub12_3 = PulseEvent.createPulseEvent(7, i_0);
		class282_sub50_sub12_3.immediate();
		class282_sub50_sub12_3.primary = i_1;
	}

	public static void rotateComponentSprite(int interfaceHash, int pitch, int roll, int scale) {
	...
	public static void method3069(int i_0, int i_1) {
