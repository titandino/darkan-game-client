...
public class wa extends Class455 implements Interface40 {
	...
	public native void g(ja var1, ba var2, int var3, int var4, int[] var5, int[] var6);

	public native void l(ja var1, ba var2, int var3, int var4, int[] var5, int[] var6);
	...
	public native void n(ja var1, ba var2, int var3, int var4, int[] var5, int[] var6);
