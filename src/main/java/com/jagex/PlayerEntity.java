...
import com.jagex.client.js5.defs.ItemDefinitions;
...
public class PlayerEntity extends PathingEntity {
	...
	@Override
	public Class285 method13010(AbstractRenderer graphicalrenderer_1) {
	...
	@Override
	public void method12991(AbstractRenderer graphicalrenderer_1) {
	...
	@Override
	public void method13023(AbstractRenderer graphicalrenderer_1) {
		if (model != null && (aBool10370 || method16133(graphicalrenderer_1, 0))) {
			Matrix44Var matrix44var_2 = graphicalrenderer_1.method8450();
	...
	@Override
	public boolean method12983(AbstractRenderer graphicalrenderer_1, int i_2, int i_3) {
	...
	@Override
	public void method13013(GraphNode_Sub1 class521_sub1_2, int i_3, int i_4, int i_5, boolean bool_6) {
		throw new IllegalStateException();
	}
	...
	public boolean method16133(AbstractRenderer graphicalrenderer_1, int i_2) {
		int i_4 = i_2;
	...
	@Override
	public Class285 method13009(AbstractRenderer graphicalrenderer_1) {
		if (model != null && method16133(graphicalrenderer_1, 2048)) {
			Matrix44Var matrix44var_2 = graphicalrenderer_1.method8450();
			Matrix44Var matrix44var_3 = method11168();
			CoordinateSpace class305_4 = method11166();
	...
	@Override
	public Class285 method12989(AbstractRenderer graphicalrenderer_1) {
		if (model != null && method16133(graphicalrenderer_1, 2048)) {
			Matrix44Var matrix44var_2 = graphicalrenderer_1.method8450();
			Matrix44Var matrix44var_3 = method11168();
			CoordinateSpace class305_4 = method11166();
	...
	@Override
	public void method13012(AbstractRenderer graphicalrenderer_1) {
		if (model != null && (aBool10370 || method16133(graphicalrenderer_1, 0))) {
			Matrix44Var matrix44var_2 = graphicalrenderer_1.method8450();
			matrix44var_2.method5210(method11166());
			matrix44var_2.method5219(0.0F, -5.0f, 0.0F);
	...
	@Override
	public void method13016(GraphNode_Sub1 class521_sub1_2, int i_3, int i_4, int i_5, boolean bool_6) {
		throw new IllegalStateException();
	}

	public void method16136(AbstractRenderer graphicalrenderer_1, Matrix44Var matrix44var_2, long long_4, long long_6, int i_8, long long_9) {
	...
	@Override
	public boolean method13020(AbstractRenderer graphicalrenderer_1, int i_2, int i_3) {
		if (model != null && method16133(graphicalrenderer_1, 131072)) {
	...
	public void decodeAppearance(ByteBuf buffer) {
		...
		for (i = 0; i < LinkedNodeList.EQUIPMENT_DEFAULTS.hidden.length; i++) {
			if (LinkedNodeList.EQUIPMENT_DEFAULTS.hidden[i] != 1) {
				...
				if (index == 0) {
					...
					colour = buffer.readUnsignedByte();
					itemId = colour + (index << 8);
					if (i == 0 && itemId == 65535) {
		...
		if (i_10 == -1) {
			...
			for (colour = 0; colour < LinkedNodeList.EQUIPMENT_DEFAULTS.hidden.length; colour++) {
				if (LinkedNodeList.EQUIPMENT_DEFAULTS.hidden[colour] == 0) {
					if ((i & 1 << index) != 0) {
						modifiedMeshes[colour] = Class506.decodeItemEffects(wornItems[colour], buffer);
					}
		...
		for (index = 0; index < 10; index++) {
			colour = buffer.readUnsignedByte();
			if (Class366.SKIN_COLORS.length < 1 || colour < 0 || colour >= Class366.SKIN_COLORS[index][0].length)
				colour = 0;
		...
		if (isNpc != 0) {
			...
			if (transformedBefore != isTransformedNPC || index != isNpc || colour != walkingAnimation || itemId != rotate180Animation || i_18 != rotate90RightAnimation || i_19 != rotate90LeftAnimation || i_20 != specialByte) {
		...
		colour = model.mimickingNpcId;
		int[] ints_22 = model.colours;
		model.setAppearanceData(getRenderAnimation(), bodyAppearances, modifiedMeshes, colours, male == 1, i_10);
		if (i_10 != colour) {
		...
		if (this.index == client.myPlayerIndex && ints_22 != null) {
			for (i_18 = 0; i_18 < colours.length; i_18++) {
				if (colours[i_18] != ints_22[i_18]) {
		...
		if (aAnimation_Sub3_10337.hasDefs() && aAnimation_Sub3_10337.aBool7891) {
			...
			if (!renderanimdefs_23.method3810(aAnimation_Sub3_10337.currentAnimationId())) {
	...
	@Override
	public Class285 method12990(AbstractRenderer graphicalrenderer_1) {
		if (model != null && method16133(graphicalrenderer_1, 2048)) {
			Matrix44Var matrix44var_3 = graphicalrenderer_1.method8450();
			Matrix44Var matrix44var_4 = method11168();
