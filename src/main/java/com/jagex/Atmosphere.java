...
public class Atmosphere {
	...
	public Vector3 aClass385_7084;

	public float aFloat7081;

	public float aFloat7082;

	public float aFloat7090;

	public int anInt7085;

	public int anInt7086;

	public Class152 aClass152_7087;

	public float aFloat7088;

	public float aFloat7089;

	public float aFloat7080;

	public Class247 environmentInfo;
	...
	public void method11444(Atmosphere class535_1) {
	...
	public void method11445(AbstractRenderer graphicalrenderer_1, Atmosphere class535_2, Atmosphere class535_3, float f_4) {
	...
	public boolean method11449(Atmosphere class535_1) {
