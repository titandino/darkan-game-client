...
public class ProjectileAnimation extends GraphNode_Sub1_Sub1 {
	...
	public double aDouble10394;
	public double aDouble10395;
	public double aDouble10396;
	public double aDouble10397;
	public double aDouble10390;
	public boolean aBool10401;
	public int anInt10385;
	ParticleSystem aClass539_10402;
	public boolean aBool10398;
	int spotAnimId;
	public int angle;
	int slope;
	int entitySource;
	...
	public ProjectileAnimation(SceneObjectManager objManager, int spotAnimId, int fromPlane, int toPlane, int localX, int localY, int startHeight, int startTime, int endTime, int angle, int slope, int entitySource, int entityLockOn, int endHeight, boolean useTerrainHeight, int i_16) {
		...
		animation = new AnimationSub(this);
	...
	public void method15905(AbstractRenderer graphicalrenderer_1, MeshRasterizer meshrasterizer_2, Matrix44Var matrix44var_3) {
