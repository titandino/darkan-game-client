...
import com.jagex.GraphNode_Sub1;
...
public class AnimationSub extends Animation {

	public GraphNode_Sub1 aTransform_Sub1_7890;

	public AnimationSub(GraphNode_Sub1 class521_sub1_1) {
		super(false);
		aTransform_Sub1_7890 = class521_sub1_1;
	}

	public static void method12680(AbstractRenderer graphicalrenderer_0, int i_1, int i_2, int i_3, int i_4, int i_5, FontRenderer fontrenderer_6, FontMetrics fontmetrics_7, String string_8) {
