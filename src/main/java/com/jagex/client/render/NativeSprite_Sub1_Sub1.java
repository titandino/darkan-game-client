...
public class NativeSprite_Sub1_Sub1 extends NativeSprite_Sub1 {
	...
	public int[] anIntArray10201;

	public NativeSprite_Sub1_Sub1(JavaRenderer hardwarerenderer_1, int[] ints_2, int i_3, int i_4, int i_5, int i_6, boolean bool_7) {
	...
	public NativeSprite_Sub1_Sub1(JavaRenderer hardwarerenderer_1, int i_2, int i_3) {
		super(hardwarerenderer_1, i_2, i_3);
		anIntArray10201 = new int[i_3 * i_2];
	}

	public NativeSprite_Sub1_Sub1(JavaRenderer hardwarerenderer_1, int[] ints_2, int i_3, int i_4) {
