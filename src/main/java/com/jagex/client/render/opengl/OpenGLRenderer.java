package com.jagex.client.render.opengl;

import com.jagex.*;
import com.jagex.client.cache.CacheableNode_Sub19;
...
import com.jagex.client.render.font.FontRenderer_Sub5;
...
public class OpenGLRenderer extends AbstractRenderer {
	...
	public static int[] anIntArray8381 = new int[1000];
	public static int anInt8421 = 4;
	public static float[] aFloatArray8497 = new float[4];
	public static float[] aFloatArray8322 = new float[4];
	public Class137[] aClass137Array8482;
	public Class137_Sub1 aClass137_Sub1_8460;
	public Class158_Sub1_Sub4 aClass158_Sub1_Sub4_8493;
	public int anInt8366;
	public int anInt8384;
	public boolean aBool8408;
	public boolean aBool8459;
	public int anInt8441;
	public int anInt8428 = -1;
	public boolean aBool8367;
	public int anInt8349 = 128;
	public Class134 aClass134_8359 = new Class134();
	public Matrix44 aClass384_8360 = new Matrix44();
	public Matrix44 aClass384_8361 = new Matrix44();
	public Matrix44Var aClass294_8476 = new Matrix44Var();
	public int anInt8466 = 8;
	public int anInt8473 = 3;
	public LinkedNodeList aClass473_8369 = new LinkedNodeList();
	public LinkedNodeList aClass473_8373 = new LinkedNodeList();
	public LinkedNodeList aClass473_8486 = new LinkedNodeList();
	public LinkedNodeList aClass473_8375 = new LinkedNodeList();
	public LinkedNodeList aClass473_8376 = new LinkedNodeList();
	public LinkedNodeList aClass473_8377 = new LinkedNodeList();
	public LinkedNodeList aClass473_8461 = new LinkedNodeList();
	public LinkedNodeList aClass473_8379 = new LinkedNodeList();
	public Matrix44Var aClass294_8389 = new Matrix44Var();
	public Matrix44 aClass384_8348 = new Matrix44();
	public Matrix44 aClass384_8391 = new Matrix44();
	public Matrix44 aClass384_8442 = new Matrix44();
	public Matrix44 aClass384_8385 = new Matrix44();
	public Matrix44 aClass384_8394 = new Matrix44();
	public float[][] aFloatArrayArray8395 = new float[6][4];
	public float[] aFloatArray8396 = new float[4];
	public float aFloat8364;
	public float aFloat8320 = 1.0F;
	public float aFloat8403;
	public float aFloat8404 = -1.0f;
	public Matrix44Var aClass294_8405 = new Matrix44Var();
	public Matrix44 aClass384_8380 = new Matrix44();
	public Matrix44 aClass384_8407 = new Matrix44();
	public float[] aFloatArray8477 = new float[16];
	public boolean aBool8353 = true;
	public int anInt8415;
	public int anInt8478;
	public int anInt8413;
	public int anInt8412;
	public int anInt8453;
	public int anInt8416;
	public float[] aFloatArray8424 = new float[4];
	public float[] aFloatArray8425 = new float[4];
	public float[] aFloatArray8426 = new float[4];
	public float[] aFloatArray8427 = new float[4];
	public float aFloat8429 = 1.0F;
	public float aFloat8430 = 1.0F;
	public float aFloat8431 = 1.0F;
	public float aFloat8433 = -1.0f;
	public float aFloat8434 = -1.0f;
	public Node_Sub24[] aNode_Sub24Array8435;
	public int anInt8358;
	public int anInt8378;
	public float aFloat8446;
	public float aFloat8355;
	public boolean aBool8449;
	public int anInt8455;
	public int anInt8451;
	public float aFloat8489;
	public float aFloat8414;
	public MeshRasterizer_Sub1[] aMeshRasterizer_Sub1Array8479;
	public MeshRasterizer_Sub1[] aMeshRasterizer_Sub1Array8492;
	public Node_Sub35_Sub1 aNode_Sub35_Sub1_8499;
	public int[] anIntArray8500;
	public int[] anIntArray8501;
	public int[] anIntArray8502;
	public byte[] aByteArray8503;
	public int anInt8475;
	public OpenGL anOpenGL8352;
	public int anInt8410;
	public boolean aBool8472;
	public boolean aBool8487;
	public boolean aBool8312;
	public Class167 aClass167_8481;
	public Class164 aClass164_8363;
	public Class170 aClass170_8357;
	public boolean aBool8401;
	public boolean aBool8362;
	public boolean aBool8465;
	public Node_Sub5_Sub1 aNode_Sub5_Sub1_8444;
	public Class146 aClass146_8356;
	public boolean aBool8309;
	public boolean aBool8393;
	public NativeHeap aNativeHeap8445;
	public Interface14 anInterface14_8496;
	public OpenGlArrayBufferPointer aClass143_8494;
	public OpenGlArrayBufferPointer aClass143_8495;
	public int anInt8450;
	public HDWaterTile aClass90_8423;
	public boolean aBool8448;
	public int anInt8417;
	public int anInt8418;
	public int anInt8419;
	public int anInt8347;
	public float aFloat8398;
	public float aFloat8400;
	public float aFloat8315;
	public float aFloat8399;
	public float aFloat8432;
	public int anInt8371;
	public int anInt8370;
	public int anInt8372;
	public int anInt8368;
	public long aLong8316;
	public int anInt8409;
	public int anInt8382;
	public int anInt8438;
	public int anInt8439;
	public float aFloat8402;
	public float aFloat8406;
	public Interface14 anInterface14_8483;
	public boolean aBool8457;
	public int anInt8454;
	public int anInt8458;
	public boolean aBool8422;
	public boolean aBool8397;
	public boolean aBool8388;
	public int anInt8436;
	public boolean aBool8440;
	public Class137_Sub1_Sub1 aClass137_Sub1_Sub1_8462;
	public String aString8463;
	public String aString8464;
	public int anInt8443;
	public int anInt8469;
	public int anInt8470;
	public int anInt8471;
	public boolean aBool8467;
	public boolean aBool8342;
	public boolean aBool8484;
	public boolean aBool8485;
	public boolean aBool8365;
	public boolean aBool8480;
	public boolean aBool8498;
	public boolean aBool8338;
	public boolean aBool8488;
	public boolean aBool8344;
	public boolean aBool8456;
	public int anInt8437;
	public boolean aBool8387;
	public Class152_Sub1 aClass152_Sub1_8317;
	public Interface15 anInterface15_8452;

	public OpenGLRenderer(Canvas canvas_1, ImageLoader interface22_2, int i_3) {
		super(interface22_2);
	...
	public static int method13629(Class150 class150_0) {
	...
	public static int method13630(Class150 class150_0, Class76 class76_1) {
	...
	@Override
	public void method8555() throws Exception_Sub3 {
		try {
	...
	public void method13581(int i_1) {
	...
	@Override
	public NativeSprite method8444(SpriteDefinitions defs, boolean bool_2) {
		int[] pixels = new int[defs.width * defs.height];
		int i_4 = 0;
		int i_5 = 0;
		int i_6;
		int i_7;
		if (defs.alpha != null) {
			for (i_6 = 0; i_6 < defs.height; i_6++) {
				for (i_7 = 0; i_7 < defs.width; i_7++) {
					pixels[i_5++] = defs.alpha[i_4] << 24 | defs.pallete[defs.pixels[i_4] & 0xff];
					++i_4;
				}
			}
		} else {
			for (i_6 = 0; i_6 < defs.height; i_6++) {
				for (i_7 = 0; i_7 < defs.width; i_7++) {
					int i_8 = defs.pallete[defs.pixels[i_4++] & 0xff];
					pixels[i_5++] = i_8 != 0 ? -16777216 | i_8 : 0;
				}
			}
		}

		NativeSprite sprite = createNativeSprite(pixels, defs.width, defs.width, defs.height);
		sprite.method2743(defs.minX, defs.minY, defs.anInt958, defs.anInt953);
		return sprite;
	}

	@Override
	public NativeSprite createSprite(int[] pixels, int i_2, int width, int height, int i_5, boolean bool_6) {
		return new OpenGLSprite(this, height, i_5, pixels, i_2, width);
	}
	...
	public void method13585(Matrix44 matrix44_1) {
	...
	public void method13591(float f_1, float f_2) {
		aFloat8446 = f_1;
		aFloat8355 = f_2;
		method13594();
	}
	...
	public void method13595(int i_1, int i_2, int i_3) {
	...
	public Class137_Sub2 method13596() {
	...
	public void method13602(float f_1, float f_2) {
	...
	public void method13603(int i_3) {
	...
	public void method13608(int i_1, boolean bool_2) {
		method13609(i_1, bool_2, true);
	}

	public void method13609(int i_1, boolean bool_2, boolean bool_3) {
	...
	public void method13610(int i_1) {
		if (anInt8458 != i_1) {
	...
	public void method13611(Interface15 interface15_1, int i_3, int i_4) {
		method13663(interface15_1);
		OpenGL.glDrawElements(4, i_4, 5123, interface15_1.method2() + (i_3 * 2));
	}

	public void method13612(int i_1) {
		if (i_1 == 1) {
	...
	public int method13613(int i_1) {
		if (i_1 == 1) {
			return 7681;
		} else if (i_1 == 0) {
			return 8448;
	...
	public void method13616(int i_1, int i_2) {
		OpenGL.glTexEnvi(8960, i_1 + 34184, i_2);
		OpenGL.glTexEnvi(8960, i_1 + 34200, 770);
	}

	public void method13617(int i_1) {
	...
	public void method13620(boolean bool_1) {
		if (aBool8422 != bool_1) {
			aBool8422 = bool_1;
			method13622();
			anInt8382 &= -8;
	...
	public void method13621(boolean bool_1) {
		if (aBool8397 != bool_1) {
			aBool8397 = bool_1;
			method13622();
		}
	...
	public void method13623(boolean bool_1) {
		if (aBool8388 != bool_1) {
			aBool8388 = bool_1;
			method13579();
			anInt8382 &= -16;
	...
	public void method13624(int i_1) {
		if (anInt8366 != i_1) {
			byte b_2;
			boolean bool_3;
			boolean bool_4;
	...
	public synchronized void method13625(int i_1, int i_2) {
	...
	public synchronized void method13627(long long_1) {
		Node node_3 = new Node();
		node_3.pointer = long_1;
		aClass473_8379.insertBack(node_3);
	}

	public synchronized void method13628(int i_1) {
	...
	@Override
	public void method8596(int i_1, int i_2) throws Exception_Sub3 {
		try {
			aClass158_Sub2_5841.method14344();
		} catch (Exception ignored) {
		}
	...
	public void method13633(Matrix44 matrix44_1) {
		OpenGL.glPushMatrix();
	...
	public void method13635(float f_1, float f_2, float f_3, float f_4) {
	...
	public void method13640(int i_1, int i_2) {
		anInt8453 = i_1;
		anInt8416 = i_2;
		method13584();
		method13570();
	...
	@Override
	public Class158_Sub2 method8558(Canvas canvas_1, int i_2, int i_3) {
		return new Class158_Sub2_Sub1(this, canvas_1);
	}

	public void method13642(boolean bool_1) {
		if (aBool8440 != bool_1) {
			aBool8440 = bool_1;
			method13747();
			anInt8382 &= -16;
	...
	public void method13647(OpenGlArrayBufferPointer class143_1, OpenGlArrayBufferPointer class143_2, OpenGlArrayBufferPointer class143_3, OpenGlArrayBufferPointer class143_4) {
		if (class143_1 != null) {
	...
	public int method13652() {
		...
		aBool8456 = OperatingSystemInfo.OS_NAME.startsWith("mac");
	...
	public void method13654(Class137 class137_1) {
	...
	public void method13656(boolean bool_1) {
		if (aBool8387 != bool_1) {
			if (bool_1) {
	...
	public synchronized void method13657(int i_1, int i_2) {
		IntNode class282_sub38_3 = new IntNode(i_2);
		class282_sub38_3.pointer = i_1;
	...
	public void method13663(Interface15 interface15_1) {
	...
	@Override
	public Class158_Sub2 method8417(Canvas canvas_1, int i_2, int i_3) {
		return new Class158_Sub2_Sub1(this, canvas_1);
	}
	...
	public synchronized void method13678(int i_1) {
	...
	public synchronized void method13707(int i_1, int i_2) {
		IntNode class282_sub38_3 = new IntNode(i_2);
		class282_sub38_3.pointer = i_1;
	...
	public void method13717(int i_1, int i_2) {
		if (anInt8458 == 0) {
			boolean bool_3 = false;
			if (anInt8455 != i_1) {
	...
	public void method13719(float[] floats_1) {
