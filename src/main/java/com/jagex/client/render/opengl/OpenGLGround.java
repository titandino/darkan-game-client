...
public class OpenGLGround extends Ground {
	...
	public Class130 aClass130_8664;
	public int[][][] tileZOffsets;
	public int[][][] tileXOffsets;
	public int[][][] tileColours;
	public int[][][] anIntArrayArrayArray8662;
	public int[][][] tileBlendColours;
	public int[][][] anIntArrayArrayArray8649;
	public Node_Sub3[][][] materials;
	public byte[][] shadowing;
	public HashTable materialTable;
	public float[][] lightingZ;
	public float[][] lightingY;
	public float[][] lightingX;
	public Node[] aNodeArray8666;
	public Interface14 data;
	...
	public LinkedNodeList aClass473_8673 = new LinkedNodeList();
	public OpenGLRenderer renderer;
	public int quarterTileScale;
	public int quartertileUnits;
	public int anInt8651;
	public int flags;
	public short[][] materialIndices;
	public byte[][] shadowFlags;

	public OpenGLGround(OpenGLRenderer class505_sub1_1, int i_2, int i_3, int i_4, int i_5, int[][] ints_6, int[][] ints_7, int i_8) {
	...
	public void method13879(CacheableNode_Sub17_Sub1 class282_sub50_sub17_sub1_1, int i_2, int i_3) {
	...
	public void method13881(int i_1, int i_2, int i_3, boolean[][] bools_4, boolean bool_5) {
