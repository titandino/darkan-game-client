...
public abstract class NativeSprite implements Sprite {
	...
	public void method2760(float f_1, float f_2, float f_3, float f_4, int i_5, int i_6, int i_7, int i_8) {
		if (i_5 != 0) {
	...
	public abstract void method2764(float var1, float var2, float var3, float var4, float var5, float var6, int var7, int var8, int var9);

	public abstract int method2765();

	public abstract void method2766(float var1, float var2, float var3, float var4, float var5, float var6, int var7, Class455 var8, int var9, int var10);
	...
	public abstract void method2791(float var1, float var2, float var3, float var4, float var5, float var6, int var7, int var8, int var9, int var10);
	...
	public void method2797(float f_1, float f_2, float f_3, float f_4, float f_5, float f_6, Class455 class455_7, int i_8, int i_9) {
		method2766(f_1, f_2, f_3, f_4, f_5, f_6, 1, class455_7, i_8, i_9);
	}

	public abstract void method2798(float var1, float var2, float var3, float var4, float var5, float var6, int var7, int var8, int var9, int var10);

	public abstract void method2799(int var1, int var2, int var3, int var4, int var5, int var6, int var7);

	public abstract void method2800(float var1, float var2, float var3, float var4, float var5, float var6, int var7, Class455 var8, int var9, int var10);
	...
	public abstract void method2811(float var1, float var2, float var3, float var4, float var5, float var6, int var7, Class455 var8, int var9, int var10);

	public abstract void method2812(float var1, float var2, float var3, float var4, float var5, float var6, int var7, int var8, int var9, int var10);
