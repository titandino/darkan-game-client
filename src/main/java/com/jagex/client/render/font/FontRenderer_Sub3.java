...
import com.jagex.client.js5.loaders.CursorIndexLoader;
import com.jagex.net.BufferedConnectionContext;
import com.jagex.unknown.Class151;
...
public class FontRenderer_Sub3 extends FontRenderer {
	...
	public FontRenderer_Sub3(JavaRenderer hardwarerenderer_1, FontMetrics fontmetrics_2, SpriteDefinitions[] arr_3, int[] ints_4, int[] ints_5) {
	...
	public static void method14336(GraphNode_Sub1 class521_sub1_0, int i_1, boolean bool_2) {
		int i_4;
		int i_5;
		...
		HitsplatIndexLoader.method3612(class521_sub1_0.plane, i_4, i_5, 0, i_1, bool_2);
	}
	...
	public static boolean method14338(BufferedConnectionContext class184_0) {
		try {
	...
	public static void method14341() {
	...
	public void method14325(byte[] bytes_1, int[] ints_2, int i_3, int i_4, int i_5, int i_6, int i_7, int i_8, int i_9) {
		int i_10 = -(i_6 >> 2);
		i_6 = -(i_6 & 0x3);
	...
	public void method14326(byte[] bytes_1, int[] ints_2, int[] ints_3, int i_5, int i_6, int i_7, int i_8, int i_9, int i_10, int i_11, int i_12, int i_13, Class455 class455_14, int i_15, int i_16) {
	...
	public void method14327(byte[] bytes_1, int[] ints_2, int i_3, int i_4, int i_5, int i_6, int i_7, int i_8, int i_9, int i_10, int i_11, int i_12, Class455 class455_13, int i_14, int i_15) {
	...
	public void method14334(byte[] bytes_1, int[] ints_2, int[] ints_3, int i_4, int i_5, int i_6, int i_7, int i_8, int i_9) {
		int i_10 = -(i_6 >> 2);
		i_6 = -(i_6 & 0x3);
