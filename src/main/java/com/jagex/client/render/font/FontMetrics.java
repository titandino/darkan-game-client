...
public class FontMetrics {
	...
	public static String[] aStringArray4980 = new String[100];
	...
	public FontMetrics(byte[] bytes_1) {
	...
	public int splitLines(String string_1, int[] ints_2, String[] arr_3, Sprite[] arr_4, boolean bool_5) {
		if (string_1 == null) {
			return 0;
		} else {
			int i_7 = 0;
