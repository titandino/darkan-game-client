package com.jagex.client.render.font;

import com.jagex.HardwareRenderer;
...
public class FontRenderer_Sub4 extends FontRenderer {
	...
	public HardwareRenderer aGraphicalRenderer_Sub2_9321;
	public Interface6 anInterface6_9322;
	public Interface4 anInterface4_9320;

	public FontRenderer_Sub4(HardwareRenderer class505_sub2_1, FontMetrics fontmetrics_2, SpriteDefinitions[] arr_3, boolean bool_4) {
		...
		if (bool_4) {
			...
			if (!class505_sub2_1.method13954(Class150.aClass150_1951, Class76.aClass76_751)) {
				...
				anInterface6_9322 = class505_sub2_1.method14024(i_6, i_6, false, ints_22);
			} else {
				anInterface6_9322 = class505_sub2_1.method13957(Class150.aClass150_1951, i_6, i_6, false, bytes_28);
			}
		} else {
					...
					for (i_19 = 0; i_19 < i_13; i_19++) {
						for (i_20 = 0; i_20 < i_14; i_20++) {
							...
							if ((b_21 = bytes_26[i_18++]) != 0) {
								ints_29[i_17++] = -16777216 | ints_24[b_21 & 0xff];
							} else {
								++i_17;
							}
						}
			...
			anInterface6_9322 = class505_sub2_1.method14024(i_6, i_6, false, ints_29);
		}

		anInterface6_9322.method205(Class35.aClass35_383);
		anInterface4_9320 = class505_sub2_1.method13994(false);
		anInterface4_9320.method31(20480, 20);
		ByteBuffer bytebuffer_30 = aGraphicalRenderer_Sub2_9321.aByteBuffer8838;
		bytebuffer_30.clear();
		float f_31 = anInterface6_9322.method47(i_6) / i_6;
		float f_32 = anInterface6_9322.method62(i_6) / i_6;
		...
		for (i_10 = 0; i_10 < 256; i_10++) {
			...
			float f_39 = (i_5 * (i_10 % 16));
			float f_33 = (i_10 / 16 * i_5);
			float f_34 = f_39 * f_31;
			float f_35 = f_33 * f_32;
			float f_36 = (f_39 + i_13) * f_31;
			float f_37 = (f_33 + i_12) * f_32;
			bytebuffer_30.putFloat(i_15);
			bytebuffer_30.putFloat(i_14);
			bytebuffer_30.putFloat(0.0F);
			bytebuffer_30.putFloat(f_34);
			bytebuffer_30.putFloat(f_35);
			bytebuffer_30.putFloat(i_15);
			bytebuffer_30.putFloat((i_14 + i_12));
			bytebuffer_30.putFloat(0.0F);
			bytebuffer_30.putFloat(f_34);
			bytebuffer_30.putFloat(f_37);
			bytebuffer_30.putFloat((i_15 + i_13));
			bytebuffer_30.putFloat((i_14 + i_12));
			bytebuffer_30.putFloat(0.0F);
		...
		anInterface4_9320.method42(0, bytebuffer_30.position(), aGraphicalRenderer_Sub2_9321.aLong8695);
		class505_sub2_1.method13896(12);
	}

	@Override
	public void c(char var_1, int i_2, int i_3, int i_4, boolean bool_5) {
		aGraphicalRenderer_Sub2_9321.method13935();
		aGraphicalRenderer_Sub2_9321.method13904(1);
		...
		class47_6.anInterface4_445 = anInterface4_9320;
		class47_6.anInt446 = var_1 * 4;
		class47_6.aClass70_447 = aGraphicalRenderer_Sub2_9321.aClass70_8832;
		class47_6.method936();
	}

	@Override
	public void method362(char var_1, int i_2, int i_3, int i_4, boolean bool_5, Class455 class455_6, int i_7, int i_8) {
	}

	@Override
	public void UA(char var_1, int i_2, int i_3, int i_4, boolean bool_5) {
		aGraphicalRenderer_Sub2_9321.method13935();
		aGraphicalRenderer_Sub2_9321.method13904(1);
		Class47 class47_6 = aGraphicalRenderer_Sub2_9321.aClass47_8698;
		class47_6.anInterface6_443 = anInterface6_9322;
	...
	@Override
	public void method374(char var_1, int i_2, int i_3, int i_4, boolean bool_5, Class455 class455_6, int i_7, int i_8) {
	}

	@Override
	public void t(char var_1, int i_2, int i_3, int i_4, boolean bool_5) {
		aGraphicalRenderer_Sub2_9321.method13935();
		aGraphicalRenderer_Sub2_9321.method13904(1);
		Class47 class47_6 = aGraphicalRenderer_Sub2_9321.aClass47_8698;
		class47_6.anInterface6_443 = anInterface6_9322;
