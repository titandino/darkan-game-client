...
import com.jagex.LocalizedText;
import com.jagex.Utils;
import com.jagex.client.js5.loaders.QuestIndexLoader;
import com.jagex.client.js5.loaders.SkyboxIndexLoader;
...
public abstract class FontRenderer {
	...
	public static String[] aStringArray69 = new String[100];
	public AbstractRenderer renderer;
	public FontMetrics fontMetrics;

	public FontRenderer(AbstractRenderer graphicalrenderer_1, FontMetrics fontmetrics_2) {
	...
	public abstract void method362(char var1, int var2, int var3, int var4, boolean var5, Class455 var6, int var7, int var8);

	public void method365(int i_1, int i_2) {
		int i_21 = i_2;
		anInt61 = -1;
		anInt62 = -1;
		anInt63 = i_1;
	...
	public void method369(String string_1) {
		try {
	...
	public void method370(String string_1, int i_2) {
		int i_4 = 0;
	...
	public void method371(String string_1, int i_2, int i_3, NativeSprite[] arr_4, int[] ints_5, Class455 class455_6, int i_7, int i_8) {
	...
	public void method372(String string_1, int i_2, int i_3, NativeSprite[] arr_4, int[] ints_5, int[] ints_6, int[] ints_7) {
		i_3 -= fontMetrics.verticalSpacing;
		int i_9 = -1;
		int i_10 = -1;
		int i_11 = 0;
	...
	public abstract void UA(char var1, int var2, int var3, int var4, boolean var5);
	...
	public abstract void method374(char var1, int var2, int var3, int var4, boolean var5, Class455 var6, int var7, int var8);

	public abstract void c(char var1, int var2, int var3, int var4, boolean var5);

	public abstract void t(char var1, int var2, int var3, int var4, boolean var5);
