...
import com.jagex.client.js5.defs.models.materials.MaterialProp14;
...
public class FontRenderer_Sub1 extends FontRenderer {
	...
	public JavaRenderer aGraphicalRenderer_Sub3_8513;
	public int[] anIntArray8511;
	public int[] anIntArray8512;
	public byte[][] aByteArrayArray8509;
	public int[] anIntArray8510;
	public int[] anIntArray8514;

	public FontRenderer_Sub1(JavaRenderer hardwarerenderer_1, FontMetrics fontmetrics_2, SpriteDefinitions[] arr_3, int[] ints_4, int[] ints_5) {
	...
	public static int method13782(int i_0, int i_1) {
		byte b_3;
		if (i_1 > 20077) {
	...
	public static void method13783() {
		ParticlesPreference.anIntArray7920 = Class492.method8266();
	}

	public static void method13784(int i_0) {
	...
	public void method13771(byte[] bytes_1, int[] ints_2, int i_3, int i_4, int i_5, int i_6, int i_7, int i_8, int i_9) {
		int i_10 = -(i_6 >> 2);
		i_6 = -(i_6 & 0x3);
	...
	public void method13772(byte[] bytes_1, int[] ints_2, int i_3, int i_4, int i_5, int i_6, int i_7, int i_8, int i_9) {
		int i_10 = i_3 >>> 24;
		int i_11 = 255 - i_10;
	...
	public void method13773(byte[] bytes_1, int[] ints_2, int i_3, int i_4, int i_5, int i_6, int i_7, int i_8, int i_9, int i_10, int i_11, int i_12, Class455 class455_13, int i_14, int i_15) {
	...
	public void method13774(byte[] bytes_1, int[] ints_2, int i_3, int i_4, int i_5, int i_6, int i_7, int i_8, int i_9, int i_10, int i_11, int i_12, Class455 class455_13, int i_14, int i_15) {
		Class455_Sub3 packetsdecoder_16 = (Class455_Sub3) class455_13;
		int[] ints_17 = packetsdecoder_16.anIntArray9077;
		int[] ints_18 = packetsdecoder_16.anIntArray9078;
