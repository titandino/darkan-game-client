...
import com.jagex.client.js5.loaders.QuestIndexLoader;
...
public abstract class AbstractRenderer {
	...
	public static boolean[] aBoolArray5839 = new boolean[8];
	public ImageLoader textureCache;
	public int rendererId;
	public Class158 aClass158_5853;
	public Class158_Sub2 aClass158_Sub2_5841;
	public Hashtable<Canvas, Class158_Sub2> mapCanvasToTBD = new Hashtable<>();
	public int anInt5854 = -1;
	public Class158_Sub1[] aClass158_Sub1Array5833 = new Class158_Sub1[4];

	public AbstractRenderer(ImageLoader interface22_1) {
	...
	public static synchronized AbstractRenderer createRenderer(int type, Canvas canvas_1, ImageLoader interface22_2, Index index_3, int i_4, int i_5, int i_6) {
		if (type == 0) {
	...
	public static void method8695(EntityNode_Sub2 class275_sub2_0) {
	...
	public static CS2Script method8699(byte[] bytes_0) {
	...
	public abstract void method8397();
	...
	public void method8411(Canvas canvas_1, Class158_Sub2 class158_sub2_2) {
	...
	public void method8412(Canvas canvas_1) {
		...
		if (class158_sub2_3 == null) {
			throw new RuntimeException();
		} else if (anInt5854 <= 0 && aClass158_Sub2_5841 == aClass158_5853) {
	...
	public abstract Class158_Sub2 method8417(Canvas var1, int var2, int var3);
	...
	public abstract void CA(int var1, int var2, int var3, int var4);
	...
	public abstract NativeSprite createSprite(int[] pixels, int var2, int width, int height, int var5, boolean var6);
	...
	public Class158_Sub2 method8460() {
	...
	public abstract void method8485();

	public abstract void method8486();
	...
	public abstract void method8531();
	...
	public NativeSprite createNativeSprite(int[] pixels, int width, int height, int i_5) {
		return createSprite(pixels, 0, width, height, i_5, true);
	}
	...
	public abstract void method8555() throws Exception_Sub3;
	...
	public abstract Class158_Sub2 method8558(Canvas var1, int var2, int var3);
	...
	public abstract void method8592(float var1, float var2, float var3);
	...
	public abstract void method8596(int var1, int var2) throws Exception_Sub3;
	...
	public abstract void method8608(float var1, float var2, float var3, float var6);
	...
	public abstract void fw(int var1, int var2, int var3, int var4, int var5);
	...
	public abstract void fr(int var1, int var2, int var3, int var4, int var5);
