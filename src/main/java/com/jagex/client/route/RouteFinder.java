...
public class RouteFinder {
	...
	public static Class194 aClass194_3103;
	...
	public static boolean performCalculationS1(int srcX, int srcY, RouteStrategy strategy, ClipFlagMap clipMap) {
		int currentX = srcX;
		int currentY = srcY;
	...
	public static boolean performCalculationS2(int i_0, int i_1, RouteStrategy routestrategy_2, ClipFlagMap clipmap_3) {
		int i_5 = i_0;
		int i_6 = i_1;
		byte b_7 = 64;
		byte b_8 = 64;
	...
	public static boolean performCalculationSX(int i_0, int i_1, int i_2, RouteStrategy routestrategy_3, ClipFlagMap clipmap_4) {
		int i_6 = i_0;
		int i_7 = i_1;
		byte b_8 = 64;
		byte b_9 = 64;
