...
public class ParticlesPreference extends Preference {
	...
	public static int[] anIntArray7920;

	public ParticlesPreference(int i_1, ClientPreferences class282_sub54_2) {
		super(i_1, class282_sub54_2);
		Class15.method540(anInt5578);
	}

	public ParticlesPreference(ClientPreferences class282_sub54_1) {
		super(class282_sub54_1);
		Class15.method540(anInt5578);
	}

	public static short[][] method12805(float[][] floats_0, short[][] shorts_1) {
