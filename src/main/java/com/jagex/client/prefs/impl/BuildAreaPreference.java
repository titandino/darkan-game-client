...
public class BuildAreaPreference extends Preference {
	...
	public BuildAreaPreference(ClientPreferences class282_sub54_1) {
		super(class282_sub54_1);
	}

	public BuildAreaPreference(int i_1, ClientPreferences class282_sub54_2) {
		super(i_1, class282_sub54_2);
	}

	public static boolean method12619() {
		return Class86.method1481(Class149_Sub2.DEFAULTS_LOADER_7.aClass232_5877);
	}

	public static int method12620(WorldDescriptor world1, WorldDescriptor world2, int i_2, boolean bool_3) {
		int i_5;
		int i_6;
		if (i_2 == 1) {
