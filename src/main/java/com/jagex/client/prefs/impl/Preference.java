...
public abstract class Preference {
	...
	public ClientPreferences manager;

	public Preference(int i_1, ClientPreferences class282_sub54_2) {
		anInt5578 = i_1;
		manager = class282_sub54_2;
	}

	public Preference(ClientPreferences class282_sub54_1) {
	...
	public abstract int checkValid(int var1);
