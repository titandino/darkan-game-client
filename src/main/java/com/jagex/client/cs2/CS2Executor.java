...
public class CS2Executor {
	...
	public static int CURRENT_CS2_EXEC_IDX;
	public static ArrayList<CS2Executor> CS2_EXECUTORS = new ArrayList<CS2Executor>();
	public static int anInt5904;
	public static String aString5897;
	public static boolean aBool5898;
	public static int[] anIntArray5900 = new int[3];
	...
	public Class191 aClass191_7008;
	public QuickChatMessage currentQuickChatMessage;
	public ClanSettings currentClanSettings;
	public ClanChannel clanChannel;
	public WorldObject activeWorldObject;
	public GroundItem currentGroundItem;
	public Object[] objectLocals;
	public int[] intOpValues;
	public CS2Script current;
	public boolean aBool7022;
	...
	public Object[] stringStack = new Object[1000];
	public int stringStackPtr;

	public int returnValuesPtr;
	public CS2ReturnValue[] returnValues = new CS2ReturnValue[50];
	public CS2Interface hookedInterface1 = new CS2Interface();
	public CS2Interface hookedInterface2 = new CS2Interface();
	public int hookRequestCount;
	public int instrPtr = -1;
	...
	public static void method11251(String string_0) {
		System.out.println("Error: " + CutsceneAction.method1609(string_0, "%0a", "\n"));
	}

	public static void method1834(ClientTriggerType class397_0, int interfaceId, int i_2, CS2Executor cs2executor_3) {
	...
	public static void executeScript(CS2Script cs2script_0, int stackLimit, CS2Executor cs2executor_2) {
	...
	public static void executeHookInner(HookRequest hook, int stackLimit) {
	...
	public static void decrementCS2ExecIdx() {
		--CURRENT_CS2_EXEC_IDX;
	}

	public static CS2Executor getNextScriptExecutor() {
