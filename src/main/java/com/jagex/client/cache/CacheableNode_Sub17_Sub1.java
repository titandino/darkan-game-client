...
public class CacheableNode_Sub17_Sub1 extends Shadow {
	...
	public byte[] aByteArray10297;
	public int anInt10293;
	public int anInt10295;
	public int anInt10296;
	public int anInt10294;

	public CacheableNode_Sub17_Sub1(int i_2, int i_3) {
		aByteArray10297 = new byte[i_3 * i_2];
	}

	public static void method15709(byte[] bytes_0, int i_1, int i_2, int i_3, int i_4) {
		int i_21 = i_2;
		if (i_3 < i_4) {
			i_1 += i_3;
			i_21 = i_4 - i_3 >> 2;
	...
	public void method15713(int i_1, int i_2, int i_3, int i_4, int i_5, int i_6) {
		int i_61 = i_6;
		int i_51 = i_5;
		int i_11 = i_1;
		int i_41 = i_4;
	...
	public boolean method15716(int i_1, int i_2) {
		return aByteArray10297.length >= i_2 * i_1;
	}

	public void method15721(int i_1, int i_2, int i_3, int i_4) {
		anInt10293 = i_1;
		anInt10295 = i_2;
		anInt10296 = i_3 - i_1;
		anInt10294 = i_4 - i_2;
