...
public class CacheableNode_Sub17_Sub2 extends Shadow {
	...
	public byte[] aByteArray10454;

	public CacheableNode_Sub17_Sub2(int i_2, int i_3) {
		aByteArray10454 = new byte[i_3 * i_2];
	}

	public static void method16046(byte[] bytes_0, int i_1, int i_2, int i_3, int i_4) {
		int i_21 = i_2;
		if (i_3 < i_4) {
			i_1 += i_3;
			i_21 = i_4 - i_3 >> 2;
	...
	public boolean method16039(int i_1, int i_2) {
		return aByteArray10454.length >= i_2 * i_1;
	}

	public void method16040(int i_1, int i_2, int i_3, int i_4) {
		anInt10453 = i_1;
		anInt10455 = i_2;
		anInt10452 = i_3 - i_1;
		anInt10451 = i_4 - i_2;
	...
	public void method16043(int i_1, int i_2, int i_3, int i_4, int i_5, int i_6) {
		int i_61 = i_6;
		int i_51 = i_5;
		int i_11 = i_1;
		int i_41 = i_4;
