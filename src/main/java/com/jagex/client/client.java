...
import com.jagex.client.input.KeyRecord;
import com.jagex.client.input.MouseRecord;
import com.jagex.client.js5.*;
import com.jagex.client.js5.defaultfiles.impl.Defaults8Loader;
import com.jagex.client.js5.defs.*;
import com.jagex.client.js5.defs.models.materials.MaterialProp23;
import com.jagex.client.js5.defs.models.materials.MaterialProp8;
import com.jagex.client.js5.defs.models.materials.MaterialPropTexture;
import com.jagex.client.js5.loaders.*;
import com.jagex.client.prefs.impl.ParticlesPreference;
import com.jagex.client.prefs.impl.ScreenSizePreference;
...
public class client extends Engine {
	...
	public static boolean aBool7147;
	public static String aString7281;
	public static String aString7156;
	public static boolean aBool7160;
	public static boolean aBool7161;
	public static int anInt7163 = -1;
	public static String aString7164;
	public static Matrix44 aClass384_7167 = new Matrix44();
	public static Matrix44Var aClass294_7457 = new Matrix44Var();
	public static Matrix44Var aClass294_7169 = new Matrix44Var();
	public static long aLong7170;
	public static boolean aBool7172 = true;
	public static boolean DRAW_DEBUG;
	public static boolean aBool7177;
	public static boolean aBool7241;
	public static boolean aBool7372 = true;
	public static long aLong7409 = (long) (Math.random() * 9.999999999E9D);
	...
	public static LRUCache aClass229_7204 = new LRUCache(8);
	public static String aString7463;
	public static int npcListSize;
	public static int[] NPC_INDICES = new int[261];
	public static int anInt7332;
	public static int anInt7216;
	public static int[] anIntArray7421 = new int[1005];
	public static int anInt7221;
	public static boolean aBool7459;
	public static int anInt7357;
	public static int anInt7235;
	public static int[] anIntArray7243;
	public static int[] anIntArray7425;
	public static int[] walkStepsX;
	public static int[] walkStepsY;
	public static int[] NPC_TURN_DIRECTIONS;
	public static int anInt7248;
	public static int anInt7249;
	public static int anInt7250;
	public static int anInt7251;
	public static int anInt7343;
	public static int anInt7253;
	public static int anInt7418;
	...
	public static Random aRandom7260;
	public static int anInt7261;
	public static float aFloat7266;
	public static float aFloat7284;
	public static boolean aBool7331;
	public static boolean aBool7269;
	public static int anInt7273;
	public static boolean aBool7355;
	public static boolean aBool7285;
	public static int[] anIntArray7287;
	public static int[] anIntArray7288;
	public static int anInt7304;
	public static EntityList aClass457_7290;
	...
	public static int[] anIntArray7198;
	public static int[] anIntArray7303;
	public static int[] anIntArray7194;
	public static int[] anIntArray7305;
	public static int[] anIntArray7306;
	public static long aLong7307;
	public static boolean resizeableScreen;
	public static int anInt7309;
	public static int anInt7205;
	public static boolean aBool7322;
	public static boolean REDUCE_ATTACK_PRIORITY;
	public static short[] aShortArray7239;
	public static int[] PLAYER_OPTION_CURSORS;
	public static String[] PLAYER_OPTIONS;
	public static boolean[] PLAYER_OPTION_REDUCED_PRIORITY;
	public static int anInt7311;
	public static int anInt7339;
	public static int anInt7427;
	public static int anInt7345;
	public static int anInt7346;
	public static int anInt7351;
	public static boolean aBool7168;
	public static boolean aBool7264;
	public static boolean aBool7358;
	public static IComponentDefinitions aClass118_7257;
	public static IComponentDefinitions aClass118_7247;
	public static int anInt7361;
	public static int anInt7362;
	public static IComponentDefinitions aClass118_7370;
	public static boolean aBool7403;
	public static int anInt7432;
	public static int anInt7265;
	public static int anInt7367;
	public static int anInt7476;
	public static boolean aBool7369;
	public static int anInt7252;
	public static int anInt7215;
	public static boolean aBool7364;
	public static int anInt7184;
	public static boolean aBool7374;
	public static boolean aBool7375;
	public static int[] anIntArray7379;
	public static int anInt7453;
	public static int[] anIntArray7381;
	public static int anInt7382;
	public static int[] anIntArray7283;
	public static int anInt7384;
	public static int[] anIntArray7150;
	public static int anInt7368;
	public static int[] anIntArray7387;
	public static int anInt7388;
	public static int[] CLAN_VAR_KEYS;
	public static int CLAN_VAR_COUNTER;
	public static int anInt7386;
	public static int anInt7179;
	public static int anInt7192;
	public static int anInt7395;
	public static int anInt7320;
	public static int anInt7397;
	public static long VARCS_LAST_SAVED;
	public static NodeCollection aClass482_7233;
	public static NodeCollection aClass482_7404;
	public static IterableNodeMap ICOMPONENT_SETTINGS_SLOTS;
	public static int anInt7407;
	public static int anInt7408;
	public static boolean[] aBoolArray7410;
	public static Rectangle[] aRectangleArray7411;
	public static int anInt7412;
	public static int[] anIntArray7438;
	public static int anInt7415;
	public static int anInt7366;
	public static int[] anIntArray7420;
	public static int[] anIntArray7417;
	public static int[] anIntArray7263;
	public static Class163[] aClass163Array7419;
	public static int[] anIntArray7148;
	public static long[] aLongArray7424;
	public static int anInt7389;
	public static int anInt7429;
	public static boolean[] CAM_SHAKING;
	public static int[] anIntArray7268;
	public static int[] anIntArray7433;
	public static int[] anIntArray7462;
	public static int[] anIntArray7435;
	public static int anInt7444;
	public static int anInt7445;
	public static int anInt7451;
	public static EntityList aClass457_7350;
	public static Calendar aCalendar7278;
	public static int[] anIntArray7461;
	...
	public static void method11619() {
	...
	public static void method11626() {
	...
	public static void method11627() {
	...
	public static void method11628(int i_0) {
	...
	public static void method11629(int i_0) {
		int i_1 = Class197.NUM_PLAYER_INDICES;
		int[] ints_2 = Class197.PLAYER_INDICES;
		int[][] ints_3 = IndexLoaders.MAP_REGION_DECODER.method4437();
		int[][] ints_4 = IndexLoaders.MAP_REGION_DECODER.method4438();
	...
	public static IComponentDefinitions method11634(IComponentDefinitions icomponentdefinitions_0) {
	...
	public static boolean method11651(IComponentDefinitions icomponentdefinitions_0) {
		if (aBool7168) {
	...
	public static void method11750() {
		anInt7304 = 0;
						...
						if (iCompDef.usesScripts || iCompDef.contentType != 0) {
							...
							if (iCompDef.anObjectArray1403 != null && anInt7368 > iCompDef.anInt1446) {
								if (iCompDef.anIntArray1315 != null && anInt7368 - iCompDef.anInt1446 <= 32) {
									label969:
									for (i_24 = iCompDef.anInt1446; i_24 < anInt7368; i_24++) {
							...
							if (iCompDef.anObjectArray1405 != null && anInt7388 > iCompDef.anInt1447) {
								if (iCompDef.anIntArray1406 != null && anInt7388 - iCompDef.anInt1447 <= 32) {
									label945:
									for (i_24 = iCompDef.anInt1447; i_24 < anInt7388; i_24++) {
							...
							if (iCompDef.anObjectArray1397 != null && anInt7453 > iCompDef.anInt1443) {
								if (iCompDef.varps != null && anInt7453 - iCompDef.anInt1443 <= 32) {
									label921:
									for (i_24 = iCompDef.anInt1443; i_24 < anInt7453; i_24++) {
							...
							if (iCompDef.anObjectArray1387 != null && anInt7384 > iCompDef.anInt1445) {
								if (iCompDef.anIntArray1402 != null && anInt7384 - iCompDef.anInt1445 <= 32) {
									label873:
									for (i_24 = iCompDef.anInt1445; i_24 < anInt7384; i_24++) {
							...
							if (iCompDef.anObjectArray1407 != null && CLAN_VAR_COUNTER > iCompDef.anInt1448) {
								if (iCompDef.anIntArray1408 != null && CLAN_VAR_COUNTER - iCompDef.anInt1448 <= 32) {
									label849:
									for (i_24 = iCompDef.anInt1448; i_24 < CLAN_VAR_COUNTER; i_24++) {
	...
	public static void method12073(int i_0, int i_1) {
		if (Game.stellarDawn != CURRENT_GAME) {
	...
	public void pulse() {
		if (GAME_STATE != 16) {
			...
			if (Class504.loadingState(GAME_STATE)) {
				ParticlesPreference.method12808();
	...
	public void updateNetStatus(int i_1) {
		MaterialProp8.clientSocket = null;
		Class47_Sub1.updateConnection = null;
		updateStage = 0;
		...
		for (i_2 = 0; i_2 < anInt7210; i_2++) {
			...
			if (npc_3 != null) {
				...
				if ((b_4 & 0x1) != 0) {
					...
					Class236.getAnimationForSpeed(npc_3, IdentikitDefinition.anInt430);
								...
								while (true) {
									do {
										...
										if (hookrequest_13 == null) {
											...
											if (NEEDS_VARC_SAVE && VARCS_LAST_SAVED < Utils.time() - 60000L) {
												ClanSetting.saveVarcsToFile();
											}
