...
import com.jagex.*;
import com.jagex.client.js5.defs.models.materials.MaterialProp15;
import com.jagex.client.js5.loaders.AnimationIndexLoader;
import com.jagex.client.js5.loaders.HeadbarIndexLoader;
import com.jagex.client.js5.loaders.InventoriesIndexLoader;
import com.jagex.client.js5.loaders.SunIndexLoader;
import com.jagex.client.render.canvas.Canvas_Sub1;
import com.jagex.game.content.clans.settings.ChangeClanSetting;
import com.jagex.game.content.cutscenes.CutsceneEntity;
import com.jagex.game.content.cutscenes.actions.CutsceneAction_Sub23;
...
public abstract class Engine implements Interface24, Runnable, FocusListener, WindowListener {
	...
	public static String aString3252;
	public static volatile boolean aBool3274 = true;
	public static volatile boolean aBool3257;
	public static boolean aBool3259;
	public static UID192 aClass440_3270;
	public static long NANOSECONDS_PER_FRAME = 20000000L;
	public static long[] aLongArray3246 = new long[32];
	public static long[] PULSE_TIMES = new long[32];
	public static int anInt3256 = 500;
	public static volatile long aLong3280;
	public static volatile boolean aBool3275 = true;
	public static UID192 PLAYER_UID192;
	public static UID192 aClass440_3271;
	public static Class279 aClass279_3267;
	public static long GAME_LOOP_TIMEOUT;
	public static boolean SHUTDOWN;
	public static File aFile3264;
	public static int LOGIC_PULSES_TO_PROCESS;
	public boolean aBool3254;
	public boolean aBool3268;

	public static int method4777(int i_0, int i_1) {
	...
	public void method4655(Class274 class274_1, String string_2, String string_3, int i_4, int i_5, boolean bool_8) {
		try {
	...
	public void method4656(String string_1, String string_2, int i_3, int i_4) throws Exception {
		...
		aClass440_3270 = new UID192(new FileStream(CutsceneAction_Sub23.method14681("main_file_cache.dat2"), 524288000L), 5200);
		aClass440_3271 = new UID192(new FileStream(CutsceneAction_Sub23.method14681("main_file_cache.idx255"), 1048576L), 6000);
		Class97.aClass440Array996 = new UID192[HeadbarIndexLoader.anInt3451];
		for (i_13 = 0; i_13 < HeadbarIndexLoader.anInt3451; i_13++) {
			Class97.aClass440Array996[i_13] = new UID192(new FileStream(CutsceneAction_Sub23.method14681("main_file_cache.idx" + i_13), 1048576L), 6000);
		}
		try {
	...
	public File method4657(String string_1, String string_2, int i_3) {
		...
		if (Canvas_Sub1.aFile9453.exists()) {
			try {
				FileStream fileStream_9 = new FileStream(Canvas_Sub1.aFile9453, 10000L);
				ByteBuf rsbytebuffer_11;
				for (rsbytebuffer_11 = new ByteBuf((int) fileStream_9.getLength()); rsbytebuffer_11.index < rsbytebuffer_11.buffer.length; rsbytebuffer_11.index += i_10) {
					i_10 = fileStream_9.readBytes(rsbytebuffer_11.buffer, rsbytebuffer_11.index, rsbytebuffer_11.buffer.length - rsbytebuffer_11.index);
					if (i_10 == -1) {
	...
	public void method4659(File file_1, File file_2) {
		try {
			FileStream fileStream_4 = new FileStream(Canvas_Sub1.aFile9453, 10000L);
			...
			fileStream_4.writeBytes(rsbytebuffer_5.buffer, 0, rsbytebuffer_5.index);
			fileStream_4.close();
	...
	public synchronized void method4661(String string_1) {
	...
	public void method4663(Container container_1) {
	...
	public void processUpdatePulse() {
	...
	public abstract void method4676();

	public abstract void pulseLogic();

	public abstract void pulseUpdate();

	public void method4680(String string_1) {
		if (!aBool3254) {
			aBool3254 = true;
	...
	public void method4683(Class279 class279_1, boolean bool_2) {
		if (class279_1 == null) {
	...
	public abstract void method4686();

	public abstract void method4690();
	...
	public synchronized void method4704() {
		method4729();
	...
	public abstract void method4714();

	public boolean method4720(File file_1, boolean bool_2) {
		try {
	...
	public abstract void method4738();
