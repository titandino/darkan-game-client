...
import com.jagex.unknown.Class190;
...
public class JS5CacheFile {
	...
	public static long aLong2577;

	public static byte[] aByteArray2576 = new byte[520];

	public UID192 aClass440_2573;

	public UID192 aClass440_2574;

	public int anInt2572 = 65000;
	...
	public boolean method3349(int i_1, byte[] bytes_2, int i_3, boolean bool_4) {
