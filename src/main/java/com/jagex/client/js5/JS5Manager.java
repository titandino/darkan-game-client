...
import com.Loader;
import com.jagex.GraphNode_Sub1_Sub1;
import com.jagex.PaddedJS5Request;
import com.jagex.RenderFlagMap;
import com.jagex.WorldObject;
...
public class JS5Manager {
	...
	public PaddedJS5Request tableRequest;

	public JS5GrabWorker[] grabWorkers;
	...
	public BigInteger updateServerExponent;

	public BigInteger updateServerModulus;
	...
	public static boolean method5491(char var_0) {
	...
	public static boolean method5492(Class293[][][] arr_0, int i_1, int i_2, int i_3, boolean bool_4) {
	...
	public JS5GrabWorker method5478(int i_1, JS5CacheFile js5cachefile_2, JS5CacheFile js5cachefile_3) {
		if (buffer == null) {
			throw new RuntimeException();
