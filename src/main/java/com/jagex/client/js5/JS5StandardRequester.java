...
public abstract class JS5StandardRequester {
	...
	public PaddedJS5Request request(int i_1, int i_2, byte b_3, boolean bool_4) {
	...
	public abstract void method5539();

	public abstract void method5540();
