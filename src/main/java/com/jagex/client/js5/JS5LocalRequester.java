...
public class JS5LocalRequester implements Runnable {
	...
	public Queue aClass477_3664 = new Queue();
	public int anInt3662;
	public boolean aBool3661;
	public Thread aThread3663 = new Thread(this);
	...
	public CacheableNode_Sub11_Sub2 method5564(int i_1, byte[] bytes_2, JS5CacheFile js5cachefile_3) {
	...
	public CacheableNode_Sub11_Sub2 method5567(int i_1, JS5CacheFile js5cachefile_2) {
	...
	public void method5569(CacheableNode_Sub11_Sub2 class282_sub50_sub11_sub2_1) {
	...
	public CacheableNode_Sub11_Sub2 method5578(int i_1, JS5CacheFile js5cachefile_2) {
		CacheableNode_Sub11_Sub2 class282_sub50_sub11_sub2_4 = new CacheableNode_Sub11_Sub2();
