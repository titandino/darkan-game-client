...
import com.jagex.client.js5.defaultfiles.impl.EntityDefaults;
...
public class IndexLoaders {
	...
	public static BASIndexLoader RENDER_ANIM_LOADER;
	...
	public static LoadingStage LOADING_STAGE;
	public static boolean USING_JAGEX_IMAGE_FORMAT;
	...
	public static int initializeGame() {
		...
		if (LOADING_STAGE == LoadingStage.aClass387_4700) {
			...
			ParticlesPreference.method12806(SPRITES_INDEX);
		...
		if (LoadingStage.aClass387_4716 == LOADING_STAGE) {
			...
			AbstractQueue_Sub1.DEFAULT_SKIN_COLOURS = QuickchatFiller.ENTITY_DEFAULTS.originalColours;
		...
		if (LoadingStage.aClass387_4704 == LOADING_STAGE) {
			...
			RENDER_ANIM_LOADER = new BASIndexLoader(CONFIG_INDEX, LinkedNodeList.EQUIPMENT_DEFAULTS);
			...
			HITSPLAT_LOADER = new HitsplatIndexLoader(CONFIG_INDEX, SPRITES_INDEX);
		...
		if (LoadingStage.aClass387_4707 == LOADING_STAGE) {
			...
			CS2Interpreter.VARC_STRING = new String[VARC_STRING_LOADER.size];
