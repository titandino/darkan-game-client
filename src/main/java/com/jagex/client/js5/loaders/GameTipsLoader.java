...
public class GameTipsLoader {
	...
	public Index tipsIndex;
	public Class402[] aClass402Array4818;
	public int anInt4820;

	public GameTipsLoader(Index tipsIndex) {
		this.tipsIndex = tipsIndex;
		ByteBuf buffer = new ByteBuf(this.tipsIndex.getFile(0, 0));
	...
	public static String method6793(String string_0) {
	...
	public Class402 method6784(int i_1, int i_2) {
		if (anInt4820 == -1) {
