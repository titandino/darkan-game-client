...
public class QuestIndexLoader {
	...
	public static SpriteDefinitions aClass91_2981;
	...
	public static void method4164(int i_0, int i_1) {
	...
	public static Class149_Sub3 method4165(ByteBuf rsbytebuffer_0) {
	...
	public int method4154(VarProvider interface42_1) {
		int i_3 = 0;
