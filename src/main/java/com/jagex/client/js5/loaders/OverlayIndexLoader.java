...
public class OverlayIndexLoader {
	...
	public OverlayDefinitions getOverlayDef(int i_1) {
		LRUCache softcache_4 = aClass229_7092;
		OverlayDefinitions overlaydef_3;
		synchronized (aClass229_7092) {
			overlaydef_3 = (OverlayDefinitions) aClass229_7092.get(i_1);
		}
		if (overlaydef_3 != null) {
			...
			overlaydef_3 = new OverlayDefinitions();
