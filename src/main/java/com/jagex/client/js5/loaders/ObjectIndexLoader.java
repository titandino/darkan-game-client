...
import com.jagex.unknown.Class452;
...
public class ObjectIndexLoader {
	...
	public RSMesh[] aClass157Array5616 = new RSMesh[4];

	public Class452 aClass452_5620 = new Class452(null, null);

	public LRUCache LRUCache = new LRUCache(256);

	public LRUCache aClass229_5614 = new LRUCache(500);

	public LRUCache aClass229_5615 = new LRUCache(30);

	public LRUCache aClass229_5619 = new LRUCache(50);
