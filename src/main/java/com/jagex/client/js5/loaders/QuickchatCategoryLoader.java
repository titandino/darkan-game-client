...
import com.jagex.client.js5.defs.QuickChatCategoryDefinitions;
import com.jagex.client.js5.defs.animations.AnimationDefinitions;
import com.jagex.client.js5.defs.models.materials.MaterialProp35;
				...
				if ((i_7 & 0x1) != 0) {
					if (i_6 == -1) {
						...
						if (class456_sub2_sub1_12 != null && class456_sub2_sub1_12.hasDefs()) {
							if (i_6 == class456_sub2_sub1_12.currentAnimationId()) {
								if (i_11 == 0) {
									animable.aAnimation_Sub2_Sub1Array10354[i_9] = null;
