...
import com.jagex.unknown.Class353;
import com.jagex.unknown.Class356;
import com.jagex.unknown.Class372;
import com.jagex.unknown.Class62;

public class VarDefinitionLoader implements IndexLoader {

	public static Thread aThread4520;
	public int size;
	public LRUCache aClass229_4517 = new LRUCache(64);
	public Index varIndex;
	...
	public static void method6394(AbstractRenderer graphicalrenderer_0, int i_1, int i_2, int i_3, int i_4, int i_5) {
