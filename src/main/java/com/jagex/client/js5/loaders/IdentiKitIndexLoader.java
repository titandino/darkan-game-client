...
import com.jagex.unknown.Class383;
...
public class IdentiKitIndexLoader implements IndexLoader {
	...
	public LRUCache aClass229_360 = new LRUCache(64);
	public Index aClass317_358;
	...
	public IdentikitDefinition getIdentiKit(int id) {
		IdentikitDefinition class44_3;
		synchronized (aClass229_360) {
			class44_3 = (IdentikitDefinition) aClass229_360.get(id);
		}
		if (class44_3 != null) {
			return class44_3;
		} else {
			...
			synchronized (aClass317_358) {
				bytes_10 = aClass317_358.getFile(SharedConfigsType.IdentiKit.id, id);
			}
			class44_3 = new IdentikitDefinition();
			class44_3.aClass31_429 = this;
			class44_3.id = id;
			if (bytes_10 != null) {
				class44_3.decode(new ByteBuf(bytes_10));
			}
			LRUCache softcache_9 = aClass229_360;
			synchronized (aClass229_360) {
				aClass229_360.put(class44_3, id);
				return class44_3;
			}
		}
	}
