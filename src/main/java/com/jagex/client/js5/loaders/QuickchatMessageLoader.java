...
public class QuickchatMessageLoader {
	...
	public LRUCache aClass229_5131 = new LRUCache(64);
	public Interface19 anInterface19_5134;
	public Index messagesIndex;
	public Index menusIndex;
	...
	public String method7212(QuickChatValueType value, int[] configs, long data) {
