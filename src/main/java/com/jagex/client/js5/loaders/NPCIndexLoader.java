...
import com.jagex.unknown.Class111;

public class NPCIndexLoader {

	public int anInt4845;

	public LRUCache aClass229_4841 = new LRUCache(64);

	public LRUCache aClass229_4836 = new LRUCache(50);

	public LRUCache meshCache = new LRUCache(5);

	public Game aClass486_4844;

	public Language aClass495_4837;

	public boolean aBool4838;

	public Index aClass317_4839;

	public Index aClass317_4842;

	public String[] aStringArray4840;
	...
	public static Class111[] method6852() {
