...
import com.jagex.unknown.Class351;
...
public class UnderlayIndexLoader {
	...
	public LRUCache cache = new LRUCache(128);
	...
	public static void method8036(int i_0) {
		int i_01 = i_0;
	...
	public UnderlayDefinitions getUnderlayDef(int i_1) {
		LRUCache softcache_4 = cache;
		UnderlayDefinitions underlaydef_3;
		synchronized (cache) {
			underlaydef_3 = (UnderlayDefinitions) cache.get(i_1);
		}
		if (underlaydef_3 != null) {
			...
			underlaydef_3 = new UnderlayDefinitions();
			if (bytes_10 != null) {
