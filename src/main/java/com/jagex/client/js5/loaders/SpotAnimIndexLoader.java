...
public class SpotAnimIndexLoader {
	...
	public static Font aFont5893;

	public LRUCache aClass229_5891 = new LRUCache(64);

	public LRUCache aClass229_5890 = new LRUCache(60);

	public Index aClass317_5888;

	public Index aClass317_5889;
