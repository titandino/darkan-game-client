...
public class LightIntensityIndexLoader {
	...
	public static void method7313(SubInterface ifSub, int baseWindowId, int leftBound, int lowerBound, int rightBound, int upperBound, int x, int y, int mouseX, int mouseY) {
