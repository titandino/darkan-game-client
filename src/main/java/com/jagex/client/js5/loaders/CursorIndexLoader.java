...
import com.jagex.client.prefs.impl.GraphicsPreference;
...
public class CursorIndexLoader {
	...
	public LRUCache aClass229_5344 = new LRUCache(64);
	public LRUCache aClass229_5342 = new LRUCache(2);
	public Index configIndex;
	public Index spritesIndex;
	...
	public static void createProjectile(int spotAnimId, int source, int lockOn, int basOffIdx, int startHeight, int endHeight, int localX, int localY, int xOff, int yOff, int startTime, int endTime, int angle, int slope, boolean useFloorHeight) {
