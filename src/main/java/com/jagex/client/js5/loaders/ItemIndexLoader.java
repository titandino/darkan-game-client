...
import com.jagex.client.js5.defs.ParamDefinitions;
...
import com.jagex.unknown.Class212;
...
public class ItemIndexLoader implements IndexLoader {
	...
	public LRUCache cache = new LRUCache(64);
	public LRUCache aClass229_5115 = new LRUCache(50);
	public SoftwareItemRender softwareItemRender = new SoftwareItemRender();
	public Game game;
	public Language language;
	public ParamIndexLoader attrDefaults;
	public Index fs19;
	public Index meshIndex;
	public String[] defaultGroundOptions;
	public String[] defaultInventoryOptions;
	...
	public static String method7169(int i_0, int i_1) {
		int i_3 = i_1 - i_0;
	...
	public static String method7171(IComponentDefinitions icomponentdefinitions_0, int i_1) {
