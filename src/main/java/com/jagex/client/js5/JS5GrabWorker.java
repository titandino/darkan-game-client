...
import com.jagex.*;
import com.jagex.client.cache.CacheableNode_Sub11_Sub2;
import com.jagex.game.entity.player.creation.AccountCreationStage;
import com.jagex.unknown.Class361;

import java.util.zip.CRC32;

public class JS5GrabWorker extends JS5FileWorker {

	public static CRC32 aCRC32_7804 = new CRC32();

	public JS5CacheRequest refTableReq;

	public ReferenceTable table;

	public byte[] aByteArray7792;

	public int anInt7793;

	public boolean aBool7795;

	public NodeCollection coll;

	public IterableNodeMap aClass465_7796 = new IterableNodeMap(16);

	public int anInt7797;

	public NodeCollection aClass482_7807 = new NodeCollection();

	public long aLong7785;

	public int indexId;

	public JS5CacheFile dataFile;

	public boolean hasDataFile;

	public JS5CacheFile refsFile;

	public JS5StandardRequester standardRequester;

	public JS5LocalRequester localRequester;

	public int tableCRC;

	public byte[] tableDigest;

	public int tableRevision;

	public boolean aBool7801;

	public JS5GrabWorker(int i_1, JS5CacheFile js5cachefile_2, JS5CacheFile js5cachefile_3, JS5StandardRequester js5standardrequester_4, JS5LocalRequester js5localrequester_5, int i_6, byte[] bytes_7, int i_8) {
		indexId = i_1;
	...
	public static boolean method12562() {
	...
	@Override
	public void method5812(int i_1) {
		if (dataFile != null) {
			Node node_2;
	...
	@Override
	public byte[] method5804(int i_1) {
	...
	@Override
	public void method5805(int i_1) {
		if (dataFile != null) {
			Node node_3;
	...
	public JS5CacheRequest method12546(int i_1, int i_2) {
	...
	@Override
	public ReferenceTable method5807() {
		if (table != null) {
			return table;
		} else {
			if (refTableReq == null) {
	...
	@Override
	public byte[] method5809(int i_1) {
	...
	@Override
	public byte[] method5811(int i_1) {
		JS5CacheRequest js5cacherequest_2 = method12546(i_1, 0);
		if (js5cacherequest_2 == null) {
			return null;
		} else {
	...
	@Override
	public void method5808(int i_1) {
		if (dataFile != null) {
			Node node_2;
			for (node_2 = aClass482_7807.head(); node_2 != null; node_2 = aClass482_7807.next()) {
				if (-3442165056282524525L * node_2.pointer * -1253863389874800229L == i_1) {
	...
	@Override
	public byte[] method5813(int i_1) {
		JS5CacheRequest js5cacherequest_2 = method12546(i_1, 0);
		if (js5cacherequest_2 == null) {
			return null;
		} else {
