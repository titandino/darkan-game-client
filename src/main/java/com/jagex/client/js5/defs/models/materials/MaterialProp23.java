...
import com.jagex.client.js5.defs.CutsceneDefinitions;
...
import com.jagex.client.js5.loaders.VarcStringIndexLoader;
import com.jagex.client.js5.loaders.VarnIndexLoader;
...
public class MaterialProp23 extends MaterialProperty {
	...
	public static void pulseLoggedInLogic() {
												...
												while (true) {
													do {
														...
														if (hookrequest_14 == null) {
															...
															if (client.NEEDS_VARC_SAVE && client.VARCS_LAST_SAVED < Utils.time() - 60000L) {
