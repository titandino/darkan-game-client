...
import com.jagex.unknown.Class341;
...
public class AnimationFrameBase extends Node {
	...
	public AnimationFrameBase(int id, byte[] bytes_2) {
		this.id = id;
	...
	public static void method12212(CacheableNode_Sub15 class282_sub50_sub15_0, int i_1) {
		if (Class20.aBool161) {
			...
			if (i_4 + i_6 > ChangeClanSetting.BASE_WINDOW_WIDTH) {
