...
import com.jagex.unknown.Class370;

public class MaterialProp34 extends MaterialProperty {

	public byte[] aByteArray9732 = new byte[512];
	public int anInt9736 = 4;
	public int anInt9737 = 1638;
	public int anInt9735 = 4;
	public int anInt9725 = 4;
	public int anInt9733;
	public short[] aShortArray9730;
	public boolean aBool9726 = true;
	public short[] aShortArray9731;
	...
	public void method15197(int i_1, int[] ints_2) {
	...
	public int method15198(int i_1, int i_2, int i_3, int i_4, int i_5, int i_6) {
		int i_8 = i_1 >> 12;
		int i_9 = i_8 + 1;
		if (i_9 >= i_6) {
			i_9 = 0;
