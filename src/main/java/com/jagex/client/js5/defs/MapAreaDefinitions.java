...
public class MapAreaDefinitions {
	...
	public MapAreaIndexLoader aClass218_2716;
	public int varbit = -1;
	public int var = -1;
	public int varValueMin;
	public int varValueMax;
	public int anInt2733 = -1;
	public int varbitSecondary = -1;
	public int varSecondary = -1;
	public int varValueMinSecondary;
	public int varValueMaxSecondary;
	public IterableNodeMap aClass465_2737;

	public static void iComponentOnNPC(NPCEntity npc_0, boolean bool_1) {
	...
	public static boolean renderIconsAndNames(AbstractRenderer graphicalrenderer_0, Node_Sub36 class282_sub36_1, MapAreaDefinitions worldmapareadefs_2) {
	...
	public void method3716(ByteBuf rsbytebuffer_1) {
		while (true) {
	...
	public void method3717(ByteBuf rsbytebuffer_1, int i_2) {
		if (i_2 == 1) {
