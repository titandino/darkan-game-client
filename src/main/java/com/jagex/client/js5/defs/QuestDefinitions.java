...
import com.jagex.client.prefs.impl.MaxScreenSizePreference;
import com.jagex.net.io.ByteBuf;
import com.jagex.unknown.Class179;
import com.jagex.unknown.Class378;
...
public class QuestDefinitions {
	...
	public QuestIndexLoader aClass242_2976;
	public int[][] varValues;
	public int[][] varbitValues;
	public int[] anIntArray2955;
	public int[] minVarpValue;
	public int[] maxVarpValue;
	public int[] minVarBitValue;
	public int[] maxVarBitValue;
	public IterableNodeMap params;
	...
	public static void writeCRCs(ByteBuf.Bit rsbitsbuffer_0) {
		...
		rsbitsbuffer_0.writeInt(MaxScreenSizePreference.method12672());
	...
	public void method4094(ByteBuf rsbytebuffer_1, int i_2) {
		if (i_2 == 1) {
	...
	public void method4119(ByteBuf rsbytebuffer_1) {
		while (true) {
