...
public class CursorDefintions {
	...
	public static NativeSprite aNativeSprite_5004;
	public int anInt5002;
	public int anInt5000;
	public CursorIndexLoader loader;
	public int spriteId;

	public void method7024(ByteBuf rsbytebuffer_1) {
		while (true) {
	...
	public void method7025(ByteBuf rsbytebuffer_1, int i_2) {
		if (i_2 == 1) {
