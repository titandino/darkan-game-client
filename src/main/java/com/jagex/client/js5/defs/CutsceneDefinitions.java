...
import com.jagex.game.content.cutscenes.*;
...
public class CutsceneDefinitions {
	...
	public static CutsceneAction decodeMiscActions(ByteBuf buffer) {
	...
	public static void readValueLoop(ByteBuf rsbytebuffer_0) {
		while (true) {
