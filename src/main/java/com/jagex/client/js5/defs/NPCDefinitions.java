...
import com.jagex.unknown.Class247;
import com.jagex.unknown.Class356;
import com.jagex.unknown.Class386;
import com.jagex.unknown.Class46;
...
public class NPCDefinitions {
	...
	public NPCIndexLoader npcLoader;
	public byte aByte4871;
	public int anInt4880 = 128;
	public int anInt4881 = 128;
	...
	public IterableNodeMap cs2Params;
	...
	public void method6874(ByteBuf rsbytebuffer_1) {
		while (true) {
	...
	public MeshRasterizer method6875(AbstractRenderer graphicalrenderer_1, int i_2, BASIndexLoader renderanimindexloader_3, VarProvider interface42_4, Animation animation_5, Animation animation_6, Animation[] arr_7, int[] ints_8, int i_9, NPCMeshModifier class417_10) {
	...
	public MeshRasterizer renderFull(AbstractRenderer graphicalrenderer_1, int i_2, BASIndexLoader renderanimindexloader_3, VarProvider interface42_4, Animation animation_5, Animation animation_6, Animation[] arr_7, int[] ints_8, int i_9, NPCMeshModifier class417_10, int i_11, boolean bool_12) {
		if (transformTo != null) {
				...
				if (originalColors != null) {
					...
					for (i_27 = 0; i_27 < originalColors.length; i_27++) {
						if (recolourPalette != null && i_27 < recolourPalette.length) {
							meshrasterizer_19.recolour(originalColors[i_27], aShortArray4862[recolourPalette[i_27] & 0xff]);
						} else {
							meshrasterizer_19.recolour(originalColors[i_27], shorts_48[i_27]);
						}
					}
				}
				if (originalTextures != null) {
					...
					for (i_27 = 0; i_27 < originalTextures.length; i_27++) {
						meshrasterizer_19.retexture(originalTextures[i_27], shorts_48[i_27]);
					}
				}
				if (aByte4871 != 0) {
			...
			if (bool_15 || bool_38) {
				...
				if (anInt4880 != 128 || anInt4881 != 128) {
					meshrasterizer_37.resize(anInt4880, anInt4881, anInt4880);
				}
				...
				if (originalColors != null) {
					...
					for (i_17 = 0; i_17 < originalColors.length; i_17++) {
						if (recolourPalette != null && i_17 < recolourPalette.length) {
							raster.recolour(originalColors[i_17], aShortArray4862[recolourPalette[i_17] & 0xff]);
						} else {
							raster.recolour(originalColors[i_17], shorts_21[i_17]);
						}
					}
				}
				if (originalTextures != null) {
					...
					for (i_17 = 0; i_17 < originalTextures.length; i_17++) {
						raster.retexture(originalTextures[i_17], shorts_21[i_17]);
					}
				}
				if (aByte4871 != 0) {
