...
import com.jagex.client.cache.CacheableNode_Sub2;
...
import com.jagex.game.content.cutscenes.actions.ObjectAnimationCutsceneAction;
...
public class SunDefinitions {
	...
	public static void method851(int i_0) {
	...
	public static void method857(AbstractRenderer graphicalrenderer_0) {
		...
		AnimationSub.method12680(graphicalrenderer_0, Class301.anInt3555, BufferedConnectionContext.anInt2300, Class158_Sub2.anInt8975, Class110.anInt1104, b_6, fontrenderer_7, fontmetrics_8, LocalizedText.CHOOSE_OPTION.translate(Class223.CURRENT_LANGUAGE));
		...
		if (!Class20.aBool162) {
			...
			if (Class20.aCacheableNode_Sub15_163 != null) {
				AnimationSub.method12680(graphicalrenderer_0, Class341.anInt3996, CacheableNode_Sub2.anInt9471, ObjectAnimationCutsceneAction.anInt8518, WallObjectGraphNode.anInt10526, b_6, fontrenderer_7, fontmetrics_8, Class20.aCacheableNode_Sub15_163.aString9771);
				i_12 = 0;
	...
	public static boolean isItemClickType(int i_0) {
		return i_0 == 18 || i_0 == 19 || i_0 == 20 || i_0 == 21 || i_0 == 22 || i_0 == 1004 || i_0 == 17;
	}

	public static void setComponentText(int i_0, String string_1) {
