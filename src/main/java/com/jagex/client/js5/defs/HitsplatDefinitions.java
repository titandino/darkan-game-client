...
public class HitsplatDefinitions {
	...
	public static void method3850(Matrix44 matrix44_0, float f_2, float f_3, float f_4, float f_5, int i_6, int i_7) {
	...
	public void method3833(ByteBuf stream, int opcode) {
		if (opcode == 1) {
	...
	public void method3837(ByteBuf rsbytebuffer_1) {
		while (true) {
	...
	public void method3839(AbstractRenderer graphicalrenderer_1) {
