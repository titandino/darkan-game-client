...
import com.jagex.unknown.Class13;
import com.jagex.unknown.Class179;
import com.jagex.unknown.Class298;

public class SpotAnimDefinitions {

	public static int CAM_MOVE_Z;
	public int animationId = -1;
	public byte aByte6982;
	public boolean aBool6968;
	public SpotAnimIndexLoader aClass515_6973;
	public int defaultModel;
	public int anInt6976 = 128;
	public int anInt6971 = 128;
	...
	public static void method11243() {
	...
	public void method11226(ByteBuf rsbytebuffer_1) {
		while (true) {
	...
	public void method11227(ByteBuf rsbytebuffer_1, int i_2) {
		if (i_2 == 1) {
	...
	public MeshRasterizer rasterize(AbstractRenderer graphicalrenderer_1, int i_2, boolean bool_3, Ground class390_4, Ground class390_5, int i_6, int i_7, int i_8, Animation animation_9, byte b_10) {
		...
		if (meshrasterizer_13 == null || graphicalrenderer_1.method8452(meshrasterizer_13.m(), i_12) != 0) {
			...
			if (aShortArray6972 != null) {
				for (i_16 = 0; i_16 < aShortArray6972.length; i_16++) {
					meshrasterizer_13.recolour(aShortArray6972[i_16], aShortArray6983[i_16]);
				}
			}
			if (aShortArray6974 != null) {
				for (i_16 = 0; i_16 < aShortArray6974.length; i_16++) {
					meshrasterizer_13.retexture(aShortArray6974[i_16], aShortArray6975[i_16]);
				}
			}
		...
		if (anInt6976 != 128 || anInt6971 != 128) {
			meshrasterizer_21.resize(anInt6976, anInt6971, anInt6976);
		}
		if (anInt6978 != 0) {
			if (anInt6978 == 90) {
