...
import com.jagex.unknown.Class182;
...
public class VarcDefinitions {
	...
	public static void method6996(AbstractRenderer graphicalrenderer_0, IComponentDefinitions icomponentdefinitions_1) {
	...
	public static void method6997(AbstractRenderer graphicalrenderer_0, ObjectDefinition objectdefinitions_1, int i_2, int i_3, int i_4) {
		int i_21 = i_2;
	...
	public void method6990(ByteBuf rsbytebuffer_1) {
		while (true) {
	...
	public void method6991(ByteBuf stream, int opcode) {
		if (opcode == 1) {
