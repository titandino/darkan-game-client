...
import com.jagex.client.js5.defs.models.materials.MaterialProp33;
...
public class ObjectDefinition {
	...
	public ObjectIndexLoader loader;
	...
	public IterableNodeMap aClass465_5668;
	...
	public static PulseEvent nextPulseEvent() {
	...
	public static byte[] method8023(File file_0, int i_1) {
		try {
	...
	public void method7964(ByteBuf rsbytebuffer_1) {
		while (true) {
	...
	public void method7965(ByteBuf buffer, int opcode) {
		int i_4;
		int i_5;
		int i_6;
		int i_7;
	...
	public MeshRasterizer method7971(AbstractRenderer class505, int i, int i_35_, int i_36_, Class476 class476) {
		...
		if (originalColors != null) {
			...
			for (int i_49_ = 0; i_49_ < originalColors.length; i_49_++) {
				if (aByteArray5641 != null && i_49_ < aByteArray5641.length)
					class528_48_.recolour(originalColors[i_49_], (aShortArray5691[(aByteArray5641[i_49_] & 0xff)]));
				else
					class528_48_.recolour(originalColors[i_49_], is[i_49_]);
			}
		}
		if (originalTextures != null) {
			short[] is;
