...
public class BillboardDefinitions {
	...
	public static void method6170(int i_0, int i_1) {
		if (Class291_Sub1.aFloat3468 < Class291_Sub1.aFloat3462) {
			Class291_Sub1.aFloat3468 = (float) (Class291_Sub1.aFloat3468 + Class291_Sub1.aFloat3468 / 30.0D);
			if (Class291_Sub1.aFloat3468 > Class291_Sub1.aFloat3462) {
		...
		if (Class291_Sub1.aBool8022 && QuickChatMessage.aClass482_4049 != null) {
			for (Node_Sub33 class282_sub33_5 = (Node_Sub33) QuickChatMessage.aClass482_4049.head(); class282_sub33_5 != null; class282_sub33_5 = (Node_Sub33) QuickChatMessage.aClass482_4049.next()) {
				MapAreaDefinitions worldmapareadefs_6 = Class291_Sub1.MAP_AREA_LOADER.getWorldMapDefs(class282_sub33_5.aNode_Sub36_7835.anInt7991);
				if (class282_sub33_5.method12577(i_0, i_1)) {
					...
					if (!class282_sub33_5.aNode_Sub36_7835.aBool7989) {
						...
						HitsplatIndexLoader.executeTrigger(ClientTriggerType.aClass397_4797, class282_sub33_5.aNode_Sub36_7835.anInt7991, worldmapareadefs_6.anInt2718);
					}
					if (class282_sub33_5.aNode_Sub36_7835.aBool7989) {
						HitsplatIndexLoader.executeTrigger(ClientTriggerType.aClass397_4805, class282_sub33_5.aNode_Sub36_7835.anInt7991, worldmapareadefs_6.anInt2718);
					}
				} else if (class282_sub33_5.aNode_Sub36_7835.aBool7989) {
					class282_sub33_5.aNode_Sub36_7835.aBool7989 = false;
					HitsplatIndexLoader.executeTrigger(ClientTriggerType.aClass397_4798, class282_sub33_5.aNode_Sub36_7835.anInt7991, worldmapareadefs_6.anInt2718);
				}
			}
		}
	}
	...
	public static BillboardDefinitions getBillboardDefinitions(int id) {
		BillboardDefinitions defs = (BillboardDefinitions) BILLBOARD_CACHE.get(id);
		if (defs != null) return defs;
		byte[] data = BILLBOARD_INDEX.getFile(0, id);
		defs = new BillboardDefinitions();
		if (data != null)
			defs.decode(new ByteBuf(data));
		BILLBOARD_CACHE.put(defs, id);
		return defs;
	}
	...
	public void method6164(ByteBuf rsbytebuffer_1, int i_2) {
		if (i_2 == 1) {
