package com.jagex.client.js5.defs.models;
...
public class RSMesh {
	...
	public RSMesh(int id, byte[] data) {
		this.id = id;
	...
	public static RSMesh decodeMesh(Index meshIndex, int id) {
		byte[] data = meshIndex.getFile(id, 0);
		return data == null ? null : new RSMesh(id, data);
	}

	public int method2657(RSMesh rsmesh_1, int i_2, short s_3) {
	...
	public void calculateMaxDepth(ByteBuf first, ByteBuf second) {
		short s_3 = 0;
		short s_4 = 0;
		short s_5 = 0;
		short s_6 = 0;
		...
		for (int i_7 = 0; i_7 < faceCount; i_7++) {
			...
			if (i_8 == 1) {
				s_3 = (short) (first.readUnsignedSmart() + s_6);
				s_4 = (short) (first.readUnsignedSmart() + s_3);
				s_5 = (short) (first.readUnsignedSmart() + s_4);
				s_6 = s_5;
				triangleX[i_7] = s_3;
				triangleY[i_7] = s_4;
				triangleZ[i_7] = s_5;
			...
			if (i_8 == 2) {
				s_4 = s_5;
				s_5 = (short) (first.readUnsignedSmart() + s_6);
				s_6 = s_5;
				triangleX[i_7] = s_3;
				triangleY[i_7] = s_4;
				triangleZ[i_7] = s_5;
	...
	public void decodeTexturedTriangles(ByteBuf first, ByteBuf second, ByteBuf third, ByteBuf fourth, ByteBuf firth, ByteBuf sixth) {
			...
			if (i_8 == 1) {
				...
				if (version < 15) {
					...
					if (version < 14) {
						...
						particleDirectionY[i_7] = third.read24BitUnsignedInteger();
					}

					particleDirectionZ[i_7] = third.readUnsignedShort();
				} else {
					particleDirectionX[i_7] = third.read24BitUnsignedInteger();
					particleDirectionY[i_7] = third.read24BitUnsignedInteger();
					particleDirectionZ[i_7] = third.read24BitUnsignedInteger();
				}

				particleLifespanX[i_7] = fourth.readByte();
				particleLifespanY[i_7] = firth.readByte();
	...
	public void decodeOldFormat(byte[] bytes_1) {
