...
public abstract class MaterialProperty extends Node<MaterialProperty> {
	...
	public MaterialProperty[] params;

	public MaterialProperty(int numParams, boolean bool_2) {
		noPalette = bool_2;
	...
	public static MaterialProperty decode(ByteBuf buffer) {
	...
	public static MaterialProperty getById(int i_0) {
		switch (i_0) {
			case 0:
