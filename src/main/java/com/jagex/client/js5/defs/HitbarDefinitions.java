...
import com.jagex.client.js5.loaders.QuickchatMessageLoader;
...
public class HitbarDefinitions {
	...
	public HeadbarIndexLoader aClass290_2437;
	public int anInt2444 = -1;
	public int anInt2445 = -1;
	public int anInt2441 = -1;
	...
	public static void method3231(int i_0, int i_1, int i_2, int i_3, boolean bool_4) {
		int i_01 = i_0;
		int i_13 = i_1;
		int i_21 = i_2;
		int i_31 = i_3;
	...
	public void method3206(ByteBuf stream, int opcode) {
		if (opcode == 1) {
	...
	public void method3210(ByteBuf rsbytebuffer_1) {
		while (true) {
	...
	public void method3211(AbstractRenderer graphicalrenderer_1) {
