...
import com.jagex.client.prefs.impl.SceneryShadowPreference;
...
public class IComponentDefinitions {
	...
	public static LRUCache aClass229_1303 = new LRUCache(8);
	public static LRUCache aClass229_1282 = new LRUCache(4);
	...
	public IterableNodeMap aClass465_1365;
	public short[] colorsToReplace;
	public short[] colorsToReplaceWith;
	public short[] texturesToReplace;
	public short[] texturesToReplaceWith;
	...
	public void readValues(ByteBuf rsbytebuffer_1) {
	...
	public int[] decodeScript3(ByteBuf rsbytebuffer_1) {
		int i_3 = rsbytebuffer_1.readUnsignedByte();
		if (i_3 == 0) {
			return null;
		} else {
	...
	public Object[] decodeScript(ByteBuf rsbytebuffer_1) {
		int i_3 = rsbytebuffer_1.readUnsignedByte();
		if (i_3 == 0) {
			return null;
		} else {
	...
	public MeshRasterizer method2002(AbstractRenderer graphicalrenderer_1, int i_2, BASIndexLoader renderanimindexloader_3, IdentiKitIndexLoader class31_4, NPCIndexLoader npcindexloader_5, ItemIndexLoader itemindexloader_6, VarProvider interface42_8, Animation animation_9, PlayerModel playerappearance_10) {
		aBool1399 = false;
			...
			if (meshrasterizer_18 == null || graphicalrenderer_1.method8452(meshrasterizer_18.m(), i_2) != 0) {
				...
				if (colorsToReplace != null) {
					for (i_20 = 0; i_20 < colorsToReplace.length; i_20++) {
						meshrasterizer_18.recolour(colorsToReplace[i_20], colorsToReplaceWith[i_20]);
					}
				}
				if (texturesToReplace != null) {
					for (i_20 = 0; i_20 < texturesToReplace.length; i_20++) {
						meshrasterizer_18.retexture(texturesToReplace[i_20], texturesToReplaceWith[i_20]);
					}
				}
					...
					if (i_17 < i_19 && i_18 < i_20) {
						...
						if (inter.type == ComponentType.CONTAINER) {
							...
							if (class282_sub44_33 != null) {
								BASIndexLoader.method3629(class282_sub44_33.interfaceId, i_17, i_18, i_19, i_20, drawX, drawY, i_13);
							}
