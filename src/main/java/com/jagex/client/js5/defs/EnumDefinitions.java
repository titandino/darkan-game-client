...
public class EnumDefinitions {
	...
	public HashMap aHashMap5147;

	public static boolean isObjectClickType(int i_0) {
	...
	public void method7224(ByteBuf stream, int opcode) {
		if (opcode == 1) {
	...
	public void method7227(ByteBuf rsbytebuffer_1) {
		while (true) {
