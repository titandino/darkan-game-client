...
public class MaterialDefinitions extends CacheableNode {
	...
	public int id;
	public static FileOutputStream aFileOutputStream9481;
	public static double aDouble9479 = -1.0;
	public static int[] anIntArray9474 = new int[256];
	public MaterialProperty[] properties;
	public int[] spritePropertyIds;
	public int[] texturePropertyIds;
	public MaterialProperty opaqueProperty;
	public MaterialProperty translucentProperty;
	public MaterialProperty combinedProperty;

	public MaterialDefinitions(int id, ByteBuf buffer) {
		this.id = id;
...
//		buffer.setOffset(0);
	...
	public boolean loadImageFiles(Index spriteIndex, ImageLoader imageLoader) {
	...
	public int[] method14718(Index index_1, ImageLoader interface22_2, double d_3, int i_5, int i_6, boolean bool_7, boolean bool_8) {
	...
	public int[] renderIntPixels(Index index_1, ImageLoader interface22_2, double d_3, int width, int height, boolean bool_7) {
		Class532_Sub2.CURR_SPRITE_INDEX = index_1;
		Class532_Sub1.IMAGE_LOADER = interface22_2;
	...
	public float[] renderFloatPixels(Index index_1, ImageLoader interface22_2, int i_3, int i_4, boolean blend) {
		Class532_Sub2.CURR_SPRITE_INDEX = index_1;
		Class532_Sub1.IMAGE_LOADER = interface22_2;
