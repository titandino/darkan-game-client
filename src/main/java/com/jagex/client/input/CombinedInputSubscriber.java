...
import com.jagex.StaticElements;
...
import com.jagex.unknown.Class308;
...
public class CombinedInputSubscriber implements InputSubscriber {
	...
	public CombinedInputSubscriber(int i_1, int i_2, int[] ints_3) {
		clickType = i_1;
		minimumClicks = i_2;
		requiredKeys = ints_3;
	}

	public static CombinedInputSubscriber decode(ByteBuf rsbytebuffer_0) {
	...
	public static void queryItem(String query, boolean tradeableOnly, int paramId, int paramIntQuery, String paramStringQuery, boolean paramIsString) {
