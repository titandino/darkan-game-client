...
import com.jagex.unknown.Class532_Sub3_Sub1;

public class InputSubscriberType {

	public static int EMAIL_STATUS;

	public static IComponentDefinitions aClass118_2763;

	public static InputSubscriberType COMBINED = new InputSubscriberType(0);
	public static InputSubscriberType KEY_PRESS = new InputSubscriberType(1);
	public static InputSubscriberType KEY_HOLD = new InputSubscriberType(2);

	public int anInt2758;

	public InputSubscriberType(int i_1) {
		anInt2758 = i_1;
	}
	...
	public static InputSubscriberType valueOf(int i_0) {
