...
import com.jagex.unknown.Class413;
import com.jagex.unknown.Class78;

public class KeyPressInputSubscriber implements InputSubscriber {
	public int code;
	public int flags;

	public KeyPressInputSubscriber(int i_1, int i_2) {
		code = i_1;
		flags = i_2;
	}

	public static KeyPressInputSubscriber decode(ByteBuf rsbytebuffer_0) {
	...
	public static String method3754(CharSequence charsequence_0, Class413 class413_1) {
