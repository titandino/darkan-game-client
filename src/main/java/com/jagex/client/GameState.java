...
import com.jagex.client.js5.loaders.QuickchatCategoryLoader;
...
public class GameState {
	...
	public static boolean method7742(int i_0) {
		...
		if (state != client.GAME_STATE) {
			...
			if (bool_2 != bool_3) {
				if (bool_2) {
					...
					if (Class393.preferences.aBuildAreaPreference3_8229.method12714() != 0) {
						Class339.method6047(IndexLoaders.MUSIC_INDEX, Class260.anInt3228, Class393.preferences.aBuildAreaPreference3_8229.method12714());
