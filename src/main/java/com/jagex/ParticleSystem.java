...
public class ParticleSystem {
	...
	public static boolean[] aBoolArray7133 = new boolean[32];
	public static boolean[] aBoolArray7134 = new boolean[8];
	public boolean aBool7132;
	public long aLong7124;
	public long aLong7123;
	public boolean aBool7119;
	public boolean aBool7130;
	public int size;
	public List<ParticleProducer> aList7129 = new LinkedList<>();
	public int anInt7126;
	public List<Node_Sub40> aList7127 = new LinkedList<Node_Sub40>();
	public int anInt7121;
	public boolean aBool7128;
	public int anInt7122;
	public Class151 aClass151_7131 = new Class151();
	public Particle[] particles = new Particle[8192];

	public ParticleSystem(int i_1, boolean bool_2) {
	...
	public void method11504(int i_1, boolean bool_2) {
	...
	public boolean method11509(AbstractRenderer graphicalrenderer_1, long long_2) {
	...
	public void method11513(SurfaceSkin[] arr_1) {
		for (int i_3 = 0; i_3 < 8; i_3++) {
			aBoolArray7134[i_3] = false;
		}

		Iterator<Node_Sub40> iterator_6 = aList7127.iterator();

		while (true) {
			label69:
			while (iterator_6.hasNext()) {
				Node_Sub40 class282_sub40_7 = iterator_6.next();
				if (arr_1 != null) {
	...
	public void method11516(SceneObjectManager sceneobjectmanager_1, AbstractRenderer graphicalrenderer_2) {
	...
	public Class151 method11533() {
		...
		for (int i_1 = 0; i_1 < particles.length; i_1++) {
			if (particles[i_1] != null && particles[i_1].producer != null) {
				aClass151_7131.aClass464_1961.method7735(particles[i_1]);
			}
		}
	...
	public void method11541(AbstractRenderer graphicalrenderer_1, ParticleEmitterConfig[] arr_2) {
