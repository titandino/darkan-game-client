...
import com.jagex.unknown.Class287;
...
public abstract class GraphNode_Sub1_Sub1 extends GraphNode_Sub1 {
	...
	public byte aByte9454;

	public GraphNode_Sub1_Sub1(SceneObjectManager sceneobjectmanager_1, int i_2, int i_3, int i_4, int i_5, int i_6, int i_7, int i_8, int i_9, int i_10, boolean bool_11, byte b_12) {
