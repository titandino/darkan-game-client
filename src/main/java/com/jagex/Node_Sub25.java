...
public class Node_Sub25 extends Node {
	...
	public Node_Sub25(int i_1, int i_2) {
		anInt7688 = i_1;
		anInt7689 = i_2;
	}

	public static void method12400(int i_0, int i_1, int i_2, int i_4, int i_6, CacheableNode_Sub7 class282_sub50_sub7_7, FontRenderer fontrenderer_8, FontMetrics fontmetrics_9, int i_10, int i_11) {
		int i_101 = i_10;
