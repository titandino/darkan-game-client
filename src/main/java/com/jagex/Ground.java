...
import com.jagex.client.js5.defs.models.materials.MaterialProp19;
import com.jagex.client.render.NativeSprite;
import com.jagex.unknown.Class119;
import com.jagex.unknown.Class245;
...
public abstract class Ground {
	...
	public Ground(int i_1, int i_2, int i_3, int[][] ints_4) {
		width = i_1;
		length = i_2;
		int scale;
	...
	public static void method6728(IComponentDefinitions icomponentdefinitions_0, Class119 class119_1, int i_2, int i_3, int i_4, int i_5, int i_6, long long_7) {
