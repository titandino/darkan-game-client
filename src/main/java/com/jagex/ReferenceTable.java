...
public class ReferenceTable {
	...
	public NamedFileReference archiveName;

	public int[][] fileNameHashes;

	public NamedFileReference[] namedFiles;

	public int headerCrc;

	public byte[] headerWhirlpool;

	public ReferenceTable(byte[] data, int crcCheck, byte[] whirlpool) {
	...
	public void decodeHeader(byte[] bytes_1) {
