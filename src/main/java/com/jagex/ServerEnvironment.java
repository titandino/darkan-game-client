...
import com.jagex.client.js5.loaders.LightIntensityIndexLoader;
...
public enum ServerEnvironment implements Identifiable {
	...
	public static void updateRandomDatUID192(ByteBuf data, int i_1) {
	...
	public static void pulseSubInterfaces() {
