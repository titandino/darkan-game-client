...
import com.jagex.client.js5.defs.SkyboxDefinitions;
...
public class WallObjectGraphNode extends GraphNode_Sub1_Sub5 implements WorldObject {
	...
	public static Class194 aClass194_10527;
	public static int[] anIntArray10522 = {1, 2, 4, 8};
	public static int[] anIntArray10518 = {16, 32, 64, 128};
	Shadow aCacheableNode_Sub17_10517;
	public Class200 aClass200_10519;
	public boolean aBool10524;
	ObjectIndexLoader aClass474_10515;
	public int anInt10514;
	public boolean aBool10525;
	byte aByte10521;
	byte aByte10520;
	public boolean aBool10523;
	public boolean aBool10516;
	MeshRasterizer aMeshRasterizer_10513;

	public WallObjectGraphNode(SceneObjectManager sceneobjectmanager_1, AbstractRenderer graphicalrenderer_2, ObjectIndexLoader objectindexloader_3, ObjectDefinition objectdefinitions_4, int i_5, int i_6, int i_7, int i_8, int i_9, boolean bool_10, int i_11, int i_12, boolean bool_13) {
	...
	public static void handleAccountCreationStart() {
	...
	@Override
	public boolean method12986() {
		return aMeshRasterizer_10513 == null || !aMeshRasterizer_10513.u();
	}

	public Class452 method16101(AbstractRenderer graphicalrenderer_1, int i_2, boolean bool_3) {
	...
	@Override
	public boolean method13001() {
		return aMeshRasterizer_10513 != null && aMeshRasterizer_10513.i();
	}

	@Override
	public boolean method13002() {
		return aMeshRasterizer_10513 != null && aMeshRasterizer_10513.i();
	}
