...
public class WorldMapRect extends Node {
	...
	public WorldMapRect(int i_1, int i_2, int i_3, int i_4, int i_5, int i_6, int i_7, int i_8, int i_9) {
		plane = i_1;
		bottomLeftX = i_2;
		bottomLeftY = i_3;
		topRightX = i_4;
