...
import com.jagex.unknown.Class149_Sub4;
import com.jagex.unknown.Class260;
import com.jagex.unknown.Class435;
import com.jagex.unknown.Class76;
...
public class SoftwareItemRender implements Interface18 {
	...
	public boolean hasPlayerAppearance;

	public static Class149_Sub4 method7033(ByteBuf rsbytebuffer_0) {
	...
	public static void playAnimationSound(AnimationDefinitions defs, int frame1Index) {
		if (Class260.SOUNDS_SIZE < 50 && defs != null && defs.soundIds != null && frame1Index < defs.soundIds.length && defs.soundIds[frame1Index] != null) {
			int flag = defs.soundIds[frame1Index][0];
			int soundId = flag >> 8;
			int type = flag >> 5 & 0x7;
			int i_6;
			if (defs.soundIds[frame1Index].length > 1) {
				i_6 = (int) (Math.random() * defs.soundIds[frame1Index].length);
				if (i_6 > 0)
					soundId = defs.soundIds[frame1Index][i_6];
			}
			i_6 = 256;
			if (defs.anIntArray5927 != null && defs.anIntArray5919 != null) {
				i_6 = Class76.method1356(defs.anIntArray5927[frame1Index], defs.anIntArray5919[frame1Index]);
			}
			int i_7 = defs.anIntArray5926 == null ? 255 : defs.anIntArray5926[frame1Index];
			if (defs.aBool5928) {
				Class435.playSoundVorbis(soundId, type, 0, i_7, false, i_6);
			} else {
				VarNPCMap.playSoundSynth(soundId, type, 0, i_7, i_6);
			}
		}
	}

	public static boolean method7035(char var_0) {
