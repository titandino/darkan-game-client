...
public class Node_Sub19 extends Node {
	...
	public OpenGLRenderer aGraphicalRenderer_Sub1_7650;
	public Node_Sub24 aNode_Sub24_7641;
	public OpenGLGround aGround_Sub2_7654;
	public int anInt7642;
	public int anInt7653;
	public int anInt7644;
	public int anInt7656;
	public float[][] aFloatArrayArray7652;
	public float[][] aFloatArrayArray7648;
	public float[][] aFloatArrayArray7645;
	public Interface15 anInterface15_7639;
	public Interface14 anInterface14_7649;
	public OpenGlArrayBufferPointer aClass143_7647;
	public OpenGlArrayBufferPointer aClass143_7643;
	public ByteBuf aNode_Sub35_7655;
	public Node_Sub35_Sub1 aNode_Sub35_Sub1_7651;
	public HashTable aClass453_7657;
	public int anInt7640;

	public Node_Sub19(OpenGLRenderer class505_sub1_1, OpenGLGround class390_sub2_2, Node_Sub24 class282_sub24_3, int[] ints_4) {
	...
	public void method12305(short s_1) {
	...
	public void method12306(int i_1, int i_2, int i_3, int i_4, int i_5, int i_6) {
		long long_7 = -1L;
	...
	public void method12311(int i_1, int i_2, int i_3, boolean[][] bools_4) {
