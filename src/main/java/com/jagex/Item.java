...
public class Item extends Node {
	...
	public Item(int i_1, int i_2, int i_3, int i_4, int i_5, boolean bool_6) {
		id = i_1;
		amount = i_2;
		outlineSize = i_3;
		shadowColor = i_4;
	...
	public static void method12574(AbstractRenderer graphicalrenderer_0, IComponentDefinitions icomponentdefinitions_1, int i_2, int i_3) {
