...
public class GraphNode_Sub1_Sub1_Sub6 extends GraphNode_Sub1_Sub1 implements WorldObject {
	...
	public Class200 aClass200_10537;

	ObjectIndexLoader aClass474_10542;

	int id;

	public boolean aBool10536;

	byte aByte10539;

	byte aByte10540;

	public boolean aBool10541;

	public boolean aBool10543;

	public boolean aBool10544;

	MeshRasterizer aMeshRasterizer_10535;

	Shadow aCacheableNode_Sub17_10538;

	public GraphNode_Sub1_Sub1_Sub6(SceneObjectManager sceneobjectmanager_1, AbstractRenderer graphicalrenderer_2, ObjectIndexLoader objectindexloader_3, ObjectDefinition objectdefinitions_4, int i_5, int i_6, int i_7, int i_8, int i_9, boolean bool_10, int i_11, int i_12, int i_13, int i_14, int i_15, int i_16, boolean bool_17) {
	...
	public Class452 method16117(AbstractRenderer graphicalrenderer_1, int i_2, boolean bool_3) {
