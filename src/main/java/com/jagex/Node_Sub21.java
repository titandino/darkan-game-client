...
public class Node_Sub21 extends Node {
	...
	public static NativeSprite[] aNativeSpriteArray7673;
	public String aString7674;
	public int anInt7675;

	public static void setItemInContainer(int key, int slot, int itemId, int amount, boolean negativeKey) {
