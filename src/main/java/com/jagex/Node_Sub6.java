...
public class Node_Sub6 extends Node {
	...
	public HardwareGround aGround_Sub1_7509;
	public HardwareRenderer aGraphicalRenderer_Sub2_7518;
	public int anInt7510;
	public float aFloat7511;
	public HDWaterTile hdWaterTile;
	public int[] anIntArray7515;
	public Interface4 anInterface4_7516;
	public NativeHeapBuffer aNativeHeapBuffer7520;
	public Stream aStream7513;

	public Node_Sub6(HardwareGround class390_sub1_1, int i_2, int i_3, HDWaterTile class90_4) {
	...
	public void method12145(int i_1, int i_2, int i_3, float f_4) {
		int i_21 = i_2;
		int i_6;
		int i_7;
		if (anInt7510 != -1) {
	...
	public void method12146(int i_1) {
	...
	public void method12147(int[] ints_1, int i_2) {
		anInt7514 = 0;
		anInt7519 = 32767;
		anInt7517 = -32768;
	...
	public void method12150(int i_1) {
	...
	public void method12152(int i_1, int i_2, int i_3) {
