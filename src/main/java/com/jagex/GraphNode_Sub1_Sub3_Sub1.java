...
public class GraphNode_Sub1_Sub3_Sub1 extends SceneObjectNode implements WorldObject {
	...
	public Class200 aClass200_10494;
	public boolean aBool10497;
	ObjectIndexLoader aClass474_10492;
	int id;
	public boolean aBool10493;
	byte aByte10496;
	public boolean aBool10498;
	public boolean aBool10500;
	MeshRasterizer aMeshRasterizer_10499;

	public GraphNode_Sub1_Sub3_Sub1(SceneObjectManager sceneobjectmanager_1, AbstractRenderer graphicalrenderer_2, ObjectIndexLoader objectindexloader_3, ObjectDefinition objectdefinitions_4, int i_5, int i_6, int i_7, int i_8, int i_9, boolean bool_10, int i_11, boolean bool_12) {
	...
	public static boolean method16081() {
	...
	public Class452 method16074(AbstractRenderer graphicalrenderer_1, int i_2, boolean bool_3) {
