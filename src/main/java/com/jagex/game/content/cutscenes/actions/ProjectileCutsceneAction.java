...
import com.jagex.client.input.CombinedInputSubscriber;
...
import com.jagex.unknown.Class159;
...
public class ProjectileCutsceneAction extends CutsceneAction {
	...
	public int anInt9405;

	public int anInt9413;

	public int anInt9409;

	public int anInt9412;

	public int anInt9399;

	public ProjectileCutsceneAction(ByteBuf rsbytebuffer_1, int i_2, int i_3) {
