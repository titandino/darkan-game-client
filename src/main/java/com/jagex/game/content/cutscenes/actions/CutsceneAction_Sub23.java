...
import com.jagex.Node_Sub17_Sub4;
...
import com.jagex.unknown.Class329_Sub1;
import com.jagex.unknown.Class350_Sub2;
...
public class CutsceneAction_Sub23 extends CutsceneAction {
	...
	public static CacheableNode_Sub7 aCacheableNode_Sub7_9445;
	public int anInt9443;
	public int anInt9444;

	public CutsceneAction_Sub23(ByteBuf rsbytebuffer_1) {
		super(rsbytebuffer_1);
		anInt9443 = rsbytebuffer_1.readUnsignedShort();
		anInt9444 = rsbytebuffer_1.readInt();
	}

	public static File method14681(String string_0) {
