...
public class CutsceneEntityMovement {
	...
	public int[] movementTypes;
	public int[] movementCoordinates;

	public CutsceneEntityMovement(ByteBuf rsbytebuffer_1) {
	...
	public static boolean method1577(WorldObject sceneobject_0) {
	...
	public static String method1578(long long_0) {
	...
	public void method1566(CutsceneEntity entity, int i_2) {
