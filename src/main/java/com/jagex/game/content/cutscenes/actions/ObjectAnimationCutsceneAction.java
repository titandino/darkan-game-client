...
public class ObjectAnimationCutsceneAction extends CutsceneAction {
	...
	public static int anInt8518;

	public int anInt8516;

	public int anInt8517;

	public ObjectAnimationCutsceneAction(ByteBuf rsbytebuffer_1) {
		super(rsbytebuffer_1);
		anInt8516 = rsbytebuffer_1.readUnsignedShort();
		anInt8517 = rsbytebuffer_1.readBigSmart();
	}

	public static String method13787(Throwable throwable_0) throws IOException {
