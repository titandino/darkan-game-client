...
public class CutsceneAction_Sub12 extends CutsceneAction {
	...
	public static int USE_INTERFACE_ID;

	public String aString9318;

	public int anInt9317;

	public CutsceneAction_Sub12(ByteBuf rsbytebuffer_1) {
		super(rsbytebuffer_1);
		aString9318 = rsbytebuffer_1.readString();
		anInt9317 = rsbytebuffer_1.readUnsignedShort();
	}

	public static void method14612(int i_0, int i_1) {
