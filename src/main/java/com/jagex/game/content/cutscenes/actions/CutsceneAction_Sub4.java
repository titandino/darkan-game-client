...
public class CutsceneAction_Sub4 extends CutsceneAction {
	...
	public CutsceneAction_Sub4(ByteBuf rsbytebuffer_1) {
	...
	public static boolean method13788(int i_0) {
		return i_0 == 59 || i_0 == 2 || i_0 == 8 || i_0 == 17 || i_0 == 15 || i_0 == 16 || i_0 == 58;
	}

	public static void method13789(CacheableNode_Sub7 class282_sub50_sub7_0, int i_1, int i_2, int i_3) {
