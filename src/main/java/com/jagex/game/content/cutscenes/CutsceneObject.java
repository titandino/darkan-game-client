...
import com.jagex.QuickChatValueType;
import com.jagex.VorbisNode;
...
public class CutsceneObject {
	...
	public static QuickChatValueType[] getQuickChatDynamicValueTypes() {
	...
	public void method1559(int i_1, int i_2, int i_3, int i_4) {
