...
import com.jagex.unknown.Class209;
import com.jagex.unknown.Class276;
import com.jagex.unknown.Class86;

public class CutsceneEntity {

	public static Index aClass317_746;
	public static int PULSE_TIME_IDX;
	...
	public CutsceneEntity(ByteBuf buffer, int index) {
		this.index = index;
	...
	public static String method1354(CacheableNode_Sub15 class282_sub50_sub15_0) {
		return class282_sub50_sub15_0.aString9771 + Utils.rgbToColHexShortcut(16777215) + " >";
	}

	public void move(int y, int plane, int x, int direction) {
		if (!initialized) {
			initialized = true;
			if (id >= 0) {
	...
	public void method1338(int i_1, int i_2, int i_3) {
		if (npc != null) {
