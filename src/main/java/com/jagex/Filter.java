...
public class Filter {
	...
	public static float[][] coefficient_float = new float[2][8];
	public static int[][] coefficient_int = new int[2][8];
	public static float invUnity_float;
	public static int invUnity_int;
	...
	public float adaptMagnitude(int dir, int k, float t) {
	...
	public float adaptPhase(int dir, int i, float t) {
		float _f = pairPhase[dir][0][i] + t * (pairPhase[dir][1][i] - pairPhase[dir][0][i]);
		_f *= 1.2207031E-4F;
		return normalize(_f);
	}

	public void decode(ByteBuf buffer, Envelope envelope) {
