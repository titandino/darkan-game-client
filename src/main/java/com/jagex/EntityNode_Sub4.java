...
public class EntityNode_Sub4 extends EntityNode {
	...
	public int anInt7838 = (int) (Utils.time() / 1000L);
	public String aString7837;
	public short aShort7839;

	public EntityNode_Sub4(String string_1, int i_2) {
		aString7837 = string_1;
		aShort7839 = (short) i_2;
	}

	public static void method12585(Node_Sub31 class282_sub31_0) {
