...
import com.jagex.unknown.Class185;
import com.jagex.unknown.Class302;
import com.jagex.unknown.Class335;
import com.jagex.unknown.Class372;

public class ChoppyItemFixClass {

	public float aFloat1678;
	public float aFloat1679;
	public float aFloat1680;
	public int anInt1684;
	public int anInt1700;
	public float aFloat1702;
	public boolean aBool1671;
	public int anInt1677;
	public int[] anIntArray1693;
	public float aFloat1696;
	public int anInt1674;
	public int[] anIntArray1698;
	public float aFloat1695;
	public int[] anIntArray1673;
	public float aFloat1681;
	...
	public boolean aBool1672;
	public boolean aBool1675 = true;
	public boolean aBool1676;
	public float aFloat1682;
	public float aFloat1683 = 1.0F;
	public int[] anIntArray1685 = new int[4096];
	public int anInt1688 = -1;
	public int anInt1692 = -1;
	public boolean aBool1703 = true;
	public int anInt1704 = -1;
	public boolean aBool1708;
	public JavaRenderer aGraphicalRenderer_Sub3_1686;
	public Class185 aClass185_1687;
	public int anInt1705;
	public int[] anIntArray1689;
	public float[] aFloatArray1690;

	public ChoppyItemFixClass(JavaRenderer hardwarerenderer_1, Class185 class185_2) {
	...
	public void method2418(boolean bool_1) {
		aBool1671 = bool_1;
	}

	public void method2419(boolean bool_1, boolean bool_2, boolean bool_3, int[] ints_4, int i_5, int i_6, int i_7, int i_8, int i_9, float f_10, float f_11) {
		int i_91 = i_9;
		int i_81 = i_8;
		int i_71 = i_7;
		if (aBool1708) {
	...
	public void method2421(float f_4, float f_5, float f_6, float f_7, float f_8, float f_9, float f_10, float f_11, float f_12, float f_13, float f_14, float f_15, float f_16, float f_17, float f_18, float f_19, float f_20, float f_21, int i_22, int i_23, int i_24, int i_25, float f_26, float f_27, float f_28, int i_29, float f_30, int i_31, float f_32, int i_33, float f_34) {
		...
		int i_37;
		if (i_291 != anInt1692) {
			anIntArray1693 = aGraphicalRenderer_Sub3_1686.getPixels(i_291);
			if (anIntArray1693 == null) {
				anInt1674 = 255 - (i_221 >> 24 & 0xff);
				i_37 = Class335.HSL_TO_RGB[Class372.method6362(aGraphicalRenderer_Sub3_1686.method14362(i_291)) & 0xffff];
		...
		aFloat1696 = f_301;
		if (anInt1688 != i_311) {
			anIntArray1698 = aGraphicalRenderer_Sub3_1686.getPixels(i_311);
			if (anIntArray1698 == null) {
				anInt1674 = 255 - (i_221 >> 24 & 0xff);
				i_37 = Class335.HSL_TO_RGB[Class372.method6362(aGraphicalRenderer_Sub3_1686.method14362(i_311)) & 0xffff];
				i_36 = -16777216 | (i_37 >> 16 & 0xff) * (i_221 >> 16 & 0xff) << 8 & 0xff0000 | (i_221 >> 8 & 0xff) * (i_37 >> 8 & 0xff) & 0xff00 | (i_37 & 0xff) * (i_221 & 0xff) >> 8;
				method2425(true, true, false, f_410, f_510, f_610, f_710, f_810, f_92, f_101, f_111, f_121, Class302.method5364(i_36, i_25, f_261), Class302.method5364(i_36, i_25, f_271), Class302.method5364(i_36, i_25, f_281));
				return;
			}
		...
		aFloat1695 = f_321;
		if (i_331 != anInt1704) {
			anIntArray1673 = aGraphicalRenderer_Sub3_1686.getPixels(i_331);
			if (anIntArray1673 == null) {
				anInt1674 = 255 - (i_221 >> 24 & 0xff);
				i_37 = Class335.HSL_TO_RGB[Class372.method6362(aGraphicalRenderer_Sub3_1686.method14362(i_331)) & 0xffff];
				i_36 = -16777216 | (i_37 >> 16 & 0xff) * (i_221 >> 16 & 0xff) << 8 & 0xff0000 | (i_221 >> 8 & 0xff) * (i_37 >> 8 & 0xff) & 0xff00 | (i_37 & 0xff) * (i_221 & 0xff) >> 8;
	...
	public void method2422(boolean bool_1, boolean bool_2, int[] ints_3, int i_4, int i_5, int i_6, int i_7, int i_8, float f_9, float f_10, float f_11, float f_12, float f_13, float f_14, float f_15, float f_16) {
		int i_81 = i_8;
		int i_71 = i_7;
		int i_61 = i_6;
		int i_51 = i_5;
	...
	public void method2424(boolean bool_1, boolean bool_2, boolean bool_3, float f_4, float f_5, float f_6, float f_7, float f_8, float f_9, float f_10, float f_11, float f_12, float f_13, float f_14, float f_15, float f_16, float f_17, float f_18, float f_19, float f_20, float f_21, int i_22, int i_23, int i_24, int i_25, float f_26, float f_27, float f_28, int i_29) {
		...
		if (!bool_1) {
			...
			int i_30;
			if (i_29 != anInt1692) {
				anIntArray1693 = aGraphicalRenderer_Sub3_1686.getPixels(i_29);
				if (anIntArray1693 == null) {
					anInt1674 = 255 - (i_221 >> 24 & 0xff);
					int i_74 = Class335.HSL_TO_RGB[Class372.method6362(aGraphicalRenderer_Sub3_1686.method14362(i_29)) & 0xffff];
	...
	public void method2425(boolean bool_1, boolean bool_2, boolean bool_3, float f_4, float f_5, float f_6, float f_7, float f_8, float f_9, float f_10, float f_11, float f_12, int i_13, int i_14, int i_15) {
		float f_91 = f_9;
		float f_81 = f_8;
		float f_43 = f_4;
		float f_71 = f_7;
	...
	public void method2426(boolean bool_1, boolean bool_2, boolean bool_3, float f_4, float f_5, float f_6, float f_7, float f_8, float f_9, float f_10, float f_11, float f_12, float f_13, float f_14, float f_15) {
		float f_91 = f_9;
		float f_81 = f_8;
		float f_41 = f_4;
		float f_71 = f_7;
		...
		if (!bool_1) {
			...
			aGraphicalRenderer_Sub3_1686.method8429((int) f_71, (int) f_41, (int) f_81, (int) f_51, Class335.HSL_TO_RGB[(int) f_13 & 0xffff]);
			aGraphicalRenderer_Sub3_1686.method8429((int) f_81, (int) f_51, (int) f_91, (int) f_61, Class335.HSL_TO_RGB[(int) f_13 & 0xffff]);
			aGraphicalRenderer_Sub3_1686.method8429((int) f_91, (int) f_61, (int) f_71, (int) f_41, Class335.HSL_TO_RGB[(int) f_13 & 0xffff]);
		} else {
			float f_16 = f_81 - f_71;
	...
	public void method2427(int[] ints_3, int i_4, int i_5, int i_6, float f_7, float f_8, float f_9, float f_10, float f_11, float f_12, float f_13, float f_14, float f_15, float f_16, float f_17, float f_18, float f_19, float f_20, float f_21, float f_22, float f_23, float f_24, float f_25, float f_26, float f_27, float f_28) {
		int i_61 = i_6;
		int i_51 = i_5;
		int i_29 = i_61 - i_51;
	...
	public void method2428(boolean bool_1, boolean bool_2, boolean bool_3, float f_4, float f_5, float f_6, float f_7, float f_8, float f_9, float f_10, float f_11, float f_12, int i_13) {
		float f_91 = f_9;
		float f_81 = f_8;
		float f_41 = f_4;
		float f_71 = f_7;
	...
	public void method2434(boolean bool_1, boolean bool_2, int[] ints_3, int i_5, int i_6, int i_7, float f_8, float f_9, float f_10, float f_11, float f_12, float f_13, float f_14, float f_15, float f_16, float f_17, float f_18, float f_19, float f_20, float f_21, float f_22, float f_23, float f_24, float f_25) {
		int i_71 = i_7;
		int i_61 = i_6;
		int i_26 = i_71 - i_61;
	...
	public void method2443(boolean bool_1, boolean bool_2, int[] ints_3, int i_4, int i_5, int i_6, int i_7, int i_8, float f_9, float f_10, float f_11, float f_12) {
		int i_81 = i_8;
		int i_71 = i_7;
		int i_61 = i_6;
		int i_51 = i_5;
			...
			if (aClass185_1687.aBool2334) {
				if (aBool1675) {
					...
					if (anInt1674 == 0) {
						if (i_61 > 0) {
							do {
								i_51 = Class335.HSL_TO_RGB[(int) f_9 & 0xffff];
								f_9 += f_10;
								++i_4;
					...
					if (anInt1674 != 0) {
						...
						do {
							++i_4;
							if (!bool_1 || f_11 < aFloatArray1690[i_4]) {
								ints_3[i_4] = Class335.HSL_TO_RGB[(int) f_9 & 0xffff];
								if (bool_1) {
									aFloatArray1690[i_4] = f_11;
								}
							}
