...
import com.jagex.client.prefs.impl.TexturesPreference;
import com.jagex.game.content.cutscenes.actions.ApplyHitmarkCutsceneAction;
import com.jagex.game.content.cutscenes.actions.SendFinishedCutsceneAction;
...
import com.jagex.unknown.Class371;

public class Node_Sub14 extends Node {

	public static int anInt7597;
	public int[] anIntArray7596 = new int[128];
	public Node_Sub26_Sub1[] aNode_Sub26_Sub1Array7589 = new Node_Sub26_Sub1[128];
	public short[] aShortArray7590 = new short[128];
	public byte[] aByteArray7592 = new byte[128];
	public byte[] aByteArray7591 = new byte[128];
	public Class110[] aClass110Array7594 = new Class110[128];
	public byte[] aByteArray7595 = new byte[128];
	public int anInt7593;

	public Node_Sub14(byte[] bytes_1) {
	...
	public static void method12221(IComponentDefinitions icomponentdefinitions_0, int i_1, int i_2) {
		if (client.aClass118_7257 == null && !Class20.aBool161 && icomponentdefinitions_0 != null && ApplyHitmarkCutsceneAction.method14643(icomponentdefinitions_0)) {
			...
			SendFinishedCutsceneAction.anInt8308 = 0;
			client.aBool7364 = false;
		}

	}

	public static void method12222() {
	}
	...
	public boolean method12216(Class250 class250_1, byte[] bytes_2, int[] ints_3) {
		boolean bool_5 = true;
		int i_6 = 0;
