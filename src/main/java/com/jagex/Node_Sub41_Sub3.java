...
import com.jagex.unknown.Class81;
...
public class Node_Sub41_Sub3 extends Node_Sub41 {
	...
	public boolean aBool9555;
	public long aLong9553;
	public boolean aBool9554;
	public double aDouble9547;
	public DecoderContext aDecoderContext9549;
	public GranulePos aGranulePos9550;
	public Frame aFrame9551;
	public int anInt9556;
	public boolean aBool9560;
	public boolean aBool9558;
	public int anInt9557;
	public NativeSprite anObject9544;
	public SetupInfo aSetupInfo9559 = new SetupInfo();
	public TheoraInfo aTheoraInfo9546 = new TheoraInfo();
	public TheoraComment aTheoraComment9552 = new TheoraComment();

	public Node_Sub41_Sub3(OggStreamState oggstreamstate_1) {
	...
	public void method14790(int i_1) {
		anInt9557 = i_1;
		if (aBool9554) {
