...
import com.jagex.unknown.Class325;
...
public class ClipFlagMap {
	...
	public static void method6007(int i_0, int[] ints_1) {
	...
	public void removeFlag(int i_1, int i_2, int i_3) {
		map[i_1][i_2] &= ~i_3;
	}

	public void addFlag(int i_1, int i_2, int i_3) {
		map[i_1][i_2] |= i_3;
	}

	public void removeFlag(int i_1, int i_2, ClipFlag... flags) {
		int flag = 0;
		for (ClipFlag f : flags)
			flag |= f.flag;
	...
	public void addFlag(int i_1, int i_2, ClipFlag... flags) {
		int flag = 0;
		for (ClipFlag f : flags)
			flag |= f.flag;
