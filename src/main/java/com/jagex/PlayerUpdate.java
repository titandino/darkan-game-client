...
import com.jagex.unknown.Class197;
import com.jagex.unknown.Class20;
import com.jagex.unknown.Class236;
import com.jagex.unknown.Class399;

public class PlayerUpdate {

	public static void decode(ByteBuf.Bit buffer, int size) {
	...
	public static void decodeUpdate(ByteBuf.Bit bitPacket) {
		int i_2 = 0;
	...
	public static void decodeMasks(ByteBuf.Bit buffer) {
	...
	public static void decodeMasksBody(ByteBuf.Bit stream, int i_1, PlayerEntity player, int flags) {
		...
		if (player.aBool10568) {
			if (tempMoveType == 127) {
				...
				Class236.getAnimationForSpeed(player, b_20);
