...
public abstract class Shader {
	...
	public static Interface11 anInterface11_1012 = new Class82();

	public int anInt1015 = -1;

	public String aString1014;

	public int anInt1009;

	public Class107 aClass107_1013;

	public int anInt1016;

	public Class107 aClass107_1011;

	public Class115[] aClass115Array1010;

	public Shader(HardwareRenderer class505_sub2_1, ShaderLoader class114_2) {
	...
	public static void getSortedStringIndices(String[] strings, int[] ints, int fromIndex, int toIndex) {
	...
	public abstract Class115 method1665(HardwareRenderer var1, Class99 var2);
	...
	public abstract Class115 method1683(HardwareRenderer var1, Class99 var2);
	...
	public abstract Node_Sub21_Sub1 method1694(Class122 var1);
	...
	public abstract Class115 method1697(HardwareRenderer var1, Class99 var2);
	...
	public abstract Node_Sub21_Sub1 method1712(Class122 var1);
	...
	public abstract Class115 method1743(HardwareRenderer var1, Class99 var2);
	...
	public abstract Node_Sub21_Sub1 method1765(Class122 var1);
}
