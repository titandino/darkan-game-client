...
public class World {
	...
	public static void method3662(AnimationDefinitions animDef, int i_1, GraphNode_Sub1 class521_sub1_2) {
		if (Class260.SOUNDS_SIZE < 50 && animDef != null && animDef.soundIds != null && i_1 < animDef.soundIds.length && animDef.soundIds[i_1] != null && class521_sub1_2.plane == VertexNormal.MY_PLAYER.plane) {
			int i_4 = animDef.soundIds[i_1][0];
			int i_5 = i_4 >> 8;
			int i_6 = i_4 >> 5 & 0x7;
			int i_7 = i_4 & 0x1f;
			int i_8;
			if (animDef.soundIds[i_1].length > 1) {
				i_8 = (int) (Math.random() * animDef.soundIds[i_1].length);
				if (i_8 > 0) {
					i_5 = animDef.soundIds[i_1][i_8];
				}
			}

			i_8 = 256;
			if (animDef.anIntArray5927 != null && animDef.anIntArray5919 != null) {
				i_8 = (int) (Math.random() * (animDef.anIntArray5919[i_1] - animDef.anIntArray5927[i_1])) + animDef.anIntArray5927[i_1];
			}
