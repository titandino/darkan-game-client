...
import com.jagex.client.cache.CacheableNode_Sub10;
...
import com.jagex.client.js5.loaders.ParamIndexLoader;
import com.jagex.client.js5.loaders.UnderlayIndexLoader;
import com.jagex.client.prefs.impl.FlickeringEffectsPreference;
...
public class PacketDecoder {
	...
	public static boolean decode(BufferedConnectionContext context) throws IOException {
		...
		if (context.currentPacket == ServerProt.IF_SETMODEL) {
				...
				if (class282_sub47_116 != null) {
					...
					if (bool_115) {
						...
						if (spotAnimId != -1) {
							...
							class161_104.animation.setAnimationFull(spotanimdefinitions_38.animationId, speed, i_40, false);
						} else {
				...
				if (player_117 != null) {
					...
					if (bool_16) {
						...
						if (spotAnimId != -1) {
							...
							class161_121.animation.setAnimationFull(spotanimdefinitions_125.animationId, speed, i_83, false);
						} else {
			...
			FlickeringEffectsPreference.method12948(class494_96);
			context.currentPacket = null;
			return true;
			...
			if (key != Class354.JCOINS) {
				Class354.JCOINS = key;
				HitsplatIndexLoader.executeTrigger(ClientTriggerType.aClass397_4812, -1, -1);
			}
			context.currentPacket = null;
			return true;
			...
			if (bool_66 != Class469.LOYALTY_ENABLED || key != KeyHoldInputSubscriber.LOYALTY_BALANCE) {
				...
				HitsplatIndexLoader.executeTrigger(ClientTriggerType.LOYALTY_UPDATED, -1, -1);
			}
			context.currentPacket = null;
			return true;
	...
	public static void decodeTilestreamPacket(UpdateZonePacket packet) {
