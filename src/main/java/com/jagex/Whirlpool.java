...
import com.jagex.client.js5.JS5LocalRequester;
import com.jagex.client.js5.defs.IComponentDefinitions;
import com.jagex.client.prefs.impl.Preference;
...
public class Whirlpool {
	...
	public static long[][] aLongArrayArray5367 = new long[8][256];

	public static long[] aLongArray5366 = new long[11];
	...
	public byte[] aByteArray5375 = new byte[32];
	public byte[] aByteArray5368 = new byte[64];
	public long[] aLongArray5361 = new long[8];
	public long[] aLongArray5372 = new long[8];
	public long[] aLongArray5374 = new long[8];
	public long[] aLongArray5365 = new long[8];
	public long[] aLongArray5373 = new long[8];

	public static void applyDebugOpcode(int id) {
		if (id == 17) {
			throw new Error();
		} else if (id == 25) {
	...
	public void method7407(byte[] bytes_1, long long_2) {
		int i_4 = 0;
	...
	public void method7408(byte[] bytes_1) {
