...
public class ItemContainer extends Node {
	...
	public static IterableNodeMap CONTAINER_MAP = new IterableNodeMap(32);
	public static LRUCache aClass229_7712 = new LRUCache(11);
	int[] itemIds = {-1};
	...
	public static ItemContainer getContainer(int key, boolean negativeKey) {
		long longKey = key | (negativeKey ? Integer.MIN_VALUE : 0);
		return (ItemContainer) CONTAINER_MAP.get(longKey);
	}

	public MeshRasterizer method12429(AbstractRenderer graphicalrenderer_1, int i_2, Animation animation_3, int i_4, boolean female, PlayerModel playerappearance_6) {
		...
		long long_24 = method12444(ints_11, i_4, playerappearance_6 != null ? playerappearance_6.colours : null, female);
		...
		if (meshrasterizer_8 == null || graphicalrenderer_1.method8452(meshrasterizer_8.m(), i_9) != 0) {
			...
			if (playerappearance_6 != null) {
				for (i_18 = 0; i_18 < 10; i_18++) {
					for (i_19 = 0; i_19 < AbstractQueue_Sub1.DEFAULT_SKIN_COLOURS[i_18].length; i_19++) {
						if (playerappearance_6.colours[i_18] < Class366.SKIN_COLORS[i_18][i_19].length) {
							meshrasterizer_8.recolour(AbstractQueue_Sub1.DEFAULT_SKIN_COLOURS[i_18][i_19], Class366.SKIN_COLORS[i_18][i_19][playerappearance_6.colours[i_18]]);
						}
					}
				}
			}
	...
	public long method12444(int[] ints_1, int i_2, int[] ints_3, boolean bool_4) {
