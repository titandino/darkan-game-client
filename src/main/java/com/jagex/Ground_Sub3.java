...
public class Ground_Sub3 extends Ground {
	...
	public Class178[][] aClass178ArrayArray9352;
	public Class183[][] aClass183ArrayArray9332;
	public Class177[][] aClass177ArrayArray9336;
	public Class196[][] aClass196ArrayArray9337;
	public Class181[][] aClass181ArrayArray9335;
	byte[][] aByteArrayArray9355;
	byte[][] aByteArrayArray9356;
	public float aFloat9338;
	public float aFloat9340;
	public float aFloat9341;
	public float aFloat9342;
	public float aFloat9343;
	public float aFloat9344;
	public float aFloat9334;
	public float aFloat9346;
	public float aFloat9339;
	public float aFloat9327;
	public float aFloat9349;
	public float aFloat9350;
	public float aFloat9351;
	public float aFloat9328;
	public float aFloat9333;
	public float aFloat9354;
	...
	public static int method14616(int i_0, int i_1) {
		...
		if (ints_3 != null && ints_3.length != 0) {
			...
			for (i_14 = 0; i_14 < ints_7.length; i_14++) {
				if (ints_7[i_14] == -1) {
					...
					ints_7[i_14] = Class335.HSL_TO_RGB[Class372.method6362(ints_7[i_14]) & 0xffff] << 8 | 0xff;
				}
			}
			...
			if (ints_8 != null) {
				for (i_14 = 0; i_14 < ints_8.length; i_14++) {
					if (ints_8[i_14] == -1) {
						...
						ints_8[i_14] = Class335.HSL_TO_RGB[Class372.method6362(ints_8[i_14]) & 0xffff] << 8 | 0xff;
					}
				}
			}
						...
						if (bool_33) {
							...
							if (bool_37) {
								...
								if (bool_36) {
									i_27 = ints_9[i_22];
									if (i_27 != -1 && !aGraphicalRenderer_Sub3_9353.textureCache.getTextureDetails(i_27).isGroundMesh) {
										class196_38.anIntArray2420[i_22] = Class335.HSL_TO_RGB[Class372.method6362(aGraphicalRenderer_Sub3_9353.textureCache.getTextureDetails(i_27).color & 0xffff) & 0xffff];
									}

									i_27 = ints_9[i_34];
									if (i_27 != -1 && !aGraphicalRenderer_Sub3_9353.textureCache.getTextureDetails(i_27).isGroundMesh) {
										class196_38.anIntArray2420[i_34] = Class335.HSL_TO_RGB[Class372.method6362(aGraphicalRenderer_Sub3_9353.textureCache.getTextureDetails(i_27).color & 0xffff) & 0xffff];
									}

									i_27 = ints_9[i_24];
									if (i_27 != -1 && !aGraphicalRenderer_Sub3_9353.textureCache.getTextureDetails(i_27).isGroundMesh) {
										class196_38.anIntArray2420[i_24] = Class335.HSL_TO_RGB[Class372.method6362(aGraphicalRenderer_Sub3_9353.textureCache.getTextureDetails(i_27).color & 0xffff) & 0xffff];
									}
								}
	...
	public void method14617(int i_1, int i_2, boolean bool_3, Class185 class185_4, ChoppyItemFixClass choppyitemfixclass_5, float[] floats_6, float[] floats_7, float[] floats_8, float[] floats_9, float[] floats_10, int i_11) {
	...
	public void method14618(int i_1, int i_2, int i_3, int i_4, int i_5, int i_6, int i_7, boolean[][] bools_8, Class185 class185_9, ChoppyItemFixClass choppyitemfixclass_10, float[] floats_11, float[] floats_12) {
	...
	public void method14619(int i_1, int i_2, boolean bool_3, Class185 class185_4, ChoppyItemFixClass choppyitemfixclass_5, float[] floats_6, float[] floats_7, float[] floats_8, float[] floats_9, float[] floats_10, int i_11) {
	...
	public boolean method14620(int i_1) {
		return (anInt9345 & 0x8) != 0 && (i_1 == 4 || (i_1 == 8 || i_1 == 9));
	}

	public void method14622(int i_1, int i_2, int i_3, int i_4, int i_5, int i_6, int i_7, boolean[][] bools_8, Class185 class185_9, ChoppyItemFixClass choppyitemfixclass_10, float[] floats_11, float[] floats_12) {
		int i_13 = i_3 * (i_7 - i_5) / 256;
		int i_14 = i_3 >> 8;
		boolean bool_15 = class185_9.aBool2334;
		aGraphicalRenderer_Sub3_9353.RA(false);
	...
	public void method14636(int i_1, int i_2, ChoppyItemFixClass choppyitemfixclass_3, float[] floats_4, float[] floats_5, float[] floats_6, float[] floats_7, int i_9) {
			...
			if ((class178_10.aByte2219 & 0x2) == 0) {
				...
				if ((f_25 - f_28) * (f_23 - f_29) - (f_26 - f_29) * (f_22 - f_28) > 0.0F) {
					...
					if (class178_10.aShort2215 >= 0) {
						choppyitemfixclass_3.method2424(true, true, false, f_26, f_29, f_23, f_25, f_28, f_22, f_27, f_30, f_24, f_17, f_18, f_16, 1.0F, 0.0F, 1.0F, 1.0F, 1.0F, 0.0F, -16777216 | Class335.HSL_TO_RGB[class178_10.aShort2216 & 0xffff] & 0xffffff, -16777216 | Class335.HSL_TO_RGB[class178_10.aShort2218 & 0xffff] & 0xffffff, -16777216 | Class335.HSL_TO_RGB[class178_10.aShort2217 & 0xffff] & 0xffffff, 0, 0.0F, 0.0F, 0.0F, class178_10.aShort2215);
					} else {
				...
				if ((f_19 - f_22) * (f_29 - f_23) - (f_20 - f_23) * (f_28 - f_22) > 0.0F) {
					...
					if (class178_10.aShort2215 >= 0) {
						choppyitemfixclass_3.method2424(true, true, false, f_20, f_23, f_29, f_19, f_22, f_28, f_21, f_24, f_30, f_15, f_16, f_18, 0.0F, 1.0F, 1.0F, 0.0F, 0.0F, 1.0F, -16777216 | Class335.HSL_TO_RGB[class178_10.aShort2214 & 0xffff] & 0xffffff, -16777216 | Class335.HSL_TO_RGB[class178_10.aShort2217 & 0xffff] & 0xffffff, -16777216 | Class335.HSL_TO_RGB[class178_10.aShort2218 & 0xffff] & 0xffffff, 0, 0.0F, 0.0F, 0.0F, class178_10.aShort2215);
					} else {
	...
	public void method14638(int i_1, int i_2, int i_3) {
