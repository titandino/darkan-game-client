...
public class HitsplatIndexLoader {
	...
	public LRUCache aClass229_2664 = new LRUCache(20);
	public LRUCache aClass229_2667 = new LRUCache(64);
	public Index aClass317_2666;
	public Index aClass317_2665;

	public HitsplatIndexLoader(Index index_3, Index index_4) {
		aClass317_2666 = index_4;
		aClass317_2665 = index_3;
		aClass317_2665.filesCount(SharedConfigsType.HITSPLATS.id);
	}

	public static void method3612(int i_0, int i_1, int i_2, int i_3, int i_4, boolean bool_5) {
