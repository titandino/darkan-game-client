...
public class InteractableObject extends GraphNode_Sub1_Sub1 implements WorldObject {
	...
	public boolean aBool10512 = true;
	public Class200 aClass200_10510;
	public boolean aBool10511;

	public InteractableObject(SceneObjectManager sceneobjectmanager_1, AbstractRenderer graphicalrenderer_2, ObjectIndexLoader objectindexloader_3, ObjectDefinition objectdefinitions_4, int i_5, int i_6, int i_7, int i_8, int i_9, boolean bool_10, int i_11, int i_12, int i_13, int i_14, int i_15, int i_16, int i_17) {
