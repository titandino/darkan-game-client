...
public class Static {
	...
	public static Class194 aClass194_5794;
	public static int UPDATE_ZONE_X;
	...
	public static void method2095(CacheableNode_Sub7 class282_sub50_sub7_0) {
		if (!Class20.aBool161) {
	...
	public static int method6375(String string_0, byte[] bytes_1, int i_2) {
		int i_4 = i_2;
	...
	public static String method6380(CacheableNode_Sub7 class282_sub50_sub7_0) {
	...
	public static void method4281(PathingEntity animable_0) {
	...
	public static void method13042(AbstractRenderer graphicalrenderer_0, int i_1, int i_2, int i_3, int i_4, int i_5, int i_6, int i_7) {
	...
	public static void resetContainer(int key, boolean negativeKey) {
	...
	public static void method1495(String[] arr_0, short[] shorts_1, int i_2, int i_3) {
		if (i_2 < i_3) {
			int i_5 = (i_3 + i_2) / 2;
			int i_6 = i_2;
	...
	public static void method4653(int i_0, int i_1) {
