...
public class ja extends AbstractRenderer implements Interface40 {
	...
	public static int[] ab = new int[Math.max(Math.max(104, 20), 24573)];
	public static float[] ar = new float[20];
	public static int[] ae = new int[6];
	...
	public int ac = 4096;
	public int as;
	public Matrix44Var ay;
	public Matrix44 an;
	public long nativeid;
	public NodeCollection au = new NodeCollection();
	public Matrix44Var ag;
	public Matrix44 ao;
	public Matrix44 aw;
	...
	public native void op(za var1);

	public native void q(ImageLoader var1, int var2, int var3);
	...
	public native void R(int var1, int var2, int var3, int var4, int var5, int var6, Class455 var7, int var8, int var9);
	...
	public native void Q(int var1, int[] var2, float[] var3);

	public native void wa(float[] var1);
	...
	public native void ol(int var1, int var2, int var3, int var4);
	...
	public NativeSprite createSprite(int[] pixels, int i_2, int width, int height, int i_5, boolean bool_6) {
		return new fa(this, pixels, i_2, width, height, i_5);
	}
	...
	public native void PA(za var1);

	public native void d(long var1, long var3);
	...
	public native void A(int var1, int var2, int var3, int var4);
	...
	@Override
	public native void CA(int var1, int var2, int var3, int var4);
	...
	@Override
	public FontRenderer createFont(com.jagex.client.render.font.FontMetrics fontmetrics_1, SpriteDefinitions[] arr_2, boolean bool_3) {
	...
	public native void oo();

	public native void AA(float[] var1);
	...
	public native void YA(int var1, int var2, int var3, int var4, int var5, int var6);
	...
	public native void JA(int var1, int var2, int var3, int var4);

	public native void M(int var1, int var2, int var3, int var4);
	...
	public native void F(short var1, int[] var2, short var3, int var4, byte var5, byte var6, int var7, boolean var8, byte var9, byte var10, byte var11, byte var12, boolean var13, boolean var14, boolean var15, boolean var16, boolean var17, byte var18, boolean var19, boolean var20, int var21);
	...
	public native void n(Node_Sub1 var1);
	...
	public native void og(float[] var1);
	...
	public void ny(Class151 class151_1) {
		int i_3 = 0;
		int i_4 = 0;
		int i_5 = 0;
		int i_6 = 0;
	...
	public native void oq(float[] var1);
	...
	@Override
	public native void fr(int var1, int var2, int var3, int var4, int var5);
	...
	@Override
	public FontRenderer method8660(com.jagex.client.render.font.FontMetrics fontmetrics_1, SpriteDefinitions[] arr_2, boolean bool_3) {
		int[] ints_4 = new int[arr_2.length];
		int[] ints_5 = new int[arr_2.length];
		boolean bool_6 = false;
	...
	public native void oj(int var1, int var2, int var3, int var4);
	...
	public native void on(int var1, int var2, int var3, int var4);
	...
	public native void nn(int var1, int var2, int var3, int var4, int var5, int var6);
	...
	@Override
	public native void fw(int var1, int var2, int var3, int var4, int var5);
	...
	public native void ou(long var1, long var3);
	...
	public native void oi(int var1, int var2, int var3, int var4);
	...
	public native void V(short var1, short var2, int var3, byte var4, byte var5, int var6, boolean var7, byte var8, byte var9, byte var10, byte var11, boolean var12, boolean var13, boolean var14, boolean var15, boolean var16, byte var17, boolean var18, boolean var19, int var20);
	...
	public native void ng(ImageLoader var1, int var2, int var3);

	@Override
	public void method8530(int i_1, int i_2, int i_3, int i_4, int i_5, int i_6, int i_7, int i_8, int i_9) {
	}

	public native void nc(int var1, int var2, int var3, int var4, int var5, int var6);
	...
	public native void nz(int var1);

	public native void nm(Node_Sub1 var1);

	public native void nd(Node_Sub1 var1);

	public native void nj(Node_Sub1 var1);

	public native void nf(int var1, int[] var2, float[] var3);

	public native void nr(short var1, int[] var2, short var3, int var4, byte var5, byte var6, int var7, boolean var8, byte var9, byte var10, byte var11, byte var12, boolean var13, boolean var14, boolean var15, boolean var16, boolean var17, byte var18, boolean var19, boolean var20, int var21);

	public native void ns(short var1, int[] var2, short var3, int var4, byte var5, byte var6, int var7, boolean var8, byte var9, byte var10, byte var11, byte var12, boolean var13, boolean var14, boolean var15, boolean var16, boolean var17, byte var18, boolean var19, boolean var20, int var21);

	public native void nw(short var1, int[] var2, short var3, int var4, byte var5, byte var6, int var7, boolean var8, byte var9, byte var10, byte var11, byte var12, boolean var13, boolean var14, boolean var15, boolean var16, boolean var17, byte var18, boolean var19, boolean var20, int var21);

	public native void ow(za var1);

	@Override
	public void method8673(int i_1, int i_2, int i_3, int i_4) {
	}

	public native void os(za var1);
	...
	public native void oe();

	@Override
	public native void O();

	public native void of(int var1, int var2, int var3, int var4);
	...
	public native void ov(int var1, int var2, int var3, int var4);
	...
	public native void oy(float[] var1);

	@Override
	public native void in(float var1);

	public native void ot(float[] var1);
	...
	public native void no(ImageLoader var1, int var2, int var3);

	public native void oa(int var1, int var2, int var3, int var4);

	public native void ox(int var1, int var2, int var3, int var4);
