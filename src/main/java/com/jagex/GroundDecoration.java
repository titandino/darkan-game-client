...
public class GroundDecoration extends SceneObjectNode implements WorldObject {
	...
	public boolean aBool10508 = true;
	public Class200 aClass200_10505;
	public boolean aBool10506;

	public GroundDecoration(SceneObjectManager sceneobjectmanager_1, AbstractRenderer graphicalrenderer_2, ObjectIndexLoader objectindexloader_3, ObjectDefinition objectdefinitions_4, int i_5, int i_6, int i_7, int i_8, int i_9, boolean bool_10, int i_11, int i_12) {
