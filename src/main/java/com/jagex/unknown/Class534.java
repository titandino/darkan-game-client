...
public abstract class Class534 {
	...
	public static short aShort7079;

	public long aLong7074 = -1L;

	public long aLong7076 = -1L;

	public int anInt7075 = -1;

	public int anInt7078 = -1;

	public NodeCollection aClass482_7077 = new NodeCollection();

	public static void method11441() {
	...
	public int method11408(MouseRecord class282_sub53_1, int i_2) {
		long long_4;
		if (aLong7074 == -1L) {
			long_4 = i_2;
		} else {
	...
	public void method11410(MouseRecord class282_sub53_1) {
		aClass482_7077.append(class282_sub53_1);
	}

	public abstract int method11412();

	public abstract void method11413(ByteBuf var1, MouseRecord var2);

	public abstract void method11414();

	public abstract int method11415();

	public abstract TCPPacket method11416();
	...
	public abstract void method11418();

	public abstract TCPPacket method11420();

	public abstract TCPPacket method11421();

	public abstract TCPPacket method11422();

	public abstract boolean method11423();

	public abstract int method11424();

	public abstract int method11425();

	public abstract void method11426(ByteBuf var1, MouseRecord var2);

	public abstract void method11427(ByteBuf var1, MouseRecord var2);

	public abstract TCPPacket method11428();

	public abstract void method11431();

	public abstract boolean method11434();
}
