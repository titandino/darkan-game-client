...
public class Class380 implements Iterator {
	...
	public static String aString4636;

	public int anInt4634;

	public int anInt4635;

	public AbstractQueue_Sub1 anAbstractQueue_Sub1_4633;

	public Class380(AbstractQueue_Sub1 abstractqueue_sub1_1) {
	...
	public static void method6451(int i_0, int i_1) {
	...
	public Object next() {
		...
		} else if (anInt4634 < anAbstractQueue_Sub1_4633.anInt10070) {
