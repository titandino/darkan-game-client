...
public class Class264 {
	...
	public static void method4781(int i_0, Class261 class261_5, float f_6, float f_7, float f_8, float f_9, byte[] bytes_11, int i_12) {
		int i_13 = 16384;
		...
		for (i_15 = 0; i_15 < 8; i_15++) {
			i_16 = i_12;
			class261_5.method4634(i_0, 128, 128, 16, f_6 / 128, f_7 / 128, f_8 / 16, f_9 * 127.0F, floats_14);

			for (int i_17 = 0; i_17 < i_13; i_17++) {
				bytes_11[i_16] = (byte) ((int) (bytes_11[i_16] + floats_14[i_17]));
				++i_16;
			}
	...
	public static byte[] method4782(Class261 class261_4) {
		byte[] bytes_10 = new byte[262144];
		method4783(class261_4, bytes_10, 0);
		return bytes_10;
	}

	public static void method4783(Class261 class261_4, byte[] bytes_10, int i_11) {
