...
public class Class291 {
	...
	public static byte[][][] aByteArrayArrayArray3464;
	public static int anInt3469;
	public static StaticElements aClass283_3470;
	public static int xLength;
	public static int yLength;
	public static int anInt3454 = (int) (Math.random() * 11.0D) - 5;
	public static int anInt3463 = (int) (Math.random() * 17.0D) - 8;
	public static NodeCollection aClass482_3459 = new NodeCollection();
	public static Index MAP_AREA_INDEX;
	public static ObjectIndexLoader OBJECT_LOADER;
	public static MapAreaIndexLoader MAP_AREA_LOADER;
	public static MapSpriteIndexLoader MAP_SPRITE_LOADER;
	public static VarProvider PLAYER_VAR_PROVIDER;
	...
	public static IterableNodeMap aClass465_3461 = new IterableNodeMap(16);
	public static int[] anIntArray3466 = new int[1];
	public static byte[] aByteArray3467 = new byte[1];
	public static OverlayIndexLoader OVERLAY_LOADER;
	public static UnderlayIndexLoader UNDERLAY_LOADER;
	public static byte[] underlayData;
	public static byte[] aByteArray3453;
	public static byte[] aByteArray3487;
	public static Object[] anObjectArray3488;
	public static byte[] aByteArray3475;
	public static ArrayList[][][] anArrayListArrayArrayArray3484;
	public static int[] anIntArray3481;
	public static byte[] rgbColors;
	public static short[] aShortArray3479;
	...
	public static void method5128(int i_0) {
	...
	public static void renderMap(AbstractRenderer graphicalrenderer_0, int i_1, int i_2) {
	...
	public static void method5132(ImageLoader interface22_0, int i_1, int i_2) {
	...
	public static NodeCollection method5135() {
	...
	public static void method5139(int i_0, int i_1, int i_2, int i_3, int i_4, int i_5, int i_6, int i_7) {
	...
	public static void renderUnderlay(AbstractRenderer graphicalrenderer_0, int i_1, int i_2, int i_3, int i_4, int i_5, int i_6, int i_7, int[] ints_8, byte[] bytes_9, boolean bool_10) {
		int i_11;
		int i_12;
	...
	public static void method5146(Node_Sub36 class282_sub36_1, int i_2, int i_3) {
	...
	public static void method5147(AbstractRenderer graphicalrenderer_0, Node_Sub36 class282_sub36_1, MapAreaDefinitions worldmapareadefs_2) {
	...
	public static void method5162(ByteBuf rsbytebuffer_1, int i_2, int i_3, int i_4, int i_5, int[] ints_6, int[] ints_7) {
	...
	public static int method5164(ImageLoader interface22_0, int i_1, int i_2, int i_3) {
		OverlayDefinitions overlaydef_4 = OVERLAY_LOADER.getOverlayDef(i_1);
		if (overlaydef_4 == null) {
			...
			if (overlaydef_4.secondaryRGB >= 0) {
				...
				i_6 = -16777216 | Class335.HSL_TO_RGB[Class372.method6362(QuestIndexLoader.method4162(i_9, 96)) & 0xffff];
			} else if (i_5 >= 0) {
				i_6 = -16777216 | Class335.HSL_TO_RGB[Class372.method6362(QuestIndexLoader.method4162(interface22_0.getTextureDetails(i_5).color, 96)) & 0xffff];
	...
	public static void renderObjectSprites(AbstractRenderer graphicalrenderer_0, int i_1, int i_2, int i_3, int i_4, int[] ints_5, byte[] bytes_6) {
		if (ints_5 != null) {
	...
	public static NodeCollection method5179(int i_1, int i_2) {
	...
	public static void renderMap(AbstractRenderer graphicalrenderer_0) {
		int i_1 = anInt3480 - anInt3485;
		int i_2 = anInt3486 - anInt3465;
		int i_3 = (anInt3476 - anInt3489 << 16) / i_1;
		int i_4 = (anInt3492 - anInt3490 << 16) / i_2;
	...
	public static void decodeArea(int i_1, int i_2) {
	...
	public static void decodeUnderlayColors(byte[] bytes_0, byte[] bytes_1, short[] shorts_2, int i_3, int i_4) {
		...
		for (int i_10 = -5; i_10 < xLength; i_10++) {
			...
			for (i_13 = 0; i_13 < yLength; i_13++) {
				UnderlayDefinitions underlaydef_26;
				if (i_11 < xLength) {
				...
				for (int i_18 = -5; i_18 < yLength; i_18++) {
					...
					if (i_18 >= 0 && i_17 > 0) {
						...
						if ((bytes_0[i_10 + i_18 * xLength] & 0xff) == 0) {
							...
							int i_25 = Class335.HSL_TO_RGB[Class372.method6362(PlaySoundJingleCutsceneAction.method14677(i_23, 96)) & 0xffff];
