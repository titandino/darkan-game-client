...
import com.jagex.client.prefs.impl.FogPreference;
...
public abstract class Class455 {
	...
	public static void iComponentOnIComponent(IComponentDefinitions icomponentdefinitions_0) {
		if (client.aBool7344) {
	...
	public static void method7558(boolean bool_0, boolean bool_1, String string_2, String string_3, long long_4) {
	...
	public static int getCRC(byte[] data, int start, int end) {
		int i_3 = -1;
