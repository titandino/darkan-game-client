...
public class Class66 {
	...
	public LRUCache aClass229_674 = new LRUCache(256);
	public HardwareRenderer aGraphicalRenderer_Sub2_676;
	public ImageLoader anInterface22_675;

	public Class66(HardwareRenderer class505_sub2_1, ImageLoader interface22_2) {
		aGraphicalRenderer_Sub2_676 = class505_sub2_1;
		anInterface22_675 = interface22_2;
	}

	public Interface6 method1277(int i_1, int i_2) {
		int i_21 = i_2;
	...
	public Interface6 method1283(int i_1) {
