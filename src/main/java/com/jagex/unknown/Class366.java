...
public class Class366 implements Interface3 {
	...
	public Class366(int i_1) {
		anInt4231 = i_1;
	}

	public static void method6301(AbstractRenderer graphicalrenderer_0, int i_1, int i_2, IComponentDefinitions icomponentdefinitions_3, int i_4) {
	...
	public static long method6302(CharSequence charsequence_0) {
		long long_2 = 0L;
