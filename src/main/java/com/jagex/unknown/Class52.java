...
public abstract class Class52 implements Interface2 {
	...
	public long aLong491;

	Index aClass317_493;

	Index aClass317_490;

	public Class350 aClass350_489;

	public Class52(Index index_1, Index index_2, Class350 class350_3) {
		aClass317_493 = index_1;
		aClass317_490 = index_2;
		aClass350_489 = class350_3;
	}

	public static void method1086(int i_0, int i_1, int i_2, boolean bool_3, int i_4, boolean bool_5) {
		if (i_0 < i_1) {
			int i_7 = (i_0 + i_1) / 2;
			int i_8 = i_0;
	...
	public static WorldMapDef method1087(Index mapAreas, int archiveId, int fileId) {
	...
	public abstract void method1075(int var2, int var3);

	public abstract void method1076(boolean var1, int var2, int var3);
	...
	public abstract void method1077(int var2, int var3);
	...
	public abstract void method1079(int var2, int var3);
	...
	public abstract void method1080(int var2, int var3);
	...
	public abstract void method1081(boolean var1, int var2, int var3);
