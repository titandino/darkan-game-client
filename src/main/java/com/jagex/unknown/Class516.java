...
public class Class516 {
	...
	public static void method8867(boolean bool_0) {
		FileStream.method7403(client.BASE_WINDOW_ID, ChangeClanSetting.BASE_WINDOW_WIDTH, client.BASE_WINDOW_HEIGHT * -969250379, bool_0);
	}

	public static void method8868(String string_0) {
