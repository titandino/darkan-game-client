...
public class Class158_Sub1_Sub4 extends Class158_Sub1 {
	...
	public Interface13[] anInterface13Array10233 = new Interface13[4];
	public OpenGLRenderer aGraphicalRenderer_Sub1_10227;
	public Interface13 anInterface13_10232;

	public Class158_Sub1_Sub4(OpenGLRenderer class505_sub1_1) {
	...
	public void method15622(int i_1) {
	...
	public void method15624(int i_3, int i_4, boolean bool_8) {
		if (true) {
			int i_9 = anInt10230;
	...
	public void method15628(int i_1) {
