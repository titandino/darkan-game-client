...
public class Class247 {
	...
	public static ImageLoader TEXTURE_LOADER;

	public int anInt3053;

	public int anInt3044;

	public NativeSprite aNativeSprite_3030;

	public int anInt3052;

	public int anInt3054;

	public boolean aBool3042;

	public Class247 aClass247_3051;

	public int anInt3032 = -1;

	public boolean aBool3045 = true;
	...
	public Class334[] aClass334Array3049;

	public Class204 aClass204_3050;

	public Class334[] aClass334Array3035;

	public Class334 aClass334_3033;
	...
	public static boolean method4248(int i_0, int i_1) {
		if (!Class20.aBool161) {
			...
			int i_3 = i_0 >> 16;
			int i_4 = i_0 & 0xffff;
			if (Interface.INTERFACES[i_3] != null && Interface.INTERFACES[i_3].components[i_4] != null) {
				IComponentDefinitions icomponentdefinitions_5 = Interface.INTERFACES[i_3].components[i_4];
	...
	public void method4206(AbstractRenderer graphicalrenderer_1, int i_2, int i_3, int i_4, int i_5, int i_6, int i_7, int i_8, int i_9, int i_10, boolean bool_11, int i_13) {
		int i_15 = 255 - i_13;
	...
	public void method4229(AbstractRenderer graphicalrenderer_1) {
		try {
	...
	public void method4231(AbstractRenderer graphicalrenderer_1, int i_2, int i_3, int i_4, int i_5) {
