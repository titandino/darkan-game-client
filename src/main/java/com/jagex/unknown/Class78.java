...
public class Class78 {
	...
	public static HashMap<String, TimeZone> aHashMap768 = new HashMap<>();

	public static Map<Language, ConcurrentLinkedQueue<SimpleDateFormat>> aMap766;
	...
	public static TimeZone method1373() {
		return method1375();
	}

	public static TimeZone method1375() {
	...
	public static String method1382(Date date_0, String string_1, TimeZone timezone_2, Language xlanguage_3) {
		if (aMap766 == null) {
	...
	public static int method1386(Class413 class413_0) {
		if (class413_0 == null) {
			return 12;
		} else {
