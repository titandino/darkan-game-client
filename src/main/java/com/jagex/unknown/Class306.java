...
public class Class306 implements Runnable {
	...
	public boolean aBool3597;
	public long aLong3602;
	public String aString3603;
	public int anInt3596;
	public LoadingStage aClass387_3605;
	public int anInt3600;
	public Interface27 anInterface27_3604;
	public Interface27 anInterface27_3598 = new Class304();
	public volatile boolean aBool3599;
	public long aLong3601;

	public static void method5458(int i_0, int i_1, int i_2, int i_3) {
	...
	public synchronized void method5419() {
		aBool3597 = true;
	}

	public synchronized void method5422(long long_1, String string_3, int i_4, LoadingStage xloadingstage_5) {
		aLong3602 = long_1;
				...
				try {
					...
					if (anInterface27_3598 instanceof Class304) {
						...
						if (Renderers.CURRENT_RENDERER != null && anInterface27_3604 != null && anInterface27_3604.method190() != 0 && aLong3601 >= long_4 - anInterface27_3604.method190()) {
							...
							NativeSprite nativesprite_8 = Renderers.CURRENT_RENDERER.method8440(ChangeClanSetting.BASE_WINDOW_WIDTH, Engine.BASE_WINDOW_HEIGHT * -969250379);
	...
	public synchronized void method5445(Interface27 interface27_1) {
		anInterface27_3604 = anInterface27_3598;
		anInterface27_3598 = interface27_1;
		aLong3601 = Utils.time();
	}

	public synchronized boolean method5450() {
