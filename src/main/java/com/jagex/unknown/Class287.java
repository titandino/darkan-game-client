...
public class Class287 {
	...
	public boolean aBool3426;
	public boolean aBool3427;
	public short[] aShortArray3429;
	...
	public Class287(AbstractRenderer graphicalrenderer_1, int i_2, ByteBuf rsbytebuffer_3) {
		if (ParticlesPreference.anIntArray7920 == null) {
		...
		i_8 = (i_8 << i_2) + (1 << i_2 >> 1);
		i_10 = Class540.anIntArray7136 != null ? Class540.anIntArray7136[rsbytebuffer_3.readUnsignedShort()] : Class335.HSL_TO_RGB[Class372.method6362(rsbytebuffer_3.readUnsignedShort()) & 0xffff];
	...
	public void method5050(AbstractRenderer graphicalrenderer_1, int i_2, int i_3, int i_4, int i_5, int i_6) {
	...
	public void method5053(int i_1, boolean bool_2) {
		int i_4;
		if (!bool_2) {
			int i_5 = anInt3432 * i_1 / 50 + anInt3433 & 0x7ff;
			switch (anInt3431) {
				case 1:
					i_4 = (Trig.SINE[i_5 << 3] >> 4) + 1024;
					break;
				case 2:
					i_4 = i_5;
					break;
				case 3:
					i_4 = ParticlesPreference.anIntArray7920[i_5] >> 1;
					break;
				case 4:
					i_4 = i_5 >> 10 << 11;
					break;
