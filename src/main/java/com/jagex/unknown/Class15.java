...
public class Class15 implements Interface35 {
	...
	public static void method544(IComponentDefinitions icomponentdefinitions_0, int i_1, int i_2) {
		Class20.aClass118_183 = icomponentdefinitions_0;
		Class20.anInt195 = i_1;
		Class20.anInt179 = i_2;
	}

	public static String method547(int[] ints_0) {
