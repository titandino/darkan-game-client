...
import com.jagex.GraphNode_Sub1_Sub3_Sub1;
...
import com.jagex.client.js5.defs.HitbarDefinitions;
...
public class Class209_Sub1 extends Class209 implements MouseListener, MouseMotionListener, MouseWheelListener {
	...
	public NodeCollection aClass482_7941 = new NodeCollection();

	public NodeCollection aClass482_7945 = new NodeCollection();

	public boolean aBool7946;
	...
	public Component aComponent7935;

	public static boolean shiftDown = false;

	public Class209_Sub1(Component component_1) {
	...
	public void method12905(int i_1, int i_2) {
		anInt7942 = i_1;
		anInt7943 = i_2;
		if (aBool7946) {
	...
	public void method12906(Component component_1) {
		method12907();
	...
	public int method12908(MouseEvent mouseevent_1) {
	...
	public void method12909(int i_1, int i_2, int i_3, int i_4) {
