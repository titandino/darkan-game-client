...
public class Class20 {
	...
	public static CacheableNode_Sub7 aCacheableNode_Sub7_157;
	public static CacheableNode_Sub7 aCacheableNode_Sub7_168;
	public static int[] anIntArray177;
	public static int anInt186;
	public static int anInt178 = 16;
	public static boolean aBool162;
	public static CacheableNode_Sub15 aCacheableNode_Sub15_163;
	public static int anInt167;
	public static NodeCollection aClass482_171 = new NodeCollection();
	public static IterableNodeMap aClass465_172 = new IterableNodeMap(16);
	public static Queue aClass477_182 = new Queue();
	public static NodeCollection aClass482_174 = new NodeCollection();
	public static NodeCollection aClass482_175 = new NodeCollection();
	public static LRUCache aClass229_164 = new LRUCache(30);
	public static IComponentDefinitions aClass118_183;
	public static int anInt195 = -1;
	public static int anInt179 = -1;
	public static int anInt180 = -1;
	public static int anInt181 = -1;
	public static int anInt176;
	public static int anInt184;
	public static Matrix44 aClass384_158;
	public static Matrix44 aClass384_185 = new Matrix44();
	public static Matrix44Var aClass294_155 = new Matrix44Var();
	public static int anInt156;
	public static LRUCache aClass229_191 = new LRUCache(8);

	public static float[] aFloatArray194 = new float[4];
	...
	public static void method744(int i_0, int i_1, int i_2, int i_3, int i_4, int i_5) {
		int i_7 = EntityNode.method4890(i_2, Class532_Sub1.anInt7070, Class532_Sub1.anInt7068);
		int i_8 = EntityNode.method4890(i_3, Class532_Sub1.anInt7070, Class532_Sub1.anInt7068);
		int i_9 = EntityNode.method4890(i_0, Class532_Sub1.anInt7071, Class532_Sub1.anInt7069);
		int i_10 = EntityNode.method4890(i_1, Class532_Sub1.anInt7071, Class532_Sub1.anInt7069);
		int i_11 = EntityNode.method4890(i_5 + i_2, Class532_Sub1.anInt7070, Class532_Sub1.anInt7068);
		int i_12 = EntityNode.method4890(i_3 - i_5, Class532_Sub1.anInt7070, Class532_Sub1.anInt7068);
		int i_13;
		for (i_13 = i_7; i_13 < i_11; i_13++) {
			KeyHoldInputSubscriber.method3922(Class532_Sub1.anIntArrayArray7072[i_13], i_9, i_10, i_4);
		}
		for (i_13 = i_8; i_13 > i_12; --i_13) {
			KeyHoldInputSubscriber.method3922(Class532_Sub1.anIntArrayArray7072[i_13], i_9, i_10, i_4);
		}
		i_13 = EntityNode.method4890(i_5 + i_0, Class532_Sub1.anInt7071, Class532_Sub1.anInt7069);
		int i_14 = EntityNode.method4890(i_1 - i_5, Class532_Sub1.anInt7071, Class532_Sub1.anInt7069);
