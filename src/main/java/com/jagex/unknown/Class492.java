...
public class Class492 {
	...
	public static IterableNodeMap INDEX36_FILE_CACHE = new IterableNodeMap(4);

	public static Class502 aClass502_5776 = new Class502();

	public Class492() throws Throwable {
		throw new Error();
	}

	public static boolean method8264(ObjectIndexLoader objectindexloader_0, int i_1, int i_2) {
		int i_21 = i_2;
