...
public abstract class Class278 {
	...
	public boolean aBool3361;
	public Node_Sub41_Sub3 aNode_Sub41_Sub3_3363;
	public Node_Sub41_Sub4 aNode_Sub41_Sub4_3366;
	public String aString3365;
	public Node_Sub41_Sub2 aNode_Sub41_Sub2_3364;
	public boolean aBool3353;
	public boolean aBool3359;
	public byte[] aByteArray3354;
	public OggSyncState anOggSyncState3355;
	public OggPage anOggPage3352;
	public OggPacket anOggPacket3356;
	public IterableNodeMap aClass465_3358;
	public boolean aBool3360;
	...
	Node_Sub41 method4911() throws IOException {
		if (aBool3360) {
			...
			if (!anOggPage3352.isBOS()) {
				...
				if (!oggstreamstate_3.pageIn(anOggPage3352)) {
					throw new IllegalStateException();
				} else if (oggstreamstate_3.packetPeek(anOggPacket3356) != 1) {
					throw new IllegalStateException();
				} else {
					Node_Sub41 obj_4;
	...
	public void method4913() throws IOException {
	...
	public abstract int decode(byte[] var1) throws IOException;
}
