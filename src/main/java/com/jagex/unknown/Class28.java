...
public class Class28 implements Interface2 {
	...
	public static long aLong351;

	public Class365 aClass365_349;

	NewsItemFetcher fetchNewsTask;

	public Class28(NewsItemFetcher class30_1, Class365 class365_2) {
	...
	public static void method776(IComponentDefinitions icomponentdefinitions_0) {
		if (icomponentdefinitions_0.contentType == IComponentDefinitions.CONTENT_TYPE_328) {
			if (VertexNormal.MY_PLAYER.displayName == null) {
				...
				if (class456_sub3_2 != null) {
					...
					icomponentdefinitions_0.animation = class456_sub3_2.currentAnimationId();
	...
	public int method770(FontRenderer fontrenderer_1, String string_2, int i_3, int i_4) {
