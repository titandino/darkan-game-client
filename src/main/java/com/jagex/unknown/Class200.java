...
public class Class200 {
	...
	public Class200(int i_1, int i_2, int i_3, int i_4, int i_5, int i_6, int i_7, int i_8, int i_9, int i_10) {
		anInt2534 = i_1;
		anInt2532 = i_2;
		anInt2533 = i_3;
		anInt2540 = i_4 * i_4;
	...
	public void method3253(int i_1, int i_2, int i_3, int i_4, int i_5, int i_6, int i_7, int i_8, int i_9, int i_10) {
		anInt2534 = i_1;
		anInt2532 = i_2;
		anInt2533 = i_3;
		anInt2540 = i_4 * i_4;
	...
	public boolean method3255(int i_1, int i_2, int i_3) {
		if (i_1 >= anInt2535 && i_1 <= anInt2536) {
			if (i_2 >= anInt2537 && i_2 <= anInt2538) {
				if (i_3 >= anInt2539 && i_3 <= anInt2531) {
