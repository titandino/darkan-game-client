...
public class Class534_Sub2 extends Class534 {
	...
	public static void method12847(int i_0) {
	...
	@Override
	public void method11427(ByteBuf rsbytebuffer_1, MouseRecord class282_sub53_2) {
	}
	...
	@Override
	public TCPPacket method11416() {
		return TCPPacket.createPacket(ClientProt.MOVE_MOUSE_2, client.GAME_CONNECTION_CONTEXT.isaac);
	}

	@Override
	public void method11413(ByteBuf rsbytebuffer_1, MouseRecord class282_sub53_2) {
	}

	@Override
	public int method11412() {
		return 0;
	}
	...
	public void method11431() {
		...
		if (class282_sub53_1 != null) {
			...
			TCPPacket tcpmessage_6 = TCPPacket.createPacket(ClientProt.MOUSE_CLICK, client.GAME_CONNECTION_CONTEXT.isaac);
	...
	@Override
	public int method11415() {
		return 0;
	}

	@Override
	public TCPPacket method11421() {
		return TCPPacket.createPacket(ClientProt.MOVE_MOUSE_2, client.GAME_CONNECTION_CONTEXT.isaac);
	}

	@Override
	public TCPPacket method11420() {
		return TCPPacket.createPacket(ClientProt.MOVE_MOUSE_2, client.GAME_CONNECTION_CONTEXT.isaac);
	}

	@Override
	public TCPPacket method11428() {
		return TCPPacket.createPacket(ClientProt.MOVE_MOUSE_2, client.GAME_CONNECTION_CONTEXT.isaac);
	}
	...
	public void method11414() {
		...
		if (class282_sub53_2 != null) {
			...
			TCPPacket tcpmessage_7 = TCPPacket.createPacket(ClientProt.MOUSE_CLICK, client.GAME_CONNECTION_CONTEXT.isaac);
	...
	@Override
	public TCPPacket method11422() {
		return TCPPacket.createPacket(ClientProt.MOVE_MOUSE_2, client.GAME_CONNECTION_CONTEXT.isaac);
	}

	@Override
	public void method11426(ByteBuf rsbytebuffer_1, MouseRecord class282_sub53_2) {
	}
}
