...
import com.jagex.client.input.KeyPressInputSubscriber;
import com.jagex.client.js5.IndexLoaders;
import com.jagex.client.js5.defs.HitsplatDefinitions;
import com.jagex.client.js5.defs.LightIntensityDefinitions;
import com.jagex.client.js5.defs.ObjectDefinition;
import com.jagex.client.js5.defs.QuestDefinitions;
import com.jagex.client.js5.defs.models.materials.MaterialProp38;
...
public class Class329_Sub1 extends Class329 {
	...
	public static boolean aBool7717;

	public static boolean aBool7714;

	public static int[] anIntArray7724 = {1, 0, -1, 0};

	public static int[] anIntArray7720 = {0, -1, 0, 1};

	public static int[] anIntArray7721 = {1, -1, -1, 1};

	public static int[] anIntArray7713 = {-1, -1, 1, 1};

	public int anInt7723 = 99;

	ObjectIndexLoader objectDefLoader;

	public Class239 aClass239_7719;

	public Class329_Sub1(SceneObjectManager sceneobjectmanager_1, ObjectIndexLoader objectindexloader_2, int i_3, int i_4, int i_5, boolean bool_6, RenderFlagMap regionmap_7, Class239 class239_8) {
	...
	public void method12459(AbstractRenderer graphicalrenderer_1, int i_2, int i_3, int i_4, int i_5, int objectId, int i_7, int i_8, ClipFlagMap clipMap, int i_10) {
		if (i_3 < anInt7723) {
			anInt7723 = i_3;
		}
	...
	public boolean method12464(AbstractRenderer graphicalrenderer_1, int i_2, int i_3, boolean bool_4, ObjectDefinition objectdefinitions_5, int i_6, int i_7, int i_8, int i_9, int i_10, int i_11, int i_12, int i_13, boolean bool_14, Ground class390_15, ClipFlagMap clipmap_16, int i_17, int i_18) {
		int i_20;
	...
	public boolean method12465(AbstractRenderer graphicalrenderer_1, int i_2, int i_3, boolean bool_4, ObjectDefinition objectdefinitions_5, int i_6, int i_7, int i_8, int i_9, int i_10, int i_11, int i_12, int i_13) {
	...
	public WorldObject getWorldObject(int plane, int slot, int x, int y) {
	...
	public void method12475(AbstractRenderer graphicalrenderer_1, int i_2, int i_3, int x, int y, ClipFlagMap clipmap_6) {
