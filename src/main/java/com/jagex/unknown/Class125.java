...
public class Class125 implements Interface8 {
	...
	public static int LAST_IP_ADDRESS;

	public int anInt1568;

	public int anInt1569;

	public float[] aFloatArray1570;

	public Class125(int i_1, int i_2) {
		anInt1568 = i_1;
		anInt1569 = i_2;
		aFloatArray1570 = new float[anInt1568 * anInt1569];
	}

	public static int method2172(int i_0) {
		int i_2 = i_0 & 0x3f;
		int i_3 = i_0 >> 6 & 0x3;
		if (i_2 == 18) {
			if (i_3 == 0) {
