...
public class Class62 implements Interface3 {
	...
	public Class62(String string_1, Class356 class356_2, Class353 class353_3, int i_4, int i_5, int i_6, int i_7, int i_8, int i_9, int i_10, int i_11, int i_12, int i_13) {
		aString649 = string_1;
	...
	public static void method1260(int i_0, boolean bool_1) {
		if (bool_1) {
			...
			HitsplatIndexLoader.executeTrigger(ClientTriggerType.aClass397_4800, i_0, -1);
		}
	}
	...
	public static void method1261(Index index_0) {
		...
		Class235.aList2896 = new LinkedList<ParticleSystem>();
