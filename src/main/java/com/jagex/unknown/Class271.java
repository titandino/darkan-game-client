...
public class Class271 {
	...
	public static File aFile3327;

	public static int anInt3330;

	public static boolean aBool3328;

	public static Hashtable<String, File> aHashtable3329 = new Hashtable<>(16);
	...
	public static void method4827(Index index_0, int i_1, int i_2, int i_3, boolean bool_4) {
