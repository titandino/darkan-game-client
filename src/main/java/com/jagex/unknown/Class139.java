...
public class Class139 implements Interface13 {
	...
	public Class137_Sub2 aClass137_Sub2_1656;
	public int anInt1657;

	public Class139(Class137_Sub2 class137_sub2_1, int i_2) {
		anInt1658 = 0;
		aClass137_Sub2_1656 = class137_sub2_1;
		anInt1657 = i_2;
	}

	@Override
	public int method73() {
		return aClass137_Sub2_1656.anInt9104;
	}
	...
	public void method99(int i_1) {
		OpenGL.glFramebufferTexture2DEXT(36160, i_1, anInt1657, aClass137_Sub2_1656.anInt1647, anInt1658);
	}
