...
public class Class350_Sub1 extends Class350 {
	...
	public Class350_Sub1(Class356 class356_1, Class353 class353_2, int i_3, int i_4, int i_5, int i_6, int i_7, int i_8, int i_9, int i_11, int i_12) {
		super(class356_1, class353_2, i_3, i_4, i_5, i_6, i_7, i_8, i_9);
		anInt7755 = i_11;
		anInt7756 = i_12;
	}

	public static void method12516() {
