...
public class Class261_Sub1 extends Class261 {
	...
	public static float[][] aFloatArrayArray8043 = {{-0.333333f, -0.333333f, -0.333333f}, {0.333333F, -0.333333f, -0.333333f}, {-0.333333f, 0.333333F, -0.333333f}, {0.333333F, 0.333333F, -0.333333f}, {-0.333333f, -0.333333f, 0.333333F}, {0.333333F, -0.333333f, 0.333333F}, {-0.333333f, 0.333333F, 0.333333F}, {0.333333F, 0.333333F, 0.333333F}};
	...
	public static float method13369(float f_0, float f_1, float f_2) {
		return f_0 + (f_1 - f_0) * f_2;
	}

	public static float method13370(int i_0, float f_1, float f_2, float f_3) {
		float[] floats_4 = aFloatArrayArray8043[i_0];
		return floats_4[0] * f_1 + floats_4[1] * f_2 + floats_4[2] * f_3;
	}

	public static float method13372(float f_0) {
		return f_0 * f_0 * f_0 * (10.0F + (f_0 * 6.0F - 15.0F) * f_0);
	}

	@Override
	public void method4634(int i_1, int i_2, int i_3, int i_4, float f_5, float f_6, float f_7, float f_8, float[] floats_9) {
		int start = 0;
