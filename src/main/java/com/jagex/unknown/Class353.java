...
import com.jagex.GroundItemNode;
import com.jagex.Node_Sub29;
...
public class Class353 {
	...
	public static Class353 aClass353_4107 = new Class353();

	public static Class353 aClass353_4105 = new Class353();

	public static Class353 aClass353_4106 = new Class353();

	public static Class353[] values() {
		return new Class353[]{aClass353_4107, aClass353_4105, aClass353_4106};
	}

	public static void method6208(File file_0, byte[] bytes_1, int i_2) throws IOException {
	...
	public static void addGroundItem(int i_0, int x, int y, GroundItemNode groundItem) {
