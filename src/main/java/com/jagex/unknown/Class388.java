...
public class Class388 implements Interface41 {
	...
	public Index aClass317_4720;

	public String aString4719;

	public Class388(Index index_1) {
	...
	public static void method6692() {
		...
		tcpmessage_1.buffer.writeByte(Class393.preferences.aAntiAliasingPreference__8223.method12641());
		client.GAME_CONNECTION_CONTEXT.queuePacket(tcpmessage_1);
	}

	public static boolean method6693() {
		return client.GAME_STATE == 5 && (!JS5CacheFile.method3360() && !Class85.method1466());
	}

	public static void method6694(Class200 class200_0, int i_1, int i_2, int i_3, MeshRasterizer meshrasterizer_4) {
