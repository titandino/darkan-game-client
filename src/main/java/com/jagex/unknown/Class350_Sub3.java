...
public class Class350_Sub3 extends Class350 {
	...
	public Class350_Sub3(Class356 class356_1, Class353 class353_2, int i_3, int i_4, int i_5, int i_6, int i_7, int i_8, int i_9, int i_10, int i_11, int i_12, int i_13, int i_14, int i_15) {
	...
	public static void method12590(TCPPacket tcpmessage_0, int i_1, int i_2, int i_3) {
