...
public class Class140 {
	...
	public static int[] anIntArray1661 = new int[2];
	OpenGLRenderer aGraphicalRenderer_Sub1_1662;
	public int anInt1663;

	public Class140(OpenGLRenderer class505_sub1_1, int i_2) {
		aGraphicalRenderer_Sub1_1662 = class505_sub1_1;
		anInt1663 = i_2;
	}

	public static Class140 method2393(OpenGLRenderer class505_sub1_0, int i_1, String string_2) {
