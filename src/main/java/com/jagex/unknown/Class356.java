...
import com.jagex.HDWaterTile;
import com.jagex.HostNameIdentifier;
import com.jagex.ServerEnvironment;
import com.jagex.client.client;
import com.jagex.client.js5.IndexLoaders;
import com.jagex.client.prefs.impl.CustomCursorsPreference;
import com.jagex.client.prefs.impl.RemoveRoofPreference;
import com.jagex.game.content.clans.settings.ChangeClanSetting;

import java.util.Arrays;

public class Class356 {
	public static Class356 aClass356_4117 = new Class356();
	public static Class356 aClass356_4118 = new Class356();
	public static Class356 aClass356_4119 = new Class356();
	...
	public static void method6227(boolean bool_0) {
		if (!bool_0) {
			...
			RemoveRoofPreference.method12958();
			Class188.method3140();
			Class191.method3166();
			Class321.method5757();
