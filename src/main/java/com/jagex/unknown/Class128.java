...
public class Class128 {
	...
	public static int[] anIntArray1582 = new int[2];
	public OpenGLRenderer aGraphicalRenderer_Sub1_1581;
	public int anInt1583;

	public Class128(OpenGLRenderer class505_sub1_1, int i_2) {
		aGraphicalRenderer_Sub1_1581 = class505_sub1_1;
		anInt1583 = i_2;
	}

	public static Class128 method2174(OpenGLRenderer class505_sub1_0, Class140[] arr_1) {
		int i_2;
