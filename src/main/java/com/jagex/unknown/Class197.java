...
import com.jagex.CoordGrid;
import com.jagex.PlayerEntity;
import com.jagex.VertexNormal;
...
public class Class197 {
	...
	public static FontMetrics aClass414_2436;
	public static byte[] aByteArray2424 = new byte[2048];
	public static byte[] playerMovementTypes = new byte[2048];
	public static ByteBuf[] aNode_Sub35Array2428 = new ByteBuf[2048];
	public static int NUM_PLAYER_INDICES;
	public static int[] PLAYER_INDICES = new int[2048];
	public static int anInt2431;
	public static int[] anIntArray2426 = new int[2048];
	public static Class4[] aClass4Array2430 = new Class4[2048];
	public static int anInt2434;
	public static int[] anIntArray2435 = new int[2048];

	public Class197() throws Throwable {
		throw new Error();
	}

	public static void method3203(ByteBuf.Bit packet) {
