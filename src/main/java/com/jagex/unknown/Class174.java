...
public class Class174 {
	...
	public static boolean aBool2135;
	public static int anInt2136;
	public static int anInt2137;
	public static Class356 aClass356_2139;
	public static Class353 aClass353_2140;
	public static SpriteDefinitions aClass91_2141;
	public static SpriteDefinitions aClass91_2138;
	public static SpriteDefinitions[] aClass91Array2132;

	public Class174() throws Throwable {
		throw new Error();
	}

	public static boolean method2954() {
		boolean bool_1 = true;
	...
	public static void animateObject(int plane, int slot, int x, int y, int objectId, int rotation, int type, int animId) {
