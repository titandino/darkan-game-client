...
public abstract class Class326 implements Interface5 {
	...
	public static int[] anIntArray3766 = new int[1];
	public int anInt3758 = -1;
	JAGGLRenderer aGraphicalRenderer_Sub2_Sub1_3757;
	public int anInt3762;
	public boolean aBool3761;
	public NativeHeapBuffer aNativeHeapBuffer3765;
	public int anInt3763;
	public int anInt3764;

	public Class326(JAGGLRenderer class505_sub2_sub1_1, int i_2, boolean bool_3) {
	...
	public boolean method5798(int i_1, Source source_2) {
		if (i_1 > anInt3764) {
			method5793();
			if (anInt3758 > 0) {
				OpenGL.glBindBufferARB(anInt3762, anInt3758);
