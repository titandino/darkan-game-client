...
import com.jagex.Node_Sub17_Sub1;
...
public class Class231 {
	...
	public Class231(SceneObjectManager sceneobjectmanager_1, int i_2, int i_3, int i_4, int i_5, int i_6, int i_7, int i_8, int i_9, int i_10, int i_11, int i_12, int i_13, int i_14, int i_15) {
		aByte2863 = (byte) i_2;
		aByte2865 = (byte) i_3;
	...
	public static void method3914(int i_0, String string_1, boolean bool_2) {
		Class28.method772();
