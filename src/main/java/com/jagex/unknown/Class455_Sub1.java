...
public class Class455_Sub1 extends Class455 {
	...
	public Interface6 anInterface6_8508;

	public Class455_Sub1(HardwareRenderer class505_sub2_1, int i_2, int i_3, byte[] bytes_4) {
	...
	public Class455_Sub1(HardwareRenderer class505_sub2_1, int i_2, int i_3, int[] ints_4) {
		anInterface6_8508 = class505_sub2_1.method14024(i_2, i_3, false, ints_4);
		anInterface6_8508.method50(false, false);
	}

	public static Class455_Sub1 method13769(HardwareRenderer class505_sub2_0, int i_1, int i_2, int[] ints_3, int[] ints_4) {
		int i_6;
		int i_7;
		int i_8;
