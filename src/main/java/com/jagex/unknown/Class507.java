...
import com.jagex.client.js5.loaders.GameTipsLoader;
...
public class Class507 {
	...
	public static Class208 aClass208_5860;

	public Class507() throws Throwable {
		throw new Error();
	}

	public static void method8725(int i_0, int i_1, int i_2, int i_3, boolean bool_4) {
