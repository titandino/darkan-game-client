...
import com.jagex.Node_Sub15_Sub4;
import com.jagex.ReflectionCheck;
import com.jagex.VarProvider;
import com.jagex.client.client;

public class Class79 implements VarProvider {
	...
	public int method237(int i_1) {
		IntNode class282_sub38_2 = (IntNode) Class86.aClass465_823.get(i_1);
	...
	public int getVarBit(int i_1) {
		IntNode class282_sub38_3 = (IntNode) Class86.aClass465_823.get(0x100000000L | i_1);
	...
	public int getVar(int i_1) {
		IntNode class282_sub38_3 = (IntNode) Class86.aClass465_823.get(i_1);
	...
	public int method242(int i_1) {
		IntNode class282_sub38_2 = (IntNode) Class86.aClass465_823.get(0x100000000L | i_1);
