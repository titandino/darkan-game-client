...
import com.jagex.client.js5.defs.models.materials.MaterialProp21;
import com.jagex.client.js5.loaders.StructIndexLoader;
import com.jagex.client.js5.loaders.UnderlayIndexLoader;
import com.jagex.client.prefs.impl.MonoStereoPreference;
...
public abstract class Class152 {
	...
	public static boolean aBool1962;

	public static void method2596() {
		FileStream fileStream_1 = null;
		try {
			fileStream_1 = FileStream.createPreferenceFileStream("2", client.CURRENT_GAME.name, false);
			byte[] bytes_2 = new byte[(int) fileStream_1.getLength()];
			int i_3;
			for (int i_4 = 0; i_4 < bytes_2.length; i_4 += i_3) {
				i_3 = fileStream_1.readBytes(bytes_2, i_4, bytes_2.length - i_4);
				if (i_3 == -1) {
	...
	public static char method2599(char var_0, Language xlanguage_1) {
	...
	public static void method2601(long long_0) {
