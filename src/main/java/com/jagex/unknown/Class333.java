...
public class Class333 implements Interface28 {
	...
	public Class150 aClass150_3880;
	public Class76 aClass76_3878;
	public int anInt3877;
	public int anInt3879;
	JAGGLRenderer aGraphicalRenderer_Sub2_Sub1_3881;

	public Class333(JAGGLRenderer class505_sub2_sub1_1, Class150 class150_2, Class76 class76_3, int i_4, int i_5) {
