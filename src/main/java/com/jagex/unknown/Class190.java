...
import com.jagex.client.js5.loaders.ClanVarIndexLoader;
...
public class Class190 {
	...
	public static boolean aBool2383;
	...
	public static void savePreferences() {
		...
		try {
			fileStream_1 = FileStream.createPreferenceFileStream("", client.CURRENT_GAME.name, true);
			ByteBuf rsbytebuffer_2 = Class393.preferences.encode();
			fileStream_1.writeBytes(rsbytebuffer_2.buffer, 0, rsbytebuffer_2.index);
	...
	public static void method3149(IComponentDefinitions icomponentdefinitions_0, Class455 class455_1, int i_2, int i_3, int i_4, int i_5, NativeSprite nativesprite_6) {
	...
	public static void method3151(int i_0, int i_1, IComponentDefinitions icomponentdefinitions_2, Class119 class119_3, int i_4, int i_5) {
