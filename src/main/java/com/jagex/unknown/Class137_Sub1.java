...
public class Class137_Sub1 extends Class137 {
	...
	public int anInt9087;
	public int anInt9086;

	public Class137_Sub1(OpenGLRenderer class505_sub1_1, int i_2, int i_3, int i_4, boolean bool_5, int[] ints_6, int i_7, int i_8, boolean bool_9) {
	...
	public Class137_Sub1(OpenGLRenderer class505_sub1_1, int i_2, Class150 class150_3, Class76 class76_4, int i_5, int i_6, boolean bool_7, byte[] bytes_8, Class150 class150_9, boolean bool_10) {
	...
	public Class137_Sub1(OpenGLRenderer class505_sub1_1, int i_2, int i_3, int i_4, int i_5, int i_6) {
	...
	public Class137_Sub1(OpenGLRenderer class505_sub1_1, Class150 class150_3, Class76 class76_4, int i_5, int i_6, boolean bool_7, float[] floats_8, Class150 class150_9) {
	...
	public Class137_Sub1(OpenGLRenderer class505_sub1_1, int i_2, Class150 class150_3, Class76 class76_4, int i_5, int i_6) {
	...
	public void method14439(int i_1, int i_2, int i_3, int i_4, int i_5, int i_6) {
		Class158 class158_7 = openGLHardwareRenderer.method8523();
		if (class158_7 != null) {
			int i_8 = class158_7.method2716() - (i_4 + i_6);
			openGLHardwareRenderer.method13654(this);
	...
	public Interface8 method14440() {
		return new Class154(this);
	}

	public Interface9 method14441() {
		return new Class154(this);
	}

	public void method14445(boolean bool_1, boolean bool_2) {
		if (anInt1648 == 3553) {
			openGLHardwareRenderer.method13654(this);
	...
	public void method14452(int i_1, int i_2, int i_3, int i_4, int[] ints_5, int i_7) {
		int i_71 = i_7;
		if (i_71 == 0) {
			i_71 = i_3;
		}
	...
	public void method14455(int i_2, int i_3, int i_4, byte[] bytes_5, Class150 class150_6, int i_8, boolean bool_9) {
		int i_81 = i_8;
