...
import com.jagex.unknown.Class131_Sub2;
import com.jagex.unknown.Class135_Sub2;
...
public class Node_Sub3 extends Node {
	...
	public OpenGlArrayBufferPointer aClass143_7492;
	public NativeHeapBuffer aNativeHeapBuffer7495;
	public Stream aStream7489;
	public OpenGLGround aGround_Sub2_7488;
	public OpenGLRenderer aGraphicalRenderer_Sub1_7494;
	public int anInt7493;
	public float aFloat7490;
	public HDWaterTile aClass90_7487;
	public int[] anIntArray7496;
	public Class131_Sub2 aClass131_Sub2_7491;

	public Node_Sub3(OpenGLGround class390_sub2_1, int i_2, int i_3, HDWaterTile class90_4) {
	...
	public void method12081(int i_1) {
		aStream7489.method2919(i_1 * 4 + 3);
		aStream7489.method2920(-1);
	}

	public void method12082(int i_1, int i_2, int i_3) {
		anIntArray7496[i_2 * aGround_Sub2_7488.width + i_1] |= 1 << i_3;
	}

	public void method12083(int i_1, int i_2, int i_3, float f_4) {
		int i_21 = i_2;
		int i_6;
		int i_7;
		if (anInt7493 != -1) {
	...
	public void method12085(int[] ints_1, int i_2) {
		int i_3 = 0;
	...
	public void method12087(int i_1) {
	...
	public void method12092(int i_1) {
