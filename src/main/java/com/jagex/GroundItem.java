	...
	public Class285 method13009(AbstractRenderer graphicalrenderer_1) {
		...
		if (anInt10422 * -460947901 * 1327971947 == 0) {
			...
			if (i_11 != 0) {
				...
				if (i_29 != 0) {
					matrix44var_6.rotation(1.0F, 0.0F, 0.0F, Trig.degToRad(i_29));
				}
			}
			...
			if (i_11 != 0) {
				...
				if (i_29 != 0) {
					matrix44var_6.rotation(0.0F, 0.0F, 1.0F, Trig.degToRad(-i_29));
				}
			}
	...
	public Class285 method12990(AbstractRenderer graphicalrenderer_1) {
		...
		if (anInt10422 == 0) {
			...
			if (i_12 != 0) {
				...
				if (i_30 != 0) {
					matrix44var_7.rotation(1.0F, 0.0F, 0.0F, Trig.degToRad(i_30));
				}
			}
			...
			if (i_12 != 0) {
				...
				if (i_30 != 0) {
					matrix44var_7.rotation(0.0F, 0.0F, 1.0F, Trig.degToRad(-i_30));
				}
			}
